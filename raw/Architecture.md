...
### Распространенные проблемы высоконагруженных приложений
...
## Методы взаимодействий front-to-back
...
## Методы взаимодействий back-to-back
...
## Средства защиты доступа к данным
...
## Основные подходы к разработке решений
...
## Управление требованиями и определение бизнес-процессов
