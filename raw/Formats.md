...
На сервере операции выполняются последовательно и не зависимо. Если одна из операций завершается с ошибкой, то все предыдущие операции должны отмениться и вернуться объект с ошибкой.
