...
- **квантор существования** (`∃`) - обозначает "некоторые" и читается: "существует" или "найдётся";
...
2. **Action** - проверка гипотезы на практике;
3. **Data** - сбор данных;
4. **Insights** - получение выводов - анализ полученных данных.
