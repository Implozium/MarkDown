...
- [Коммуникация](#user-content-Коммуникация)
    ...
    - [Переговоры](#user-content-Переговоры)
        ...
        - [Процесс](#user-content-Процесс)
        - [Действия после](#user-content-Действия-после)
        - [Модель Problem - Solution - Benefit](#user-content-Модель-Problem---Solution---Benefit)
        - [Конструктивный отказ](#user-content-Конструктивный-отказ)
        - [Сложные коммуникации](#user-content-Сложные-коммуникации)
            - [Алгоритм проведения сложного разговора](#user-content-Алгоритм-проведения-сложного-разговора)
            - [Воврат в диалог из агрессии](#user-content-Воврат-в-диалог-из-агрессии)
        - [Спор](#user-content-Спор)
            - [Способы ответа на провокацию](#user-content-Способы-ответа-на-провокацию)
...
**Критическое мышление** - очень пристальное и вовлеченное - изучение того или иного вопроса.
...
<a id="Коммуникация" href="#Коммуникация">Коммуникация</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
============

**Коммуникация** - это процесс обмена информацией, идеями, мыслями, чувствами и эмоциями между людьми или группами с помощью различных средств и методов.

Это фундаментальный аспект человеческого взаимодействия, который позволяет людям понимать друг друга, сотрудничать, решать проблемы и строить отношения.

**Отправитель** (источник) - тот, кто передает информацию.

**Сообщение** - содержание информации, которая передается.

**Канал** - средство передачи сообщения.

**Получатель** - тот, кто принимает сообщение.

**Обратная связь** - реакция получателя на сообщение, которая позволяет отправителю понять, было ли сообщенеи правльно воспринято.

**Контекст** - обстановка или ситуация, в которой происходит коммуникация.

**Барьеры** (помехи) - все, что мешает эффективной коммуникации. Бывают:
- **физическими** - шум, свет и прочее;
- **сильные эмоции** у отправителя и получателя;
- **технические** - которые искажают, прерывают или теряют часть информации;
- **разный контекст** у отправителя и получателя.

**По модели коммуникации Г. Лассуэлла** идеальный **отправитель** может закодировать 80% информации из своей головы в виде слов, барьеры уменьшают ее до 60%, а **получаетель** декодирует только 40% от той, которая находилась в голове отправителя

**Деловая коммуникация** - это общение между людьми в рамках профессиональных ролей с целью достижения конкретных целей, таких как решение задач, координация действий, заключение сделок, управление коллективом или развитие бизнеса. Это форма общения, которая происходит в контексте деловой активности и подчиняется определенным правилам, нормам и стандартам.

**Деловая роль** - отвечает за что кто-то делает и зачем это делает.

Для улучшения передачи информации можно использовать вопросы, которые задаются другому человеку:
- **как с тобой говорить?**;
- **как тебе объяснять?**;
- **какая подача тебе комфортнее?**.
...
**Позиция** - решение, которое человек преподносит в разговоре (что он говорит).

**Интерес** - то, что человек хочет достичь (то, что ему нужно на самом деле).

Один из важнейших условий эффективной коммуникации - умение видеть или выяснять, что скрывается за той или иной позицией, каковы интересы собеседника, с которым строится общение.
...
- **найти пересечения и обсудить их**, а остальное перенести на другую встречу или в письменное обсуждение;
- **отменить встречу: перенести ее на другой раз**, этот метод работает для дружелюбно настроенных друг к другу собеседников - со смежниками, а для агрессивно настроенным клиентом - нет.
...
### <a id="Процесс" href="#Процесс">Процесс</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Для прояснения позиции собеседника используются **вопросы**:
- **открытого вида** для сбора как можно больше информации или передачи инициативы собеседнику:
    - *что вы знаете о ...?*;
- **закрытого вида** для проверок или уточнения гипотез или сохранения инициативы за собой:
    - *вы про это уже говорили?*;
- **альтернативного вида** для проверки выбора собеседника, уточнения гопотезы  или передачи инициативы собеседнику:
    - *вы обсуждали это с каким-то экспертом или разбирались сами?*;
- **прямого вида** для уточнения нопонятных моментов, перенаправление беседы в рамках темы или для углубления обсуждения вопроса:
    - *вы сказали что ... Почему?*;
- **объясняющего вида** для уточнения нопонятных и скрытых (неявнях) моментов, принесения новой темы в беседу или изменения обсуждения вопроса:
    - *вы говорите ..., но ... Могу я уточнить ...?*;

Или **перефразирование** - повторение мысли собеседника своими словами в утвердительной форме, которые начинаются с фраз:
- *вы говорите, что ...*;
- *если я вас правильно услышал ...*;
- *то есть вы хотите сказать ...*;
- *содержание ваших аргументов таково ...*;
- *иными словами, вы ...*.

### <a id="Действия-после" href="#Действия-после">Действия после</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Конструктивный-отказ" href="#Конструктивный-отказ">Конструктивный отказ</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Заключается не просто в ответе "**нет**" собеседнику, а в объяснении свой позиции и поиска альтернатив. Состоит из шагов:
1. **Выслушивания предложения** собеседника до конца, не перебивая, чтобы понять все предложение, а также задавание вопросов с целью выяснить "*почему это важно?*" для собеседника;
2. **Определение ценности** которое несет это предложение разделяя при этом реальную от ожидаемой;
3. **Формирование причины отказа** с аргументами релевантными для собеседника;
4. **Отказ** который должен сохранять отношения с собеседником;
5. **Предложение альтернативы** которая будет работать для собеседника, если такое возможно.

Когда целесообразно отказывать:
1. Когда согласие нанесет вред, тому кому направлено предложение;
2. Когда согласие нанесет вред самой компании;
3. Когда согласие нанесет вред просителю.

Основные ошибки:
- **мягкий отказ**, который дает надежду просителю вновь вернуться к этому вопросу с новыми аргументами;
- **вранье или выдумывание аргументов**.

Основные сложности и барьеры:
- **не видеть границы своих возможностей**;
- **чувство вины из-за отказа**;
- **принятие того, что факты могут обидеть просящего**.

### <a id="Сложные-коммуникации" href="#Сложные-коммуникации">Сложные коммуникации</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Сложные коммуникации происходят когда соблюдаются условия:
- **разные позиции** - видимая часть которая заключается в вопросах: *о чем говорим?*, *что обсуждаем?*. Основные моменты которые мешают:
    - уверенность в собственной правоте;
    - установка на обвинение;
    - придуманные намерения;
- **сильные эмоции** - это как разговаривают, насколько эмоционально или напряженно ведется диалог. Основные моменты которые мешают:
    - недооценка роли чувств в разговоре;
    - уход от диалога в агрессию или молчание;
- **высокие ставки** - это то, что значит разговор для участников. Основные моменты которые мешают:
    - позиция "все или ничего";
    - субъективная высокая цена проигрыша;
    - катастрофизация ситуации;

#### <a id="Алгоритм-проведения-сложного-разговора" href="#Алгоритм-проведения-сложного-разговора">Алгоритм проведения сложного разговора</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Состоит из шагов:
1. **Подготовка и анализ ситуации**:
    1. Разбор в содержании ситуации и эмоциях через ответы на вопросы:
        - *что произошло?*;
        - *откуда информация была получена?*;
        - *какой может быть позиция собеседника?*;
        - *каковы знания об обстоятельствах дела по сравнению с собеседником?*;
        - *как отразится ситуация на мне / команде / бизнесе?*;
        - *что каждый внес в развитие проблемы?*;
        - *какой эмоциональный отпечаток оставила ситуация на обоих?*;
        - *каковы мотивы / потребности / интересы собеседника?*;
    2. Формирование своих целей и их анализ, а также решение о том, стоит ли поднимать вопрос путем ответа на вопрос: *чего надеемся добиться этим разговором?*;

2. **Начало разговора**:
    1. Описание проблемы, как расхождение во взглядах. На равных правах расмотрение версий обеих сторон;
    2. Деление целями;
    3. Приглашение собеседника к совместному разбору ситуации;

    > *Я чувствую, что мы смотрим на вещи по разному. Я хотел бы поделиться своим взглядом и поподробнее узнать, как ты воспринимаешь ситуацию ...*

3. **Совместное иследование ситуации**:
    1. Проянение позиции собеседника, через ее уточнение;
    2. Слушание и задавание открытых или конкретизирующих вопросов;
    3. Прояснение правильности своего понимания;
    4. Рассказ о своей позиции;

4. **Решение**:
    1. Формирование критериев оптимального решения вопроса;
    2. Обсуждение вариантов, поиск решения, устраивающего обе стороны, чем стороны готовы "поступиться" в принятии альтернативного решения, а в чем нет;
    3. Оставить "двер открытой" для продолжения диалога;

#### <a id="Воврат-в-диалог-из-агрессии" href="#Воврат-в-диалог-из-агрессии">Воврат в диалог из агрессии</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Основные шаги:
1. **Понимание причины аргессии со стороны собеседника** которые бывают:
    - не желание признавать свой проигрыш, поэтому начинается нападение;
    - это определенная тактика;
    - амплуа "по жизни злой";
    - недовольство собеседником или совместной работой ("накопилось", "наболело");
2. **Возможность высказывание собеседником, выслушивание его**;
3. **Извинение при необходимости**:
    - "*прости, если я тебя обидел*";
    - "*извини, не знал, что ты думаешь именно так*";
4. **Повторное обсуждение сути вопроса или задачи, которая стоит перед вами**:
    - "*я так понял, что нам необходимо договориться о ...";
    - "*нам нужно выработать дальнейшие шаги о ...*";
5. **Уточнение позиции собеседника, его вариант решения**:
    - "*ты предлагаешь поступить так ...*";
    - "*ты считаешь, что этот выход из ситуации будет оптимальным ..., я правильно понял?*";
6. **Предложение своего варианта или компромисса**;

### <a id="Спор" href="#Спор">Спор</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

**Манипуляция** - это воздействие, при котором инициатор достигает своих целей, нанося ущерб адресату своего воздействия.

Строится по сбору информации о собеседнике, определения "мишеней" воздействия, состоит из шагов:
1. Вовлечение в контакт;
2. Использование фоновых факторов;
3. Воздействие на "мишени";
4. Побуждение собеседника к активности.

**Провокация** - это действие, направленное на получения от провоцируемого какой-либо ожидаемой реакции или поведения, которые в свою очередь могут повлечь за собой тяжелые последствия для провоцируемого / команды / общего дела.

Часто провокация строится на переплетении лжи и правды.

#### <a id="Способы-ответа-на-провокацию" href="#Способы-ответа-на-провокацию">Способы ответа на провокацию</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Главное при ответе на провокацию это не доказывать и не оправдываться.

Основные способы:
1. **Пассивная защита** - когда реакцию на провокацию не выражают;
2. **Точки над i** - активное включение и задавание вопросов по этому - цель, содержание самой провокации;
3. **Возврат** - ответ подобной провокацией на провокацию;
4. **Условное согласие** - согласие с частью правды, но с отрицанием лжи.
...
- **иллюстрацию**, но это поможет лишь отбросить частный случай, но не опровергнете ни тезис, ни аргумент.
