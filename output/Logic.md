...
- [Гипотеза](#user-content-Гипотеза)
    - [Критерии хорошей гипотезы](#user-content-Критерии-хорошей-гипотезы)
        ...
        - [HADI-цикл](#user-content-HADI-цикл)
...
### <a id="HADI-цикл" href="#HADI-цикл">HADI-цикл</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Состоит из шагов:
1. **Hypothesis** - выдвижение гипотезы;
2. **Action** - определения действий которые необходимо предпринять для проверка гипотезы на практике;
3. **Data** - определения данных какие необходимо собрать, чтобы сделать вывод о корректности гипотезы;
4. **Insights** - получение выводов - анализ полученных данных - определения основания на основе которого можно сделать вывод, что гипотеза верна или неверна.
...
Он который разделен на 6 блоков:
- **кто**:
...
- **где**:
    ...
    2. где встречаются похожие ситуации?
...
Порядок работы здесь следующий: сначала изучение вмего списока вопросов, чтобы понять весь арсенал различных углов зрения, а потом уже выбор необходимых. **Нерелевантные вопросы** будут вести в тупик. **Релевантные** - давать новую информацию.
...
1. **Оценка основных фактов**:
    ...
    - проверка на наличие текста у сторонников и противников явления, так как и те, и другие могут излагать факты тенденциозно, извращать их или умалчивать для того, чтобы подкрепить свою точку зрения.
