...
**Признак** - это свойство вещи или явления.
...
**Подмена понятия** - когда нарушается закон тождества.
...
1. Не могут быть одновременно истинными два противных суждения.
...
**Причинная связь явлений** - это связь **причины** - явление, которое необходимо вызывает другое явление и **следствия** - являения, вызванное причиной.
...
**"После этого - значит, по причине этого"** - это ошибка, когда происходит смешение причинной связи и простой временной последовательности, что не дает истинного знания о причинах явлений, но и способствует образованию ложных понятий об этих причинах.
...
Гипотеза должна удолетворять главному условию - соответствовать всем известным явлениям, всем фактам опыта. И что она есть единственно возможная, что только при ее помощи вся совокупность наблюдаемым явлений находит себе вполне достаточное объяснение.
...
- **доказывать слишком мало - значит ничего не доказывать** - когда для утверждения доказательства истинности представляют мало доказательств;
...
**Учетверением терминов** - это нарушение шестого правила из-за того, что нарушается логический закон тождества.

## <a id="Опровержение" href="#Опровержение">Опровержение</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

**Опровержение** - это доказательство ложности или несостоятельности какого-либо тезиса. Достигается способавим:
1. **Опровржение фактами** - это самый верный и успешный способ, так как факты постоянны. Задача заключается в приведении противоречащих фактов тезису;
