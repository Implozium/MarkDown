...
- [Node.JS](#8337fc010f)
    - [Запуск](#5f58484048)
    - [Модули](#4fa6e47cc5)
        - [Базовая настройка](#9b0b9625f3)
        - [Экспорт функций модуля](#954cf29df4)
    - [Функции обратного вызова (callback)](#da3d3f085f)
    - [Использование `EventEmitters`](#36531779a5)
        - [Комбинирование колбеков и `EventEmitter`](#ccdbc1ca98)
    - [Ошибки](#27369dba75)
    - [Таймеры](#874799bbad)
    - [Потоки](#199922c6e3)
        - [`stream.Readable`](#cc49ab5261)
            - [Произвольный поток чтения](#4ec2637b8b)
        - [`stream.Writable`](#782b762091)
            - [Произвольный поток записи](#7de24a5c82)
        - [`stream.Duplex`](#4a95b831ca)
        - [`stream.Transform`](#f5058e3df1)
            - [Произвольный поток преобразования](#bc9fe1f754)
    - [`Process`](#0661615568)
        - [Потоки ввода-вывода](#97d7ec4a13)
    - [`Buffer`](#178e9092e2)
        - [`btoa` / `atob`](#bb00ba531f)
        - [Порядок байтов](#cc4dce2af2)
    - [Глобальные объекты](#5abdec577e)
    - [NPM](#c2f4f87b97)
    - [Стандартные модули](#b4bf04fc81)
        - [Модуль `fs`](#46e7d1a07b)
        - [Модуль `util`](#317df4d7d9)
        - [Модуль `child_process`](#1f9fbfd543)
        - [Модуль `cluster`](#66da19bdfc)
        - [Модуль `dns`](#460bf04d13)
        - [Модуль `url`](#e02ca5de76)
        - [Модуль `querystring`](#203ed615da)
        - [Модуль `http`](#02efde90c2)
        - [Модуль `https`](#241b14df64)
        - [Модуль `net`](#173a867257)
        - [Модуль `dgram`](#c01082cea3)
        - [Модуль `path`](#d34a684d85)
        - [Модуль `readline`](#20939a97aa)
    - [Дополнительные модули](#ffd363f0f9)
        - [Модуль `debug`](#4646a7f520)
        - [Модуль `mime`](#a9fd750de3)
        - [Модуль `optimist`](#37942b34cd)
        - [Модуль `nconf`](#d92ec8e588)
        - [Модуль `async`](#fa231964db)
        - [Модуль `ws`](#3236e8709e)
        - [Модуль `formidable`](#d88fd1b176)
        - [Модуль `redis` для работы с Redis](#77860a125b)
            - [Пары ключ/значение](#5bd9b24f81)
            - [Хеш-таблицы](#5e5808f86f)
            - [Список](#bcb0721467)
            - [Множества](#6930c5ddb2)
            - [Подписки](#1094f1b15d)
        - [Модуль `mysql` для работы с MySql](#155f3e49df)
        - [Модуль `mongodb` для работы с MongoDB](#6a0fc91ba5)
    - [Фреймворк `Connect`](#b9908264fb)
        - [Связующие программы](#111b3070aa)
            - [Собственные связующие программы](#315b4e671e)
            - [Собственная обработка ошибок приложения](#48764d7474)
        - [Связующие программы `Connect`](#41ba81d499)
    - [Фреймворк Express](#dda17b8895)
        - [Установка](#e0b98cd961)
        - [Структура каталогов проекта](#049111fe97)
        - [Базовая настройка](#9b0b9625f3)
        - [Кофигурирование](#12dd54f8b4)
        - [Middleware](#6b46c74551)
        - [Роутинг](#02b765a641)
        - [Хранение транзитных сообщений в сеансах](#88eb30db22)
        - [Шаблонизация ejs](#eeedc4d7d4)
    - [Тестирование](#e6a40b2af1)
        - [Модуль `assert`](#25e0f817a8)
    - [Шаблонизатор EJS](#43176537cd)
        - [Фильтры](#60cf8ceef8)
    - [Шаблонизатор Hogan (Mustache)](#3cf1f76505)
        - [Mustache-теги](#a85e32212a)
            - [Лямбда-секции](#d73ca62c24)
        - [Компоненты](#8ae28a3a1c)
    - [Шаблонизатор Jade](#e2be6c401d)
        - [Данные в Jade-шаблоне](#9fa89cb3a0)
        - [Jade-теги](#bfc2a7e018)
        - [Программная логика в Jade-шаблонах](#083c1f3cd7)
        - [Условные и итеративные инструкции](#0b7727e075)
        - [Наследование шаблонов](#c0b5533d64)
        - [Включение шаблонов](#1884df892f)
        - [Примеси](#18009214b3)
    - [Построение собственных модулей](#0eebba8a4c)
        - [Внедрение зависимостей Dependency Injection](#4cf6d633fb)
        - [Локатор служб](#47392df805)
        - [Контейнер внедрения зависимостей, DI-контейнер](#b6201b69f9)
        - [Плагины](#45f4625472)
    - [Подключение модулей, инициализируемых асинхронно](#2f5f6949b0)
    - [Группировка асинхронных операций](#127751290e)
    - [Кэширование асинхронных запросов](#f39692048c)
    - [Использование нескольких процессов](#0c6380d502)
    - [Масштабирование приложений](#374e8e9a98)
        - [Клонирование и распределение нагрузки](#41877ae023)
        - [Динамическое распределение нагрузки с помощью http-proxy и Consul](#edceaadc4a)
        - [Одноранговое распределение нагрузки](#246471ac46)
        - [Декомпозиция сложных приложений](#57e049e376)
        - [Шаблоны интеграции в архитектуре на микрослужбах](#576aeddc56)
            - [Прокси-сервер для служб](#c555d56c95)
            - [Координация служб](#535323fa9e)
            - [Интеграция с помощью брокера сообщений](#d2d3dd4873)
    - [Шаблоны обмена сообщениями и интеграции](#7721270ae5)
        - [Шаблоны однонаправленного обмена и вида "Запрос/ответ"](#e6577a893a)
            - [Очереди сообщений](#5988eefe1f)
            - [Обмен сообщениями через брокера](#e01623f784)
        - [Шаблон "Публикация/подписка"](#a97f261deb)
            - [Протокол AMQP](#cac27cf9d8)
        - [Шаблоны "Запрос/ответ"](#326299bced)
- [Основы проектирования Node-приложений](#939b0550a4)
    - [Структура проекта](#be1c0be8d0)
        - [Структурирование решений на основе компонентов](#d68a0e9af4)
        - [Слои компонентов](#dab9ec1807)
        - [Общие утилиты](#184c5fc988)
        - [Разделение Express "приложения" и "сервера"](#2b6c324fb0)
        - [Параметры приложения](#4d5033c5bd)
- [Основы развертывания Node-приложений](#6da666659e)
    - [Инструмент Nodejitsu Forever](#3384ba3c28)
    - [Поддержание доступности приложения, Upstart](#230d38810f)
    - [Распределение нагрузки с помощью Nginx](#f89c5f4db9)

<a id="8337fc010f" href="#8337fc010f">Node.JS</a>
=======

Представляет собой язык JS на сервере.

## <a id="5f58484048" href="#5f58484048">Запуск</a>

`node <файл входа>.js`

## <a id="4fa6e47cc5" href="#4fa6e47cc5">Модули</a>

### <a id="9b0b9625f3" href="#9b0b9625f3">Базовая настройка</a>
...
### <a id="954cf29df4" href="#954cf29df4">Экспорт функций модуля</a>
...
## <a id="da3d3f085f" href="#da3d3f085f">Функции обратного вызова (callback)</a>
...
## <a id="36531779a5" href="#36531779a5">Использование `EventEmitters`</a>
...
`<EventEmitter>.on("<событие>", <функция_обработки>)` - связывает событие объекта с функцией обработки, которая будет вызвана при событии, возвращает ссылку на объект `<EventEmitter>`, которому она принадлежит, что позволяет связывать в цепочки вызовов несколько прослушивателей событий.  
...
`<EventEmitter>.removeListener("<событие>", <функция_обработки>)` - удаляет функцию прослушивания.
...
### <a id="ccdbc1ca98" href="#ccdbc1ca98">Комбинирование колбеков и `EventEmitter`</a>
...
`process.nextTick(function () {...})` - запускает следующую функцию асинхронно, до следующей операции ввода/вывода.

`setImmediate(function () {...})` - запускает следующую функцию асинхронно, после операции ввода/вывода.

## <a id="199922c6e3" href="#199922c6e3">Потоки</a>

`var stream = require('stream');`

### <a id="cc49ab5261" href="#cc49ab5261">`stream.Readable`</a>
...
`<stream>.on('error', function (error) {...});` - вызывается при ошибке считывания данных из потока.  
...
#### <a id="4ec2637b8b" href="#4ec2637b8b">Произвольный поток чтения</a>
...
### <a id="782b762091" href="#782b762091">`stream.Writable`</a>
...
`<stream>.on('finish', function (error) {...});` - вызывается при завершении считывания данных из буфера потока и финализации потока, после вызова `<stream>.end([<data>])` у потока.  
`<stream>.on('error', function (error) {...});` - вызывается при ошибке считывания данных из потока.
...
#### <a id="7de24a5c82" href="#7de24a5c82">Произвольный поток записи</a>
...
### <a id="4a95b831ca" href="#4a95b831ca">`stream.Duplex`</a>
...
### <a id="f5058e3df1" href="#f5058e3df1">`stream.Transform`</a>
...
#### <a id="bc9fe1f754" href="#bc9fe1f754">Произвольный поток преобразования</a>
...
`_transform` - переопределяет внутренюю функцию преобразования, где `chunk` - данные, `encoding` - кодировка, а `callback` - колбек завершения записи, который необходимо вызвать. Внутри нужно вызвать указаную функцию:  
    `this.push(<chunk>[, "<кодировка>"]);` - записывает данные в буфер потока и если есть еще место в буфере (ограничено `highWaterMark`), то возвращает `true`, иначе `false`, для окончания передачи нужно передать `null`.  
    `callback([<error>[, <chunk>]]);` - альтернативный вызов предыдущего варианта.
...
## <a id="0661615568" href="#0661615568">`Process`</a>
...
`process.on('exit', function (error) {...});` - вызовется непосредственно перед завершением процесса, уже после остановки цикла событий.  
...
`process.on('uncaughtException', function (error) {...});` - вызовется при перехвате не переваченного исключения.

`process.kill(<pid_процесса>[, '<сигнал>']);` - убивает процесс [посылая ему указанный сигнал].

### <a id="97d7ec4a13" href="#97d7ec4a13">Потоки ввода-вывода</a>
...
## <a id="178e9092e2" href="#178e9092e2">`Buffer`</a>
...
### <a id="bb00ba531f" href="#bb00ba531f">`btoa` / `atob`</a>
...
### <a id="cc4dce2af2" href="#cc4dce2af2">Порядок байтов</a>
...
## <a id="5abdec577e" href="#5abdec577e">Глобальные объекты</a>

`__dirname` - возвращает полный путь к каталогу текущего модуля.  
`__filename` - возвращает полный путь к файлу текущего модуля.

## <a id="c2f4f87b97" href="#c2f4f87b97">NPM</a>

`npm i|install [-g|--global] [<имя_модуля>[@<номер_версии>]]` - производит установку всех модулей из файла `package.json` из `dependencies` [указанного модуля `<имя_модуля>` [указанной версии `<номер_версии>`]] в самую ближайшую папку `node_modules`. Ключи:
- `-g`|`--global` - означает использование как глобального модуля;
- `--save` - добавит указанный пакет в список зависимостей проекта для разработки в `dependencies`;
- `--save-dev` - добавит указанный пакет в список зависимостей проекта в `devDependencies`.
...
`npm ls|list|la|ll [-g|--global]` - отображает список установленных локальных [глобальных] пакетов. 
...
## <a id="b4bf04fc81" href="#b4bf04fc81">Стандартные модули</a>

### <a id="46e7d1a07b" href="#46e7d1a07b">Модуль `fs`</a>

Модуль `fs` реализует файловую систему.

`var fs = require('fs');`

`fs.readFile("<путь_к_файлу>"[, {"binary" | "utf8" | <опции>}], function (error, file) {...});` - читает файл и записывает в переменную `file` все его содержимое (по ум. используется тип `Buffer`), а затем вызывает функцию обратного вызова.  
...
`fs.writeFile("<путь_к_файлу>", <содержимое>[, {"binary" | "utf8" | <опции>}], function (error) {...});` - записывает в файл содержимое, а затем вызывает функцию обратного вызова.  
...
`fs.appendFile("<путь_к_файлу>", <содержимое>[, {"binary" | "utf8" | <опции>}], function (error) {...});` - дописывает в файл содержимое, а затем вызывает функцию обратного вызова.  
...
`fs.rename("<путь_к_файлу>", "<новый_путь_к_файлу>", function (error) {...});` - переименовывает файл, а затем вызывает функцию обратного вызова.  
`fs.unlink("<путь_к_файлу>", function (error) {...});` - удаляет файл, а затем вызывает функцию обратного вызова.

`fs.stat("<путь_к_файлу>", function (error, stats) {...});` - возвращает информацию о файле в виде объекта `stats` типа `fs.Stats` с такими методами:
- `stats.isFile()`;
- `stats.isDirectory()`;
- `stats.isBlockDevice()`;
...
`fs.readdir("<путь_к_файлу>", function (error, files) {...});` - читает содержимое каталога, а затем вызывает функцию обратного вызова где `files` - массив файлов каталога.  
`fs.mkdir("<путь_к_каталогу>", function (error) {...});` - создает каталог , а затем вызывает функцию обратного вызова.

`fs.watchFile("<путь_к_файлу>", function (curr, prev) {...});` - отслеживает изменение файла, где `curr` и `prev` представляют текущий и предыдущий объекты `fs.Stat`, которые должны иметь различные временные метки, соответствующие времени изменения файла.
...
`var <stream> = fs.createWriteStream("<путь_к_файлу>"[, <объект_опций>]);` - возвращает поток для записи.

### <a id="317df4d7d9" href="#317df4d7d9">Модуль `util`</a>
...
### <a id="1f9fbfd543" href="#1f9fbfd543">Модуль `child_process`</a>

Модуль `child_process` позволяет запускать дочерние процессы.

`var child_process = require('child_process');`

`child_process.exec("<shell_комманда>"[, <объект_опций>], function (error, stdout, stderr) {...});` - выполняет shell-команду внутри Node.js а затем вызывает callback-функцию.

`child_process.execFile("<путь_к_файлу>"[, <объект_опций>], function (error, stdout, stderr) {...});` - выполняет файл внутри Node.js а затем вызывает callback-функцию.
...
### <a id="66da19bdfc" href="#66da19bdfc">Модуль `cluster`</a>
...
### <a id="460bf04d13" href="#460bf04d13">Модуль `dns`</a>

Модуль `dns` обеспечивает разрешение имен доменов.

`var dns = require('dns');`

`dns.lookup('<доменное_имя>', function (error, addresses, family) {...});` - находит первый ip-адрес указанного доменного имени и вызывает функцию, где `addresses` - его ip-адрес, `family` - тип ip-адреса: 4 или 6.

`dns.resolve('<доменное_имя>', '<тип>', function (error, addresses) {...});` - находит ip-адреса для указанного доменного имени по указанному типу `'<тип>'` (`'A'` - `IPV4`, `'AAAA'` - `IPV6`) и вызывает функцию, где `addresses` - массив его ip-адресов.

`dns.reverse('<ip-адрес>', function (error, hostnames) {...});` - находит список доменов указанного ip-адрес и вызывает функцию, где `hostnames` - список доменных адресов.

### <a id="e02ca5de76" href="#e02ca5de76">Модуль `url`</a>
...
### <a id="203ed615da" href="#203ed615da">Модуль `querystring`</a>
...
### <a id="02efde90c2" href="#02efde90c2">Модуль `http`</a>
...
`<request>.on('error', function (error) {...});` - запускает функцию в случае возникновения ошибки связанную с запросом.

### <a id="241b14df64" href="#241b14df64">Модуль `https`</a>
...
### <a id="173a867257" href="#173a867257">Модуль `net`</a>
...
`socket.on("error", function (error) {...})` - вызывается при ошибке сокета.  
...
### <a id="c01082cea3" href="#c01082cea3">Модуль `dgram`</a>
...
`<socket>.send(<сообщение>[, <отступ>, <длина>], <порт>, "<ip_адрес>"[, function (error) {...}])` - отправляет сообщение, которое содержит данные, которые должны быть `Buffer`, `String`, `Array` [с указанным отступом и длиной] на указанный порт и адрес [, и затем вызовет функцию].
...
### <a id="d34a684d85" href="#d34a684d85">Модуль `path`</a>

Модуль `path` - используется для работы с путями.

`var path = require('path');`

`path.normalize('<путь>')` - нормализирует путь (`..` и `.`), и заменяет множественные `/` на один.  
`path.join(['<путь1>'[, ...])` - соединяет пути и нормализирует.  
`path.parse('<путь>')` - возвращает объект пути строки с `root`, `dir`, `base`, `ext`, `name`.  
`path.resolve(['<путь1>'[, ...])` - разрешает последовательность путей или части путей в абсолютный путь, если много путей с асолютным путем, то выберется последний. 
...
`<domain>.on('error', function (error) {...});` - запускает функцию в случае возникновения ошибки в запускаемой функции.  
...
### <a id="20939a97aa" href="#20939a97aa">Модуль `readline`</a>
...
## <a id="ffd363f0f9" href="#ffd363f0f9">Дополнительные модули</a>

### <a id="4646a7f520" href="#4646a7f520">Модуль `debug`</a>
...
### <a id="a9fd750de3" href="#a9fd750de3">Модуль `mime`</a>
...
### <a id="37942b34cd" href="#37942b34cd">Модуль `optimist`</a>
...
### <a id="d92ec8e588" href="#d92ec8e588">Модуль `nconf`</a>
...
### <a id="fa231964db" href="#fa231964db">Модуль `async`</a>
...
### <a id="3236e8709e" href="#3236e8709e">Модуль `ws`</a>
...
### <a id="77860a125b" href="#77860a125b">Модуль `redis` для работы с Redis</a>
...
#### <a id="5bd9b24f81" href="#5bd9b24f81">Пары ключ/значение</a>
...
#### <a id="5e5808f86f" href="#5e5808f86f">Хеш-таблицы</a>
...
#### <a id="bcb0721467" href="#bcb0721467">Список</a>
...
#### <a id="6930c5ddb2" href="#6930c5ddb2">Множества</a>
...
#### <a id="1094f1b15d" href="#1094f1b15d">Подписки</a>
...
### <a id="155f3e49df" href="#155f3e49df">Модуль `mysql` для работы с MySql</a>
...
### <a id="6a0fc91ba5" href="#6a0fc91ba5">Модуль `mongodb` для работы с MongoDB</a>
...
## <a id="b9908264fb" href="#b9908264fb">Фреймворк `Connect`</a>
...
### <a id="111b3070aa" href="#111b3070aa">Связующие программы</a>
...
#### <a id="315b4e671e" href="#315b4e671e">Собственные связующие программы</a>
...
#### <a id="48764d7474" href="#48764d7474">Собственная обработка ошибок приложения</a>

Аналогично собственной связующей программе, только должна возвращать функцию с указанной сигнатурой `function(error, request, response, next) {...}`, где `error` - ошибка и передать (вызвать) ее в `<connect>.use(<связующая_программа>(...));`. Будет вызвана при вызове `next(<Error>)` или исключению в какой-то связующей программе.

### <a id="41ba81d499" href="#41ba81d499">Связующие программы `Connect`</a>
...
## <a id="dda17b8895" href="#dda17b8895">Фреймворк Express</a>

Фреймворк `Express` представляет собой надстройку над `Connect`.

### <a id="e0b98cd961" href="#e0b98cd961">Установка</a>

`nmp I -g express`  
`express -e -s` - флаг `-e` включает поддержку EJS в файле `app.js`, а флаг `-s` - поддержку сеансов  
`nmp i`

### <a id="049111fe97" href="#049111fe97">Структура каталогов проекта</a>
...
### <a id="12dd54f8b4" href="#12dd54f8b4">Кофигурирование</a>
...
### <a id="6b46c74551" href="#6b46c74551">Middleware</a>

Используются аналогичные как из `connect`.

`express.errorHandler(error, request, response, next);` - производит форматированный вывод ошибки.
...
### <a id="02b765a641" href="#02b765a641">Роутинг</a>
...
### <a id="88eb30db22" href="#88eb30db22">Хранение транзитных сообщений в сеансах</a>
...
### <a id="eeedc4d7d4" href="#eeedc4d7d4">Шаблонизация ejs</a>
...
## <a id="e6a40b2af1" href="#e6a40b2af1">Тестирование</a>
...
### <a id="25e0f817a8" href="#25e0f817a8">Модуль `assert`</a>
...
## <a id="43176537cd" href="#43176537cd">Шаблонизатор EJS</a>
...
### <a id="60cf8ceef8" href="#60cf8ceef8">Фильтры</a>
...
## <a id="3cf1f76505" href="#3cf1f76505">Шаблонизатор Hogan (Mustache)</a>
...
### <a id="a85e32212a" href="#a85e32212a">Mustache-теги</a>
...
#### <a id="d73ca62c24" href="#d73ca62c24">Лямбда-секции</a>
...
### <a id="8ae28a3a1c" href="#8ae28a3a1c">Компоненты</a>
...
## <a id="e2be6c401d" href="#e2be6c401d">Шаблонизатор Jade</a>
...
### <a id="9fa89cb3a0" href="#9fa89cb3a0">Данные в Jade-шаблоне</a>
...
### <a id="bfc2a7e018" href="#bfc2a7e018">Jade-теги</a>

`#{<переменная>}` - выводит значение переменной в содержимом тега.  
`<переменная>` - выводит значение переменной в теге.

### <a id="083c1f3cd7" href="#083c1f3cd7">Программная логика в Jade-шаблонах</a>
...
### <a id="0b7727e075" href="#0b7727e075">Условные и итеративные инструкции</a>
...
### <a id="c0b5533d64" href="#c0b5533d64">Наследование шаблонов</a>
...
### <a id="1884df892f" href="#1884df892f">Включение шаблонов</a>

`include <имя_шаблона>` - включает шаблон в текущий шаблон, также можно включить имя файла.

### <a id="18009214b3" href="#18009214b3">Примеси</a>
...
## <a id="0eebba8a4c" href="#0eebba8a4c">Построение собственных модулей</a>
...
### <a id="4cf6d633fb" href="#4cf6d633fb">Внедрение зависимостей Dependency Injection</a>
...
### <a id="47392df805" href="#47392df805">Локатор служб</a>
...
### <a id="b6201b69f9" href="#b6201b69f9">Контейнер внедрения зависимостей, DI-контейнер</a>
...
## <a id="2f5f6949b0" href="#2f5f6949b0">Подключение модулей, инициализируемых асинхронно</a>
...
## <a id="127751290e" href="#127751290e">Группировка асинхронных операций</a>
...
## <a id="f39692048c" href="#f39692048c">Кэширование асинхронных запросов</a>
...
## <a id="0c6380d502" href="#0c6380d502">Использование нескольких процессов</a>
...
## <a id="374e8e9a98" href="#374e8e9a98">Масштабирование приложений</a>
...
### <a id="41877ae023" href="#41877ae023">Клонирование и распределение нагрузки</a>

Приложению Node.js досту­пен один поток и ему по умолчанию доступен ограниченный объем памяти 1,7 ГБ на 64-битных машинах (этот предел можно увеличить с помощью специального пара­метра командной строки `--max_old_space_size`).
...
### <a id="edceaadc4a" href="#edceaadc4a">Динамическое распределение нагрузки с помощью http-proxy и Consul</a>
...
### <a id="246471ac46" href="#246471ac46">Одноранговое распределение нагрузки</a>
...
### <a id="57e049e376" href="#57e049e376">Декомпозиция сложных приложений</a>
...
### <a id="576aeddc56" href="#576aeddc56">Шаблоны интеграции в архитектуре на микрослужбах</a>

#### <a id="c555d56c95" href="#c555d56c95">Прокси-сервер для служб</a>
...
#### <a id="535323fa9e" href="#535323fa9e">Координация служб</a>
...
#### <a id="d2d3dd4873" href="#d2d3dd4873">Интеграция с помощью брокера сообщений</a>
...
## <a id="7721270ae5" href="#7721270ae5">Шаблоны обмена сообщениями и интеграции</a>

### <a id="e6577a893a" href="#e6577a893a">Шаблоны однонаправленного обмена и вида "Запрос/ответ"</a>
...
#### <a id="5988eefe1f" href="#5988eefe1f">Очереди сообщений</a>
...
#### <a id="e01623f784" href="#e01623f784">Обмен сообщениями через брокера</a>
...
### <a id="a97f261deb" href="#a97f261deb">Шаблон "Публикация/подписка"</a>
...
#### <a id="cac27cf9d8" href="#cac27cf9d8">Протокол AMQP</a>
...
### <a id="326299bced" href="#326299bced">Шаблоны "Запрос/ответ"</a>
...
<a id="939b0550a4" href="#939b0550a4">Основы проектирования Node-приложений</a>
=====================================

## <a id="be1c0be8d0" href="#be1c0be8d0">Структура проекта</a>

### <a id="d68a0e9af4" href="#d68a0e9af4">Структурирование решений на основе компонентов</a>
...
### <a id="dab9ec1807" href="#dab9ec1807">Слои компонентов</a>
...
### <a id="184c5fc988" href="#184c5fc988">Общие утилиты</a>
...
### <a id="2b6c324fb0" href="#2b6c324fb0">Разделение Express "приложения" и "сервера"</a>
...
### <a id="4d5033c5bd" href="#4d5033c5bd">Параметры приложения</a>
...
<a id="6da666659e" href="#6da666659e">Основы развертывания Node-приложений</a>
====================================

## <a id="3384ba3c28" href="#3384ba3c28">Инструмент Nodejitsu Forever</a>
...
## <a id="230d38810f" href="#230d38810f">Поддержание доступности приложения, Upstart</a>
...
## <a id="f89c5f4db9" href="#f89c5f4db9">Распределение нагрузки с помощью Nginx</a>
