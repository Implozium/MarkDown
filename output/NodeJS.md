...
- [Node.JS](#NodeJS)
    ...
    - [Использование `EventEmitters`](#Использование-EventEmitters)
        - [Комбинирование колбеков и `EventEmitter`](#Комбинирование-колбеков-и-EventEmitter)
    - [Ошибки](#Ошибки)
    - [Таймеры](#Таймеры)
    - [Потоки](#Потоки)
    ...
    - [Дополнительные модули](#Дополнительные-модули)
        ...
        - [Модуль `redis` для работы с Redis](#Модуль-redis-для-работы-с-Redis)
            ...
            - [Множества](#Множества)
            - [Подписки](#Подписки)
        - [Модуль `mysql` для работы с MySql](#Модуль-mysql-для-работы-с-MySql)
    ...
    - [Фреймворк Express](#Фреймворк-Express)
        ...
        - [Базовая настройка](#Базовая-настройка)
        - [Кофигурирование](#Кофигурирование)
...
- [Основы проектирования Node-приложений](#Основы-проектирования-Node-приложений)
    - [Структура проекта](#Структура-проекта)
        - [Структурирование решений на основе компонентов](#Структурирование-решений-на-основе-компонентов)
...
<a id="NodeJS" href="#NodeJS">Node.JS</a>
=======
...
### <a id="Базовая-настройка" href="#Базовая-настройка">Базовая настройка</a>
...
### <a id="Экспорт-функций-модуля" href="#Экспорт-функций-модуля">Экспорт функций модуля</a>
...
## <a id="Функции-обратного-вызова-callback" href="#Функции-обратного-вызова-callback">Функции обратного вызова (callback)</a>
...
## <a id="Использование-EventEmitters" href="#Использование-EventEmitters">Использование `EventEmitters`</a>
...
### <a id="Комбинирование-колбеков-и-EventEmitter" href="#Комбинирование-колбеков-и-EventEmitter">Комбинирование колбеков и `EventEmitter`</a>
...
## <a id="Таймеры" href="#Таймеры">Таймеры</a>
...
## <a id="Потоки" href="#Потоки">Потоки</a>

`var stream = require('stream');`

### <a id="streamReadable" href="#streamReadable">`stream.Readable`</a>
...
#### <a id="Произвольный-поток-чтения" href="#Произвольный-поток-чтения">Произвольный поток чтения</a>
...
### <a id="streamWritable" href="#streamWritable">`stream.Writable`</a>
...
#### <a id="Произвольный-поток-записи" href="#Произвольный-поток-записи">Произвольный поток записи</a>
...
### <a id="streamDuplex" href="#streamDuplex">`stream.Duplex`</a>
...
### <a id="streamTransform" href="#streamTransform">`stream.Transform`</a>
...
#### <a id="Произвольный-поток-преобразования" href="#Произвольный-поток-преобразования">Произвольный поток преобразования</a>
...
### <a id="Потоки-ввода-вывода" href="#Потоки-ввода-вывода">Потоки ввода-вывода</a>
...
## <a id="Buffer" href="#Buffer">`Buffer`</a>
...
### <a id="btoa--atob" href="#btoa--atob">`btoa` / `atob`</a>
...
### <a id="Порядок-байтов" href="#Порядок-байтов">Порядок байтов</a>
...
## <a id="Стандартные-модули" href="#Стандартные-модули">Стандартные модули</a>

### <a id="Модуль-fs" href="#Модуль-fs">Модуль `fs`</a>
...
### <a id="Модуль-util" href="#Модуль-util">Модуль `util`</a>
...
### <a id="Модуль-childprocess" href="#Модуль-childprocess">Модуль `child_process`</a>
...
### <a id="Модуль-cluster" href="#Модуль-cluster">Модуль `cluster`</a>
...
### <a id="Модуль-dns" href="#Модуль-dns">Модуль `dns`</a>
...
### <a id="Модуль-url" href="#Модуль-url">Модуль `url`</a>
...
### <a id="Модуль-querystring" href="#Модуль-querystring">Модуль `querystring`</a>
...
### <a id="Модуль-http" href="#Модуль-http">Модуль `http`</a>
...
### <a id="Модуль-https" href="#Модуль-https">Модуль `https`</a>
...
### <a id="Модуль-net" href="#Модуль-net">Модуль `net`</a>
...
### <a id="Модуль-dgram" href="#Модуль-dgram">Модуль `dgram`</a>
...
### <a id="Модуль-path" href="#Модуль-path">Модуль `path`</a>
...
### <a id="Модуль-readline" href="#Модуль-readline">Модуль `readline`</a>
...
## <a id="Дополнительные-модули" href="#Дополнительные-модули">Дополнительные модули</a>

### <a id="Модуль-debug" href="#Модуль-debug">Модуль `debug`</a>
...
### <a id="Модуль-mime" href="#Модуль-mime">Модуль `mime`</a>
...
### <a id="Модуль-optimist" href="#Модуль-optimist">Модуль `optimist`</a>
...
### <a id="Модуль-nconf" href="#Модуль-nconf">Модуль `nconf`</a>
...
### <a id="Модуль-async" href="#Модуль-async">Модуль `async`</a>
...
### <a id="Модуль-ws" href="#Модуль-ws">Модуль `ws`</a>
...
### <a id="Модуль-formidable" href="#Модуль-formidable">Модуль `formidable`</a>
...
### <a id="Модуль-redis-для-работы-с-Redis" href="#Модуль-redis-для-работы-с-Redis">Модуль `redis` для работы с Redis</a>
...
#### <a id="Пары-ключзначение" href="#Пары-ключзначение">Пары ключ/значение</a>
...
#### <a id="Хеш-таблицы" href="#Хеш-таблицы">Хеш-таблицы</a>
...
#### <a id="Множества" href="#Множества">Множества</a>
...
#### <a id="Подписки" href="#Подписки">Подписки</a>
...
### <a id="Модуль-mysql-для-работы-с-MySql" href="#Модуль-mysql-для-работы-с-MySql">Модуль `mysql` для работы с MySql</a>
...
### <a id="Модуль-mongodb-для-работы-с-MongoDB" href="#Модуль-mongodb-для-работы-с-MongoDB">Модуль `mongodb` для работы с MongoDB</a>
...
## <a id="Фреймворк-Connect" href="#Фреймворк-Connect">Фреймворк `Connect`</a>
...
### <a id="Связующие-программы" href="#Связующие-программы">Связующие программы</a>
...
#### <a id="Собственные-связующие-программы" href="#Собственные-связующие-программы">Собственные связующие программы</a>
...
#### <a id="Собственная-обработка-ошибок-приложения" href="#Собственная-обработка-ошибок-приложения">Собственная обработка ошибок приложения</a>
...
### <a id="Связующие-программы-Connect" href="#Связующие-программы-Connect">Связующие программы `Connect`</a>
...
## <a id="Фреймворк-Express" href="#Фреймворк-Express">Фреймворк Express</a>
...
### <a id="Структура-каталогов-проекта" href="#Структура-каталогов-проекта">Структура каталогов проекта</a>
...
### <a id="Кофигурирование" href="#Кофигурирование">Кофигурирование</a>
...
### <a id="Роутинг" href="#Роутинг">Роутинг</a>
...
### <a id="Хранение-транзитных-сообщений-в-сеансах" href="#Хранение-транзитных-сообщений-в-сеансах">Хранение транзитных сообщений в сеансах</a>
...
### <a id="Шаблонизация-ejs" href="#Шаблонизация-ejs">Шаблонизация ejs</a>
...
### <a id="Модуль-assert" href="#Модуль-assert">Модуль `assert`</a>
...
## <a id="Шаблонизатор-EJS" href="#Шаблонизатор-EJS">Шаблонизатор EJS</a>
...
### <a id="Фильтры" href="#Фильтры">Фильтры</a>
...
## <a id="Шаблонизатор-Hogan-Mustache" href="#Шаблонизатор-Hogan-Mustache">Шаблонизатор Hogan (Mustache)</a>
...
### <a id="Mustache-теги" href="#Mustache-теги">Mustache-теги</a>
...
#### <a id="Лямбда-секции" href="#Лямбда-секции">Лямбда-секции</a>
...
### <a id="Компоненты" href="#Компоненты">Компоненты</a>
...
## <a id="Шаблонизатор-Jade" href="#Шаблонизатор-Jade">Шаблонизатор Jade</a>
...
### <a id="Данные-в-Jade-шаблоне" href="#Данные-в-Jade-шаблоне">Данные в Jade-шаблоне</a>
...
### <a id="Jade-теги" href="#Jade-теги">Jade-теги</a>

`#{<переменная>}` - выводит значение переменной в содержимом тега.  
`<переменная>` - выводит значение переменной в теге.

### <a id="Программная-логика-в-Jade-шаблонах" href="#Программная-логика-в-Jade-шаблонах">Программная логика в Jade-шаблонах</a>
...
### <a id="Условные-и-итеративные-инструкции" href="#Условные-и-итеративные-инструкции">Условные и итеративные инструкции</a>
...
### <a id="Наследование-шаблонов" href="#Наследование-шаблонов">Наследование шаблонов</a>
...
### <a id="Включение-шаблонов" href="#Включение-шаблонов">Включение шаблонов</a>

`include <имя_шаблона>` - включает шаблон в текущий шаблон, также можно включить имя файла.

### <a id="Примеси" href="#Примеси">Примеси</a>
...
## <a id="Построение-собственных-модулей" href="#Построение-собственных-модулей">Построение собственных модулей</a>
...
### <a id="Внедрение-зависимостей-Dependency-Injection" href="#Внедрение-зависимостей-Dependency-Injection">Внедрение зависимостей Dependency Injection</a>
...
### <a id="Локатор-служб" href="#Локатор-служб">Локатор служб</a>
...
### <a id="Контейнер-внедрения-зависимостей-DI-контейнер" href="#Контейнер-внедрения-зависимостей-DI-контейнер">Контейнер внедрения зависимостей, DI-контейнер</a>
...
## <a id="Подключение-модулей-инициализируемых-асинхронно" href="#Подключение-модулей-инициализируемых-асинхронно">Подключение модулей, инициализируемых асинхронно</a>
...
## <a id="Группировка-асинхронных-операций" href="#Группировка-асинхронных-операций">Группировка асинхронных операций</a>
...
## <a id="Кэширование-асинхронных-запросов" href="#Кэширование-асинхронных-запросов">Кэширование асинхронных запросов</a>
...
## <a id="Использование-нескольких-процессов" href="#Использование-нескольких-процессов">Использование нескольких процессов</a>
...
## <a id="Масштабирование-приложений" href="#Масштабирование-приложений">Масштабирование приложений</a>
...
### <a id="Клонирование-и-распределение-нагрузки" href="#Клонирование-и-распределение-нагрузки">Клонирование и распределение нагрузки</a>
...
### <a id="Динамическое-распределение-нагрузки-с-помощью-http-proxy-и-Consul" href="#Динамическое-распределение-нагрузки-с-помощью-http-proxy-и-Consul">Динамическое распределение нагрузки с помощью http-proxy и Consul</a>
...
### <a id="Одноранговое-распределение-нагрузки" href="#Одноранговое-распределение-нагрузки">Одноранговое распределение нагрузки</a>
...
### <a id="Декомпозиция-сложных-приложений" href="#Декомпозиция-сложных-приложений">Декомпозиция сложных приложений</a>
...
### <a id="Шаблоны-интеграции-в-архитектуре-на-микрослужбах" href="#Шаблоны-интеграции-в-архитектуре-на-микрослужбах">Шаблоны интеграции в архитектуре на микрослужбах</a>

#### <a id="Прокси-сервер-для-служб" href="#Прокси-сервер-для-служб">Прокси-сервер для служб</a>
...
#### <a id="Координация-служб" href="#Координация-служб">Координация служб</a>
...
#### <a id="Интеграция-с-помощью-брокера-сообщений" href="#Интеграция-с-помощью-брокера-сообщений">Интеграция с помощью брокера сообщений</a>
...
## <a id="Шаблоны-обмена-сообщениями-и-интеграции" href="#Шаблоны-обмена-сообщениями-и-интеграции">Шаблоны обмена сообщениями и интеграции</a>

### <a id="Шаблоны-однонаправленного-обмена-и-вида-Запросответ" href="#Шаблоны-однонаправленного-обмена-и-вида-Запросответ">Шаблоны однонаправленного обмена и вида "Запрос/ответ"</a>
...
#### <a id="Очереди-сообщений" href="#Очереди-сообщений">Очереди сообщений</a>
...
#### <a id="Обмен-сообщениями-через-брокера" href="#Обмен-сообщениями-через-брокера">Обмен сообщениями через брокера</a>
...
### <a id="Шаблон-Публикацияподписка" href="#Шаблон-Публикацияподписка">Шаблон "Публикация/подписка"</a>
...
#### <a id="Протокол-AMQP" href="#Протокол-AMQP">Протокол AMQP</a>
...
### <a id="Шаблоны-Запросответ" href="#Шаблоны-Запросответ">Шаблоны "Запрос/ответ"</a>
...
<a id="Основы-проектирования-Node-приложений" href="#Основы-проектирования-Node-приложений">Основы проектирования Node-приложений</a>
=====================================

## <a id="Структура-проекта" href="#Структура-проекта">Структура проекта</a>

### <a id="Структурирование-решений-на-основе-компонентов" href="#Структурирование-решений-на-основе-компонентов">Структурирование решений на основе компонентов</a>
...
### <a id="Слои-компонентов" href="#Слои-компонентов">Слои компонентов</a>
...
### <a id="Общие-утилиты" href="#Общие-утилиты">Общие утилиты</a>
...
### <a id="Разделение-Express-приложения-и-сервера" href="#Разделение-Express-приложения-и-сервера">Разделение Express "приложения" и "сервера"</a>
...
### <a id="Параметры-приложения" href="#Параметры-приложения">Параметры приложения</a>
...
<a id="Основы-развертывания-Node-приложений" href="#Основы-развертывания-Node-приложений">Основы развертывания Node-приложений</a>
====================================

## <a id="Инструмент-Nodejitsu-Forever" href="#Инструмент-Nodejitsu-Forever">Инструмент Nodejitsu Forever</a>
...
## <a id="Поддержание-доступности-приложения-Upstart" href="#Поддержание-доступности-приложения-Upstart">Поддержание доступности приложения, Upstart</a>
...
## <a id="Распределение-нагрузки-с-помощью-Nginx" href="#Распределение-нагрузки-с-помощью-Nginx">Распределение нагрузки с помощью Nginx</a>
