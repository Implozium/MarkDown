...
- [Node.JS](#NodeJS)
    - [Запуск](#Запуск)
    - [Ассинхронность для операций **I/O**](#Ассинхронность-для-операций-IO)
    - [Модули](#Модули)
...
## <a id="Ассинхронность-для-операций-IO" href="#Ассинхронность-для-операций-IO">Ассинхронность для операций **I/O**</a>

`UV_THREADPOOL_SIZE=<количество_ассинхронных_нитий>` - переменная окружения, которая устанавливает количество потоков (нитий) для операций **I/O** (по умолчанию 4).
...
### <a id="Комбинирование-колбэков-и-EventEmitter" href="#Комбинирование-колбэков-и-EventEmitter">Комбинирование колбэков и `EventEmitter`</a>
...
`response.json(<JSON>)` - отсылает JSON объект.  
`response.send([<код_ответа>, ]<текст_JSON> | '<текст>')` - отсылает [код ответа] сразу данные.  
`response.sendStatus(<код_ответа>)` - отсылает код ответа и текст ответа, который соответстсвует статусу.
...
## <a id="Шаблон-обработки-ошибок-Circuit-Breaker" href="#Шаблон-обработки-ошибок-Circuit-Breaker">Шаблон обработки ошибок (**Circuit Breaker**)</a>
...
## <a id="Струткура-приложения" href="#Струткура-приложения">Струткура приложения</a>
