...
## <a id="Асинхронность-для-операций-IO" href="#Асинхронность-для-операций-IO">Асинхронность для операций **I/O**</a>
...
### <a id="Модуль-workerthreads" href="#Модуль-workerthreads">Модуль `worker_threads`</a>
