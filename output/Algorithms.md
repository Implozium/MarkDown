...
- [Анализ алгоритмов](#user-content-Анализ-алгоритмов)
    - [`Θ` ("тета от ...") асимптотическая граница сверху и снизу](#user-content--тета-от--асимптотическая-граница-сверху-и-снизу)
    - [`O` ("o большое от ...") асимптотическая верхняя граница](#user-content-O-o-большое-от--асимптотическая-верхняя-граница)
    - [`Ω` ("омега от ...") асимптотическая нижняя граница](#user-content--омега-от--асимптотическая-нижняя-граница)
    - [`o` ("o малое от ...") верхний предел, не являющийся асимптотически точной оценкой функции](#user-content-o-o-малое-от--верхний-предел-не-являющийся-асимптотически-точной-оценкой-функции)
    - [`ω` ("омега малое от ...") нижний предел, не являющийся асимптотически точной оценкой функции](#user-content--омега-малое-от--нижний-предел-не-являющийся-асимптотически-точной-оценкой-функции)
    - [Трихотомия](#user-content-Трихотомия)
    - [Стандартные обозначения и часто встречающиеся функции](#user-content-Стандартные-обозначения-и-часто-встречающиеся-функции)
        - [Монотонность](#user-content-Монотонность)
        - [Полы и потолки](#user-content-Полы-и-потолки)
        - [Модульная арифметика](#user-content-Модульная-арифметика)
        - [Полином](#user-content-Полином)
        - [Показательная функция](#user-content-Показательная-функция)
        - [Логарифм](#user-content-Логарифм)
        - [Факториал (`n!`)](#user-content-Факториал-n)
        - [Функциональная итерация](#user-content-Функциональная-итерация)
- [Разработка алгоритмов](#user-content-Разработка-алгоритмов)
    - [Метод декомпозиции (разделяй и властвуй)](#user-content-Метод-декомпозиции-разделяй-и-властвуй)
- [Виды алгоритмов](#user-content-Виды-алгоритмов)
    - [Разделяй и властвуй](#user-content-Разделяй-и-властвуй)
    - [Жадные алгоритмы](#user-content-Жадные-алгоритмы)
    - [Динамическое программирование](#user-content-Динамическое-программирование)
    - [Регресия](#user-content-Регресия)
- [Алгоритмы сортировки](#user-content-Алгоритмы-сортировки)
    - [Сортировка вставкой](#user-content-Сортировка-вставкой)
    - [Сортировка слиянием](#user-content-Сортировка-слиянием)
    - [Пузырьковая сортировка](#user-content-Пузырьковая-сортировка)
- [Нейронные сети](#user-content-Нейронные-сети)
...
## <a id="o-o-малое-от--верхний-предел-не-являющийся-асимптотически-точной-оценкой-функции" href="#o-o-малое-от--верхний-предел-не-являющийся-асимптотически-точной-оценкой-функции">`o` ("o малое от ...") верхний предел, не являющийся асимптотически точной оценкой функции</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Разделяй-и-властвуй" href="#Разделяй-и-властвуй">Разделяй и властвуй</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Алгоритм-создания-всех-наборов-элементов" href="#Алгоритм-создания-всех-наборов-элементов">Алгоритм создания всех наборов элементов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Алгоритм-Леванштейна" href="#Алгоритм-Леванштейна">Алгоритм Леванштейна</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
