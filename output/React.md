...
- [Контролируемые компоненты](#Контролируемые-компоненты)
    ...
    - [Перерисовка компонента](#Перерисовка-компонента)
    - [Хуки](#Хуки)
        - [Стандартные хуки](#Стандартные-хуки)
            ...
            - [Хук переходов `React.useTransition`](#Хук-переходов-ReactuseTransition)
                - [`React.startTransition`](#ReactstartTransition)
            - [Хук идентификаторов `React.useId`](#Хук-идентификаторов-ReactuseId)
            - [Хук отладки `React.useDebugValue`](#Хук-отладки-ReactuseDebugValue)
            - [Хук отложеного значения `React.useDeferredValue`](#Хук-отложеного-значения-ReactuseDeferredValue)
