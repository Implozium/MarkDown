...
- [Контролируемые компоненты](#Контролируемые-компоненты)
    ...
    - [Хуки](#Хуки)
        - [Стандартные хуки](#Стандартные-хуки)
            ...
            - [Хук колбэк `React.useContext`](#Хук-колбэк-ReactuseContext)
...
### <a id="Стандартные-хуки" href="#Стандартные-хуки">Стандартные хуки</a>

#### <a id="Хук-состояния-ReactuseState" href="#Хук-состояния-ReactuseState">Хук состояния `React.useState`</a>
...
- `set<Переменная>` - функция для изменения значения: `set<Переменная>(<новое_значение>)`;
- `<начальное_значение>` - начальное значение состояния, если это функция, то она вызовится один раз и должна вернуть начальное состояние.

> `const [count, setCount] = useState(0);`

#### <a id="Хук-эффекта-ReactuseEffect" href="#Хук-эффекта-ReactuseEffect">Хук эффекта `React.useEffect`</a>
...
#### <a id="Хук-контекста-ReactuseContext" href="#Хук-контекста-ReactuseContext">Хук контекста `React.useContext`</a>
...
#### <a id="Хук-редюсера-ReactuseReducer" href="#Хук-редюсера-ReactuseReducer">Хук редюсера `React.useReducer`</a>
...
#### <a id="Хук-колбэк-ReactuseContext" href="#Хук-колбэк-ReactuseContext">Хук колбэк `React.useContext`</a>
...
### <a id="Пользовательские-хуки" href="#Пользовательские-хуки">Пользовательские хуки</a>
...
## <a id="Компоненты-высшего-порядка-higher-order-component-HOC" href="#Компоненты-высшего-порядка-higher-order-component-HOC">Компоненты высшего порядка (higher order component, HOC)</a>
...
<a id="Redux-Form" href="#Redux-Form">Redux-Form</a>
==========

Используется для управления состоянием форм в в приложении React.

## <a id="Инициализация" href="#Инициализация">Инициализация</a>
...
## <a id="Многоразовые-компоненты" href="#Многоразовые-компоненты">Многоразовые компоненты</a>
...
### <a id="Сложные-компоненты" href="#Сложные-компоненты">Сложные компоненты</a>
...
### <a id="Множественные-компоненты" href="#Множественные-компоненты">Множественные компоненты</a>
...
## <a id="Создатели-действий" href="#Создатели-действий">Создатели действий</a>
