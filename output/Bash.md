...
- [Основы](#3535f8046b)
    - [Основные понятия](#074b12b117)
        - [Запуск](#5f58484048)
        - [Строение файла скрипта](#738e399b61)
    - [Переменные](#06423d48d5)
    - [Конструкция if-then-else](#f202327366)
        - [Сравнения и проверки](#dae37ab2d0)
            - [Сравнение чисел](#d6a8543b65)
            - [Сравнение строк](#6ad2aee972)
            - [Проверки файлов](#3a4f4a6a04)
    - [Циклы](#7617f64c55)
        - [Цикл `for`](#f9871e7e1b)
        - [Установка разделителей полей](#ff2501f850)
        - [Обход директорий](#a80a7a8dee)
        - [Цикл `for` в стиле C](#38a7bd899a)
        - [Цикл `while`](#c7b4b37947)
        - [Команда `break`](#e1cf95584b)
        - [Команда `continue`](#2512572382)
        - [Перенаправление вывода цикла](#b92f6f8340)
    - [Параметры командной строки](#9624e7d513)
        - [Команда `shift`](#b01297760a)
    - [Конструкция case](#862a775284)
    - [Стандартные ключи Linux](#ed726c9175)
    - [Ввод значений от пользователя](#4ecfff644f)
    - [Дескрипторы файлов](#8d6c134e15)
        - [Перенаправление потоков ошибок и вывода](#8052055b5b)
        - [Временное перенаправление вывода](#742929b553)
        - [Постоянное перенаправление вывода](#7fa1fd84a4)
        - [Перенаправление ввода в скриптах](#9cd874e279)
        - [Создание собственного перенаправления вывода](#9c888c0fe5)
        - [Получение сведений об открытых дескрипторах](#1a74e3d995)
        - [Подавление вывода](#96664c24df)
    - [Сигналы Linux](#f51a9128e4)
        - [Основные сигналы](#08ef916699)
        - [Временная остановка процесса](#d6dbc2049f)
        - [Перехват сигналов](#26395bc57a)
    - [Выполнение сценариев командной строки в фоновом режиме](#5d83d9aed1)
    - [Планирование запуска скриптов](#36c026aa4b)
    - [Запуск скриптов по расписанию](#4a32a6c3c2)
    - [Функции](#3a2810302d)
        - [Переменные](#06423d48d5)
        - [Массив](#9aeaead187)
    - [Создание и использование библиотек](#6e805e799d)
- [`sed`](#2bac2d8a88)
    - [Опции](#1f241da628)
        - [Дополнительные ключи](#7532cb50c3)
        - [Флаги](#faa0514424)
        - [Символы-разделители](#416d77f684)
        - [Выбор фрагментов текста для обработки](#be751fde47)
        - [Удаление строк](#3b3777a3e4)
        - [Вставка текста в поток](#98b10c184d)
        - [Замена строк](#dbb20a4673)
        - [Замена символов](#87ba85adb8)
        - [Вывод номеров строк](#93591f0ab8)
        - [Чтение данных для вставки из файла](#5c9c16d197)
        - [Регулярные выражения](#90a3d1045b)
- [`awk`](#53851a1b5a)
    - [Опции](#1f241da628)
    - [Программа](#73f1b922c0)
        - [Позиционные переменные, хранящие данные полей](#8b54bcfb77)
        - [Файл скрипта](#80e4e3fcd4)
        - [Выполнение команд до начала обработки данных](#4b6f1d2b69)
        - [Выполнение команд после окончания обработки данных](#8758ca32a2)
        - [Встроенные переменные](#847c20d648)
        - [Условный оператор](#cc2295a909)
        - [Цикл while](#2ed1488602)
        - [Цикл for](#b4a1674b20)
    - [Форматированный вывод данных](#410e5ccc64)
        - [Символы](#13c9d3212a)
        - [Модификаторы](#10cacf0c1a)
    - [Встроенные математические функции](#1597651a4a)
    - [Строковые функции](#b57a21f457)
    - [Пользовательские функции](#ed13da7c89)
- [Регулярные выражения](#90a3d1045b)
    - [Специальные классы символов](#9f2612ea3f)
- [`tar`](#31ab018022)
    - [Запаковывание](#2c41462cae)
    - [Распаковывание](#8931f3ce7f)
- [`wget`](#141ce0cf76)
- [`grep`](#5043d27bd8)
- [Процессы](#f4f65400b1)
    - [`ps`](#ce6e562f11)
    - [Выводимая информация](#eefd2ce841)
    - [`kill`](#499bd191d2)
    - [`pkill`](#0d146170eb)
    - [`killall`](#5738a27c6b)
- [`ssh`](#440c35b2c6)
- [`screen`](#26a7d38b39)
- [Другие команды](#abaee1a7ea)

<a id="3535f8046b" href="#3535f8046b">Основы</a>
======

## <a id="074b12b117" href="#074b12b117">Основные понятия</a>
...
### <a id="738e399b61" href="#738e399b61">Строение файла скрипта</a>
...
## <a id="f202327366" href="#f202327366">Конструкция if-then-else</a>
...
### <a id="dae37ab2d0" href="#dae37ab2d0">Сравнения и проверки</a>
...
#### <a id="d6a8543b65" href="#d6a8543b65">Сравнение чисел</a>
...
#### <a id="6ad2aee972" href="#6ad2aee972">Сравнение строк</a>
...
#### <a id="3a4f4a6a04" href="#3a4f4a6a04">Проверки файлов</a>
...
### <a id="ff2501f850" href="#ff2501f850">Установка разделителей полей</a>
...
### <a id="a80a7a8dee" href="#a80a7a8dee">Обход директорий</a>

В качестве списка может быть указано путь к директории, подстановочный знак `*` - обозначает все.

### <a id="38a7bd899a" href="#38a7bd899a">Цикл `for` в стиле C</a>
...
Вместо команды `<комманда>`, можно использовать выражение.

### <a id="e1cf95584b" href="#e1cf95584b">Команда `break`</a>

Эта команда позволяет прервать выполнение цикла.

### <a id="2512572382" href="#2512572382">Команда `continue`</a>

Эта команда завершает текущую итерацию досрочно и начинает следующую, при этом выхода из цикла не происходит.

### <a id="b92f6f8340" href="#b92f6f8340">Перенаправление вывода цикла</a>

После слова `done`, на той же сточке можно указать перенаправление в файл.

## <a id="9624e7d513" href="#9624e7d513">Параметры командной строки</a>
...
## <a id="ed726c9175" href="#ed726c9175">Стандартные ключи Linux</a>
...
## <a id="4ecfff644f" href="#4ecfff644f">Ввод значений от пользователя</a>
...
## <a id="8d6c134e15" href="#8d6c134e15">Дескрипторы файлов</a>
...
### <a id="8052055b5b" href="#8052055b5b">Перенаправление потоков ошибок и вывода</a>
...
### <a id="742929b553" href="#742929b553">Временное перенаправление вывода</a>

`<комманда> >&1` - перенаправление вывода команды в поток вывода.  
`<комманда> >&2` - перенаправление вывода команды в поток ошибки.

### <a id="7fa1fd84a4" href="#7fa1fd84a4">Постоянное перенаправление вывода</a>
...
### <a id="9cd874e279" href="#9cd874e279">Перенаправление ввода в скриптах</a>

`exec 0< <дескриптор>` - перенаправляет весь ввод из определённого дескриптора на время выполнения скрипта.

### <a id="9c888c0fe5" href="#9c888c0fe5">Создание собственного перенаправления вывода</a>
...
`exec <дескриптор_номер>>&-` - закрывает дескриптор, его потом можно открыть по ноовой.

### <a id="1a74e3d995" href="#1a74e3d995">Получение сведений об открытых дескрипторах</a>
...
### <a id="96664c24df" href="#96664c24df">Подавление вывода</a>
...
## <a id="f51a9128e4" href="#f51a9128e4">Сигналы Linux</a>

### <a id="08ef916699" href="#08ef916699">Основные сигналы</a>
...
### <a id="d6dbc2049f" href="#d6dbc2049f">Временная остановка процесса</a>
...
### <a id="26395bc57a" href="#26395bc57a">Перехват сигналов</a>
...
## <a id="5d83d9aed1" href="#5d83d9aed1">Выполнение сценариев командной строки в фоновом режиме</a>
...
`nohup <скрипт> &` - позволяет запустить программу, блокируя сигналы `SIGHUP`, отправляемые процессу и отвязывает процесс от терминала, что значит что процесс потеряет ссылки на `STDOUT` и `STDERR` и nohup автоматически перенаправляет сообщения, поступающие в `STDOUT` и в `STDERR`, в файл `nohup.out`.

`jobs -l` - выводит текущие задания, которые выполняются в оболочке.

## <a id="36c026aa4b" href="#36c026aa4b">Планирование запуска скриптов</a>
...
## <a id="4a32a6c3c2" href="#4a32a6c3c2">Запуск скриптов по расписанию</a>
...
### <a id="9aeaead187" href="#9aeaead187">Массив</a>
...
## <a id="6e805e799d" href="#6e805e799d">Создание и использование библиотек</a>
...
<a id="2bac2d8a88" href="#2bac2d8a88">`sed`</a>
=====
...
## <a id="1f241da628" href="#1f241da628">Опции</a>
...
### <a id="7532cb50c3" href="#7532cb50c3">Дополнительные ключи</a>
...
### <a id="faa0514424" href="#faa0514424">Флаги</a>
...
### <a id="416d77f684" href="#416d77f684">Символы-разделители</a>
...
### <a id="be751fde47" href="#be751fde47">Выбор фрагментов текста для обработки</a>
...
### <a id="3b3777a3e4" href="#3b3777a3e4">Удаление строк</a>
...
### <a id="87ba85adb8" href="#87ba85adb8">Замена символов</a>

`'y/<символы>/<символы_замены>/'` - заменяет символы в соответствии символам замены.

### <a id="93591f0ab8" href="#93591f0ab8">Вывод номеров строк</a>

`=` - выводит номер строки.  
`'/<шаблон_строки>/='` - выводит номер строки удовлетворяющей указанному шаблону.

### <a id="5c9c16d197" href="#5c9c16d197">Чтение данных для вставки из файла</a>
...
<a id="53851a1b5a" href="#53851a1b5a">`awk`</a>
=====
...
## <a id="73f1b922c0" href="#73f1b922c0">Программа</a>
...
### <a id="8b54bcfb77" href="#8b54bcfb77">Позиционные переменные, хранящие данные полей</a>
...
### <a id="80e4e3fcd4" href="#80e4e3fcd4">Файл скрипта</a>
...
### <a id="4b6f1d2b69" href="#4b6f1d2b69">Выполнение команд до начала обработки данных</a>

`BEGIN {<команда> [; ...]}` - выполнит указанную секцию команд до начала обработки данных.

### <a id="8758ca32a2" href="#8758ca32a2">Выполнение команд после окончания обработки данных</a>

`END {<команда> [; ...]}` - выполнит указанную секцию команд после начала обработки данных.

### <a id="847c20d648" href="#847c20d648">Встроенные переменные</a>
...
### <a id="cc2295a909" href="#cc2295a909">Условный оператор</a>
...
## <a id="410e5ccc64" href="#410e5ccc64">Форматированный вывод данных</a>
...
### <a id="13c9d3212a" href="#13c9d3212a">Символы</a>
...
## <a id="1597651a4a" href="#1597651a4a">Встроенные математические функции</a>
...
## <a id="b57a21f457" href="#b57a21f457">Строковые функции</a>

Используются аналогично математическим.

## <a id="ed13da7c89" href="#ed13da7c89">Пользовательские функции</a>
...
## <a id="9f2612ea3f" href="#9f2612ea3f">Специальные классы символов</a>
...
<a id="31ab018022" href="#31ab018022">`tar`</a>
=====

## <a id="2c41462cae" href="#2c41462cae">Запаковывание</a>
...
## <a id="8931f3ce7f" href="#8931f3ce7f">Распаковывание</a>
...
<a id="141ce0cf76" href="#141ce0cf76">`wget`</a>
======
...
<a id="5043d27bd8" href="#5043d27bd8">`grep`</a>
======
...
<a id="f4f65400b1" href="#f4f65400b1">Процессы</a>
========

## <a id="ce6e562f11" href="#ce6e562f11">`ps`</a>
...
## <a id="eefd2ce841" href="#eefd2ce841">Выводимая информация</a>
...
## <a id="499bd191d2" href="#499bd191d2">`kill`</a>
...
## <a id="0d146170eb" href="#0d146170eb">`pkill`</a>
...
## <a id="5738a27c6b" href="#5738a27c6b">`killall`</a>
...
<a id="440c35b2c6" href="#440c35b2c6">`ssh`</a>
=====

`ssh-keygen -t rsa` - генерирование ключа, создаст ключи по умолчанию:
...
В файле `~/.ssh/config` позволяет задать параметры подключения, в том числе специальные для кажого из серверов, а также задать им алиасы и так для каждого из серверов:
```
Host <алиас>
    Hostname <server>
    User <user>
...
<a id="26a7d38b39" href="#26a7d38b39">`screen`</a>
========
...
<a id="abaee1a7ea" href="#abaee1a7ea">Другие команды</a>
==============
