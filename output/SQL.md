...
- [Запрос получения данных `SELECT`](#user-content-Запрос-получения-данных-SELECT)
    ...
    - [WITH (Oracle)](#user-content-WITH-Oracle)
    - [Аналитический SQL (Oracle)](#user-content-Аналитический-SQL-Oracle)
...
Работа с индексами не даётся СУБД "бесплатно": они занимают оперативную память, снижают производительность операций модификации данных и приводят к иным накладным расходам.
