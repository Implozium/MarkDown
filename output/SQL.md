...
- **кластерным** - когда индекс, построен на поле (возможно, с неуникальными значениями), по которому произведено физическое упорядочивание данных в файле;
- **первичным** - когда индекс, построен на поле с уникальными значениями, по которому произведено физическое упорядочивание данных в файле;
- **некластерный** - когда индекс, построен на поле, по которому не произведено физическое упорядочивание данных в файле.
