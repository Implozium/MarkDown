...
- [Основные понятия](#074b12b117)
    - [Реляционные базы данных](#86b017a002)
    - [Реляционные связи между таблицами баз данных](#3095a7310e)
- [Типы команд SQL](#7ed1c09ec2)
    - [Запись SQL-операторов](#371ebbfe7e)
    - [Типы данных языка SQL, определенные стандартом](#b98197dc45)
        - [Символьные данные](#05cc809001)
        - [Битовые данные](#cd9c9b9e73)
        - [Точные числа](#3151f0be0c)
        - [Округленные числа](#145c0d4b1b)
        - [Дата и время](#489961d149)
        - [Интервал](#5b0da4db65)
        - [Домен](#49cb1dc7a5)
        - [Преобразование типов](#7c6bb53375)
    - [Выражения](#c3fed32a50)
        - [Переменные](#06423d48d5)
- [Управляющие конструкции SQL](#3eadba326c)
    - [Case](#e81afad0c0)
    - [If](#d9973a3e3f)
- [Основные объекты структуры базы данных](#713ec3ed1c)
    - [Таблицы](#fcf078bbac)
    - [Представления](#716ecf03c9)
    - [Хранимые процедуры](#002339ad86)
    - [Триггеры](#42be32e6ae)
    - [Функции](#3a2810302d)
    - [Индексы](#e8dac79e4f)
    - [Пользовательские типы данных](#77710717d3)
    - [Ограничения целостности](#bb593f7e25)
    - [Правила](#3084c74efe)
    - [Умолчания](#d23c4dff1d)
- [Таблица](#33a756a376)
    - [Создание таблицы](#3585ede497)
    - [Создание на основе запроса (Oracle)](#28fe00f0f2)
    - [Изменение таблицы](#552f436628)
    - [Удаление таблицы](#f3e7df3a5f)
- [Индексы](#e8dac79e4f)
- [Запрос получения данных `SELECT`](#9113b8be60)
    - [`WHERE`](#ffa00b7d28)
        - [Сравнение блоков данных](#f905e38bd0)
    - [ORDER BY](#df454ea480)
    - [Соединения и операции над отношениями](#0ae0834229)
        - [Построение вычисляемых полей](#b0073dbefe)
    - [GROUP BY](#3515238633)
    - [HAVING](#45b3b1ab80)
    - [Подзапрос](#61ac222d40)
    - [Конструктор блока данных](#6f49b8079e)
    - [WITH (Oracle)](#d78dd66ff5)
- [Запросы модификации данных](#ad69aa3925)
    - [Запрос добавления INSERT](#ac58356ab4)
        - [Первая форма оператора INSERT с параметром VALUES](#db80a4e3c2)
        - [Вторая форма оператора INSERT с параметром `SELECT`](#b1a82d16d7)
        - [Третья форма оператора INSERT в виде UPDATE в MySQL](#58128e117d)
    - [Запрос удаления DELETE](#76ccfe4652)
    - [Запрос очистки таблицы TRUNCATE](#c850f921c4)
    - [Запрос обновления UPDATE](#fffbfb53d9)
    - [Запрос вставки или обновления (MySQL)](#0df1897d0e)
    - [MERGE (Oracle)](#adcecca9b0)
- [Целостность данных](#326a3589f4)
- [Представления](#716ecf03c9)
- [Встроенные функции](#ddca9b5207)
    - [Математические функции](#7246354864)
    - [Строковые функции](#b57a21f457)
    - [Функции для работы с датой и временем](#9f5c0e7dd3)
- [Хранимые процедуры](#002339ad86)
- [Триггеры](#42be32e6ae)
- [Транзакции](#a1cd88feb1)
    - [Блокировки](#c05b96617b)
    - [Управление транзакциями](#9bd842171f)
- [Управление доступом к данным](#3a47c3185f)
    - [Оператор GRANT](#145a396488)
    - [Оператор REVOKE](#bfc9d18f04)
...
## <a id="86b017a002" href="#86b017a002">Реляционные базы данных</a>
...
## <a id="3095a7310e" href="#3095a7310e">Реляционные связи между таблицами баз данных</a>
...
<a id="7ed1c09ec2" href="#7ed1c09ec2">Типы команд SQL</a>
==============
...
## <a id="371ebbfe7e" href="#371ebbfe7e">Запись SQL-операторов</a>
...
## <a id="b98197dc45" href="#b98197dc45">Типы данных языка SQL, определенные стандартом</a>
...
### <a id="05cc809001" href="#05cc809001">Символьные данные</a>
...
### <a id="cd9c9b9e73" href="#cd9c9b9e73">Битовые данные</a>
...
### <a id="3151f0be0c" href="#3151f0be0c">Точные числа</a>
...
### <a id="145c0d4b1b" href="#145c0d4b1b">Округленные числа</a>
...
### <a id="489961d149" href="#489961d149">Дата и время</a>
...
### <a id="5b0da4db65" href="#5b0da4db65">Интервал</a>
...
### <a id="49cb1dc7a5" href="#49cb1dc7a5">Домен</a>
...
### <a id="7c6bb53375" href="#7c6bb53375">Преобразование типов</a>
...
## <a id="c3fed32a50" href="#c3fed32a50">Выражения</a>
...
<a id="3eadba326c" href="#3eadba326c">Управляющие конструкции SQL</a>
===========================
...
## <a id="e81afad0c0" href="#e81afad0c0">Case</a>
...
## <a id="d9973a3e3f" href="#d9973a3e3f">If</a>

```sql
IF (<условие>, <результат_истины>, <результат_лжи>)
```

<a id="713ec3ed1c" href="#713ec3ed1c">Основные объекты структуры базы данных</a>
======================================
...
## <a id="fcf078bbac" href="#fcf078bbac">Таблицы</a>
...
## <a id="716ecf03c9" href="#716ecf03c9">Представления</a>
...
## <a id="002339ad86" href="#002339ad86">Хранимые процедуры</a>
...
## <a id="42be32e6ae" href="#42be32e6ae">Триггеры</a>
...
## <a id="e8dac79e4f" href="#e8dac79e4f">Индексы</a>
...
## <a id="77710717d3" href="#77710717d3">Пользовательские типы данных</a>
...
## <a id="bb593f7e25" href="#bb593f7e25">Ограничения целостности</a>
...
## <a id="3084c74efe" href="#3084c74efe">Правила</a>
...
## <a id="d23c4dff1d" href="#d23c4dff1d">Умолчания</a>
...
<a id="33a756a376" href="#33a756a376">Таблица</a>
=======
...
## <a id="3585ede497" href="#3585ede497">Создание таблицы</a>
...
## <a id="28fe00f0f2" href="#28fe00f0f2">Создание на основе запроса (Oracle)</a>

`CREATE TABLE <имя_новой_таблицы> AS <запрос>` - создает новую таблицу, на основании результата запроса и заполняет его данными.

## <a id="552f436628" href="#552f436628">Изменение таблицы</a>
...
## <a id="f3e7df3a5f" href="#f3e7df3a5f">Удаление таблицы</a>
...
<a id="9113b8be60" href="#9113b8be60">Запрос получения данных `SELECT`</a>
===============================
...
## <a id="ffa00b7d28" href="#ffa00b7d28">`WHERE`</a>
...
### <a id="f905e38bd0" href="#f905e38bd0">Сравнение блоков данных</a>

```sql
(<имя_поля> [,...n]) = (<значение> [,...n])
```

## <a id="df454ea480" href="#df454ea480">ORDER BY</a>
...
## <a id="0ae0834229" href="#0ae0834229">Соединения и операции над отношениями</a>
...
### <a id="b0073dbefe" href="#b0073dbefe">Построение вычисляемых полей</a>
...
## <a id="3515238633" href="#3515238633">GROUP BY</a>
...
## <a id="45b3b1ab80" href="#45b3b1ab80">HAVING</a>
...
## <a id="61ac222d40" href="#61ac222d40">Подзапрос</a>
...
## <a id="6f49b8079e" href="#6f49b8079e">Конструктор блока данных</a>

`(VALUES (<значение_поля>[,...n]) [,...n]) AS <имя_блока>(<имя_поля>[,...n])` - возвращает блок данных (как запрос из таблицы)

## <a id="d78dd66ff5" href="#d78dd66ff5">WITH (Oracle)</a>
...
<a id="ad69aa3925" href="#ad69aa3925">Запросы модификации данных</a>
==========================

## <a id="ac58356ab4" href="#ac58356ab4">Запрос добавления INSERT</a>
...
### <a id="db80a4e3c2" href="#db80a4e3c2">Первая форма оператора INSERT с параметром VALUES</a>
...
### <a id="b1a82d16d7" href="#b1a82d16d7">Вторая форма оператора INSERT с параметром `SELECT`</a>
...
### <a id="58128e117d" href="#58128e117d">Третья форма оператора INSERT в виде UPDATE в MySQL</a>
...
## <a id="76ccfe4652" href="#76ccfe4652">Запрос удаления DELETE</a>
...
## <a id="c850f921c4" href="#c850f921c4">Запрос очистки таблицы TRUNCATE</a>
...
## <a id="fffbfb53d9" href="#fffbfb53d9">Запрос обновления UPDATE</a>
...
## <a id="0df1897d0e" href="#0df1897d0e">Запрос вставки или обновления (MySQL)</a>
...
## <a id="adcecca9b0" href="#adcecca9b0">MERGE (Oracle)</a>

Позволяет дополнять и обновлять данные одной таблицы - данными другой таблицы. При слиянии таблиц проверяется условие, и если оно истинно, то выполняется `UPDATE` [и `DELETE`], а если нет - `INSERT`. Причем нельзя изменять поля таблицы в секции `UPDATE`, по которым идет связывание двух таблиц.

```sql
MERGE INTO <имя_таблицы> [<алиас_таблицы>]
USING <выборка> [<алиас_выборки>]
    ON <условия>
WHEN MATCHED THEN UPDATE SET <имя_таблицы>.<колонка1> = <значение> [,...n]
    [WHERE <условия_включения_в_обновление>]
    [DELETE WHERE <условия_исключения_из_обновления_с_помощью_выборки>]
WHEN NOT MATCHED THEN INSERT (<колонка1> [,...n]) VALUES (<значение> [,...n])
[WHERE <условия_включения_в_вставку>]
```

<a id="326a3589f4" href="#326a3589f4">Целостность данных</a>
==================
...
Ситуации связаные с организацией поддержки ссылочной целостности при выполнении операций модификации данных в базе:
...
Обновление внешнего ключа в строке дочерней таблицы - этот случай подобен вставке новой строки в дочернюю таблицу.
...
## <a id="7246354864" href="#7246354864">Математические функции</a>
...
## <a id="9f5c0e7dd3" href="#9f5c0e7dd3">Функции для работы с датой и временем</a>
...
<a id="a1cd88feb1" href="#a1cd88feb1">Транзакции</a>
==========
...
## <a id="c05b96617b" href="#c05b96617b">Блокировки</a>
...
## <a id="9bd842171f" href="#9bd842171f">Управление транзакциями</a>
...
<a id="3a47c3185f" href="#3a47c3185f">Управление доступом к данным</a>
============================
...
## <a id="145a396488" href="#145a396488">Оператор GRANT</a>
...
## <a id="bfc9d18f04" href="#bfc9d18f04">Оператор REVOKE</a>
