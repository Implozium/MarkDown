...
## <a id="Реляционные-базы-данных" href="#Реляционные-базы-данных">Реляционные базы данных</a>
...
## <a id="Реляционные-связи-между-таблицами-баз-данных" href="#Реляционные-связи-между-таблицами-баз-данных">Реляционные связи между таблицами баз данных</a>
...
<a id="Типы-команд-SQL" href="#Типы-команд-SQL">Типы команд SQL</a>
==============
...
## <a id="Запись-SQL-операторов" href="#Запись-SQL-операторов">Запись SQL-операторов</a>
...
## <a id="Типы-данных-языка-SQL-определенные-стандартом" href="#Типы-данных-языка-SQL-определенные-стандартом">Типы данных языка SQL, определенные стандартом</a>
...
### <a id="Символьные-данные" href="#Символьные-данные">Символьные данные</a>
...
### <a id="Битовые-данные" href="#Битовые-данные">Битовые данные</a>
...
### <a id="Точные-числа" href="#Точные-числа">Точные числа</a>
...
### <a id="Округленные-числа" href="#Округленные-числа">Округленные числа</a>
...
### <a id="Интервал" href="#Интервал">Интервал</a>
...
### <a id="Преобразование-типов" href="#Преобразование-типов">Преобразование типов</a>
...
## <a id="Выражения" href="#Выражения">Выражения</a>
...
<a id="Управляющие-конструкции-SQL" href="#Управляющие-конструкции-SQL">Управляющие конструкции SQL</a>
===========================
...
## <a id="If" href="#If">If</a>

```sql
IF (<условие>, <результат_истины>, <результат_лжи>)
```

<a id="Основные-объекты-структуры-базы-данных" href="#Основные-объекты-структуры-базы-данных">Основные объекты структуры базы данных</a>
======================================
...
## <a id="Таблицы" href="#Таблицы">Таблицы</a>
...
## <a id="Представления" href="#Представления">Представления</a>
...
## <a id="Хранимые-процедуры" href="#Хранимые-процедуры">Хранимые процедуры</a>
...
## <a id="Триггеры" href="#Триггеры">Триггеры</a>
...
## <a id="Индексы" href="#Индексы">Индексы</a>
...
## <a id="Пользовательские-типы-данных" href="#Пользовательские-типы-данных">Пользовательские типы данных</a>
...
## <a id="Ограничения-целостности" href="#Ограничения-целостности">Ограничения целостности</a>
...
## <a id="Правила" href="#Правила">Правила</a>
...
## <a id="Умолчания" href="#Умолчания">Умолчания</a>
...
## <a id="Создание-таблицы" href="#Создание-таблицы">Создание таблицы</a>
...
## <a id="Создание-на-основе-запроса-Oracle" href="#Создание-на-основе-запроса-Oracle">Создание на основе запроса (Oracle)</a>

`CREATE TABLE <имя_новой_таблицы> AS <запрос>` - создает новую таблицу, на основании результата запроса и заполняет его данными.

## <a id="Изменение-таблицы" href="#Изменение-таблицы">Изменение таблицы</a>
...
## <a id="Удаление-таблицы" href="#Удаление-таблицы">Удаление таблицы</a>
...
<a id="Запрос-получения-данных-SELECT" href="#Запрос-получения-данных-SELECT">Запрос получения данных `SELECT`</a>
===============================
...
### <a id="Сравнение-блоков-данных" href="#Сравнение-блоков-данных">Сравнение блоков данных</a>
...
## <a id="ORDER-BY" href="#ORDER-BY">ORDER BY</a>
...
## <a id="Соединения-и-операции-над-отношениями" href="#Соединения-и-операции-над-отношениями">Соединения и операции над отношениями</a>
...
### <a id="Построение-вычисляемых-полей" href="#Построение-вычисляемых-полей">Построение вычисляемых полей</a>
...
## <a id="GROUP-BY" href="#GROUP-BY">GROUP BY</a>
...
## <a id="HAVING" href="#HAVING">HAVING</a>
...
## <a id="Подзапрос" href="#Подзапрос">Подзапрос</a>
...
## <a id="Конструктор-блока-данных" href="#Конструктор-блока-данных">Конструктор блока данных</a>

`(VALUES (<значение_поля>[,...n]) [,...n]) AS <имя_блока>(<имя_поля>[,...n])` - возвращает блок данных (как запрос из таблицы)

## <a id="WITH-Oracle" href="#WITH-Oracle">WITH (Oracle)</a>
...
## <a id="Аналитический-SQL-Oracle" href="#Аналитический-SQL-Oracle">Аналитический SQL (Oracle)</a>
...
Результат работы оконной функции невозможно отфильтровать в запросе с помощью `WHERE`, потому что оконные фунции выполняются после всей фильтрации и группировки, т.е. с тем, что получилось.

Аналитический SQL используется внутри `SELECT` в выборке столбцов:  
`SELECT <поле1>, <аналитический_запрос1> AS <алиас> FROM <таблица>`

<a id="Запросы-модификации-данных" href="#Запросы-модификации-данных">Запросы модификации данных</a>
==========================

## <a id="Запрос-добавления-INSERT" href="#Запрос-добавления-INSERT">Запрос добавления INSERT</a>
...
### <a id="Первая-форма-оператора-INSERT-с-параметром-VALUES" href="#Первая-форма-оператора-INSERT-с-параметром-VALUES">Первая форма оператора INSERT с параметром VALUES</a>
...
### <a id="Вторая-форма-оператора-INSERT-с-параметром-SELECT" href="#Вторая-форма-оператора-INSERT-с-параметром-SELECT">Вторая форма оператора INSERT с параметром `SELECT`</a>
...
### <a id="Третья-форма-оператора-INSERT-в-виде-UPDATE-в-MySQL" href="#Третья-форма-оператора-INSERT-в-виде-UPDATE-в-MySQL">Третья форма оператора INSERT в виде UPDATE в MySQL</a>
...
## <a id="Запрос-удаления-DELETE" href="#Запрос-удаления-DELETE">Запрос удаления DELETE</a>
...
## <a id="Запрос-очистки-таблицы-TRUNCATE" href="#Запрос-очистки-таблицы-TRUNCATE">Запрос очистки таблицы TRUNCATE</a>
...
## <a id="Запрос-обновления-UPDATE" href="#Запрос-обновления-UPDATE">Запрос обновления UPDATE</a>
...
## <a id="Запрос-вставки-или-обновления-MySQL" href="#Запрос-вставки-или-обновления-MySQL">Запрос вставки или обновления (MySQL)</a>
...
## <a id="MERGE-Oracle" href="#MERGE-Oracle">MERGE (Oracle)</a>
...
<a id="Целостность-данных" href="#Целостность-данных">Целостность данных</a>
==================
...
## <a id="Математические-функции" href="#Математические-функции">Математические функции</a>
...
`TO_CHAR(<число>)` - (oracle) переводит число в стровой формат.

## <a id="Функции-для-работы-с-датой-и-временем" href="#Функции-для-работы-с-датой-и-временем">Функции для работы с датой и временем</a>
...
<a id="Транзакции" href="#Транзакции">Транзакции</a>
==========
...
## <a id="Блокировки" href="#Блокировки">Блокировки</a>
...
## <a id="Управление-транзакциями" href="#Управление-транзакциями">Управление транзакциями</a>
...
<a id="Управление-доступом-к-данным" href="#Управление-доступом-к-данным">Управление доступом к данным</a>
============================
...
## <a id="Оператор-GRANT" href="#Оператор-GRANT">Оператор GRANT</a>
...
## <a id="Оператор-REVOKE" href="#Оператор-REVOKE">Оператор REVOKE</a>
