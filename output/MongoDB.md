...
- [Описание](#Описание)
    - [Формат данных в MongoDB](#Формат-данных-в-MongoDB)
    - [Структура хранения](#Структура-хранения)
    - [Содержимое пакета MongoDB](#Содержимое-пакета-MongoDB)
- [Структура](#Структура)
- [Команды](#Команды)
    - [Выборка из БД](#Выборка-из-БД)
        - [Курсоры](#Курсоры)
        ...
        - [Операторы](#Операторы)
            ...
            - [Оператор `$type`](#Оператор-type)
            - [Оператор `$regex`](#Оператор-regex)
...
## <a id="Формат-данных-в-MongoDB" href="#Формат-данных-в-MongoDB">Формат данных в MongoDB</a>
...
## <a id="Структура-хранения" href="#Структура-хранения">Структура хранения</a>
...
## <a id="Содержимое-пакета-MongoDB" href="#Содержимое-пакета-MongoDB">Содержимое пакета MongoDB</a>
...
<a id="Команды" href="#Команды">Команды</a>
=======
...
## <a id="Выборка-из-БД" href="#Выборка-из-БД">Выборка из БД</a>
...
### <a id="Курсоры" href="#Курсоры">Курсоры</a>
...
### <a id="Команды-группировки" href="#Команды-группировки">Команды группировки</a>
...
### <a id="Операторы" href="#Операторы">Операторы</a>
...
#### <a id="Поиск-по-массивам" href="#Поиск-по-массивам">Поиск по массивам</a>
...
#### <a id="Оператор-exists" href="#Оператор-exists">Оператор `$exists`</a>
...
#### <a id="Оператор-type" href="#Оператор-type">Оператор `$type`</a>
...
#### <a id="Оператор-regex" href="#Оператор-regex">Оператор `$regex`</a>
...
## <a id="Обновление-данных" href="#Обновление-данных">Обновление данных</a>
...
## <a id="Удаление-данных" href="#Удаление-данных">Удаление данных</a>
...
## <a id="Установка-ссылок-в-БД" href="#Установка-ссылок-в-БД">Установка ссылок в БД</a>
...
### <a id="Автоматическое-связывание" href="#Автоматическое-связывание">Автоматическое связывание</a>
...
## <a id="Управление-коллекциями" href="#Управление-коллекциями">Управление коллекциями</a>
...
## <a id="Подколлекции" href="#Подколлекции">Подколлекции</a>
