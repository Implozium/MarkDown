...
<a id="Грамматика" href="#Грамматика">Грамматика</a>
==========
...
### <a id="Возвратные-местоимения" href="#Возвратные-местоимения">Возвратные местоимения</a>
...
## <a id="Глагол-verb" href="#Глагол-verb">Глагол (verb)</a>

### <a id="Инфинитив-Infinitive" href="#Инфинитив-Infinitive">Инфинитив **Infinitive**</a>

Неопределенное наклонение глагола, отвечающее на вопрос **что делать?**, **что сделать?**.

#### <a id="to-инфинитив" href="#to-инфинитив">`to`-инфинитив</a>
...
#### <a id="Инфинитив-без-to---голый-bare" href="#Инфинитив-без-to---голый-bare">Инфинитив без `to` - голый (**bare**)</a>
...
### <a id="-ed-форма--III-form" href="#-ed-форма--III-form">`-ed`-форма / III form</a>
...
### <a id="Вероятность-might--could" href="#Вероятность-might--could">Вероятность `might` / `could`</a>
...
### <a id="Должествование-must---have-to" href="#Должествование-must---have-to">Должествование `must` - `have to`</a>
...
### <a id="Глаголы-состояния" href="#Глаголы-состояния">Глаголы состояния</a>
...
### <a id="Future-Continuous" href="#Future-Continuous">Future Continuous</a>
...
### <a id="Future-Perfect" href="#Future-Perfect">Future Perfect</a>
...
### <a id="Future-Perfect-Continuous" href="#Future-Perfect-Continuous">Future Perfect Continuous</a>
...
### <a id="Преобразование-из-Активной-формы-в-Пассивную" href="#Преобразование-из-Активной-формы-в-Пассивную">Преобразование из Активной формы в Пассивную</a>
...
## <a id="Both--Neither---All--None" href="#Both--Neither---All--None">`Both` / `Neither` - `All` / `None`</a>
...
## <a id="Both--and" href="#Both--and">`Both ... and`</a>
...
## <a id="Neither--nor" href="#Neither--nor">`Neither ... nor`</a>
...
## <a id="Устойчивые-идиомы-с-глаголом-have" href="#Устойчивые-идиомы-с-глаголом-have">Устойчивые идиомы с глаголом `have`</a>
...
## <a id="Описание-локаций" href="#Описание-локаций">Описание локаций</a>
...
## <a id="Восклицания-Exclaminations" href="#Восклицания-Exclaminations">Восклицания (Exclaminations)</a>
