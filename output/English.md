...
- [Вопросительные предложения](#user-content-Вопросительные-предложения)
    ...
    - [Вопросы о предложениях сделать что-то](#user-content-Вопросы-о-предложениях-сделать-что-то)
...
- [Предлоги](#user-content-Предлоги)
    ...
    - [Предлог `due`](#user-content-Предлог-due)
...
- [Употребляемые конструкции](#user-content-Употребляемые-конструкции)
    ...
    - [`to used to be`](#user-content-to-used-to-be)
    - [`there used to be`](#user-content-there-used-to-be)
    - [`used` questions](#user-content-used-questions)
...
- [Разное](#user-content-Разное)
    ...
    - [Предпочтения](#user-content-Предпочтения)
    - [Согласие](#user-content-Согласие)
    - [`influence`](#user-content-influence)
    - [`do` and `make`](#user-content-do-and-make)
    - [`what’s the point of`](#user-content-whats-the-point-of)
    - [Выражение](#user-content-Выражение)
    - [Идентификация](#user-content-Идентификация)
    - [Национальности](#user-content-Национальности)
...
## <a id="Использование-времен" href="#Использование-времен">Использование времен</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

### <a id="Present-Simple" href="#Present-Simple">Present Simple</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий, которые регулярные или повторяющиеся:
    > I often go to the bar. - Я часто хожу в бар.
- для действия в широком смысле слова без привязки к моменту речи:
    > I live in Dublin. - Я живу в Дублине.
- для действий, которые выражают общеизвестные факты:
    > The Earth rotates around its axis. - Земля вращается вокруг своей оси.
- для действий, которые произойдут согласно расписанию в будущем:
    > The airplane takes off at 4.30 am. - Самолет взлетит в 4.30 утра.
- для действий, которые являются шагами в рецептах или интструкциях (используется вместо повелительного наклонения):
    > You push the red button to turn on the radio. - Нажмите на красную кнопку, чтобы включить радио.
- для действий, которые выполняются в определенной последовательности:
    > You take the bus into the city center and then you take a taxi to the restaurant. - Выедете на автобусе до центра города, а затем берете такси до ресторана.
- иногда для действий, которые указывают на факт произошедшего действия в заголовках или в рассказах о событии, когда говорят о ком-то и его действиях:
...
### <a id="Past-Simple" href="#Past-Simple">Past Simple</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий, которые регулярно совершались в прошлом:
    > He often visited us, when we lived there. - Он часто навещал нас, когда мы жили там.
- для информировании о постоянном признаке предмета или характеристики человека в прошлом (каким был этот предмет или человек когда-то?):
    > Jane looked much better, when I saw her last time. - Джейн выглядела намного лучше, когда я видел ее в последний раз.
- для цепи последовательных действий в прошлом:
    > I entered the hall, switched on the light, opened the wardrobe, and then quickly closed it. - Я вошел в зал, включил свет, открыл шкаф и быстро его закрыл.
- для однократного действия в прошлом с указанием времени - факта в прошлом:
    > I visited Serbia last year. - Я посетил Сербию в прошлом году.

### <a id="Future-Simple" href="#Future-Simple">Future Simple</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для общих единичных или повторяющихся действиях в будущем:
...
- для выражения отношений к будущему: надежда, обещание, опасения и д.р.:
    > I promise we will go to Iceland next autumn. - Я обещаю, мы поедем в Исландию следующей осенью.
- для описания каких-то событий - действий в будущем, на которые никак нельзя повлиять - прогнозы на будущее:
    > Heavy rain will be tomorrow. - Завтра будет сильный дождь.
- для спонтанных действий, когда хотят подчеркнуть спонтанность какого-то решения или особый эмоциональный момент, внезапный порыв:
    > I will buy this pair of shoes. - Я куплю эти туфли. (решение принято спонтанно в магазине и не было запланировано)

### <a id="Present-Continuous" href="#Present-Continuous">Present Continuous</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий происходящих прямо сейчас, в момент речи:
    > She is eating apple while I am drinking juice. - Она ест яблоко, пока я пьюсок. (два действия совершаются одновременно)
- для действий растянутых во времени и происходящих в настоящем, но не ограничивающие настоящей секундой, которые начались какое-то время назад и будут продолжаться еще некоторое время:
    > We are moving into a new house. - Мы переезжаем в новый дом. (Мы заняты процессом переезда и продолжим его, но в момент речи мы не заняты конкретно этим, просто находимся в состоянии переезда)
- для описывание ситуаций, которые имеет временный характер:
...
- для развивающихся или постоянно меняющихся действий, при этом предложение часто содержит определенные глаголы для его обозначения:
    > Your English is getting better. - Твой английский становится лучше. (наблюдается постепенное повышение твоего уровня английского)

Дополнительные случае употребления:
...
- для действий, которые обозначают чувства, умственные процессы, которые не имеют временных пределов при этом имеющее начало и конец:
    > The chef is tasting the steak. - Повар пробует стейк на вкус. (он делает это в данную секунду)
- когда речь идет о чем-то новом с противопоставлением старому:
    > He has left university, now he is working with his friend. - Он бросил университет и теперь работает со своим другом.
- когда речь идет о необычном поведении определенного человека, он внезапно начал вести себя не так, как раньше:
    > She is eating too much. - Она слишком много ест. (до этого у нее не было такого хорошего аппетита)
...
Употребление уместно:
- для продолжительных действий, которые происходили в конкретное время или указанный период в прошлом, когда длилось определенное действие:
    > Yesterday at 5 p.m. I was drinking tea with mom. - Вчера в пять вечера я пил чай с мамой.
- для действий, которые происходили одновременно в прошлом:
    > We were eating pizza while we were watching a new TV series. - Мы ели пиццу, когда мы смотрели новый сериал по телевизору.
- для выражения недовольства или неодобрение прошлых действий:
    > He was always losing our keys while on holiday. - Он постоянно терял наши ключи на отдыхе.
- для временных ситуаций в прошлом, которые длились недолго, с указанием конкретного промежутка времени:
    > They were living in Norway for 4 months. - Они жили в Норвегии четыре месяца.

### <a id="Future-Continuous" href="#Future-Continuous">Future Continuous</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий в конкретный момент времени в будущем (иногда точный момент времени в будущем может выражаться при помощи придаточных времени):
    > She will be waiting for me here at 9 p.m. tomorrow. - Завтра в 9 вечера она будет ждать меня здесь.  
    > I will be washing the car when he leaves. - Я буду мыть машину когда он уйдет.
- для действий, которые будут происходить одновременно в будущем:
    > They will be driving home while I will be sleeping so I will be meeting them in the morning. - Они будут ехать домой, пока я буду спать, так что я их встречу утром.
- для неизбежных действий, которые точно произойдут в результате каких-либо подготовительных действий или просто естественным путем:
...
- для запланированных действий, если нужен акцент на действии, а иначе для планов используется **Present Continuous**:
    > They will be moving to Moscow next Monday. - Они переезжают в Москву в следующий понедельник.
- для вежливых вопросов собеседнику о планах на ближайшее будущее для того чтобы поинтересоваться, совпадают ли намерения другого человека с нашими желаниями:
...
### <a id="Past-Perfect" href="#Past-Perfect">Past Perfect</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий, которые произошли до других действий в прошлом:
    > Joan had drunk a smoothie before going to work. - Джоан выпила смузи перед тем, как отправиться на работу.
- для действий, результат которых был виден в прошлом:
    > I was upset. I had forgotten my bag in the car. - Я был расстроен. Я забыл свою сумку в машине.
- во фразах `hardly <past_perfect> when <past_simple>` (`как только ... так ...`), `no sooner <past_perfect> than <past_simple>` (`едва ... как ...`) и подобных:
    > Hardly had I sent the message when he came. - Как только я отправил сообщение, так он пришел.

### <a id="Future-Perfect" href="#Future-Perfect">Future Perfect</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для описания будущего завершенного действия к определенному моменту в будущем:
...
### <a id="Past-Perfect-Continuous" href="#Past-Perfect-Continuous">Past Perfect Continuous</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для того, чтобы сделать акцент на длительности действия, произошедшего в прошлом перед другим действием в прошлом или на момент в прошлом:
    > They had been developing the product for 2 months before they launched it. - Они разрабатывали продукт 2 месяца, прежде чем запустили его.

### <a id="Future-Perfect-Continuous" href="#Future-Perfect-Continuous">Future Perfect Continuous</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Употребление уместно:
- для действий, которые начались и продолжались в течение определенного времени до какого-то момента в будущем, при этом действия могут закончиться в указанному моменту в будущем, а могут продолжаться и дальше, в этом случае важен акцент на действии:
...
## <a id="Предлог-due" href="#Предлог-due">Предлог `due`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="to-used-to-be" href="#to-used-to-be">`to used to be`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="there-used-to-be" href="#there-used-to-be">`there used to be`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="used-questions" href="#used-questions">`used` questions</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Предпочтения" href="#Предпочтения">Предпочтения</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Согласие" href="#Согласие">Согласие</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="influence" href="#influence">`influence`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="whats-the-point-of" href="#whats-the-point-of">`what’s the point of`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Выражение" href="#Выражение">Выражение</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Национальности" href="#Национальности">Национальности</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
