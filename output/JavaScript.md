...
- [Основы JavaScript](#40b09c1614)
    - [Использование в HTML](#07036c5be3)
    - [Структура кода](#aed01de426)
    - [Директива use strict](#aaa65e442d)
    - [Переменные](#06423d48d5)
        - [Переменные: `let` и `const` (ES6)](#08b45b35d0)
        - [Правила именования](#bf58506de0)
        - [Деструктуризация (ES6)](#7c3f12664e)
            - [Массив ](#b872e1ee64)
            - [Оператор spread](#9850e2da9c)
            - [Деструктуризация объекта](#db4d75b73f)
    - [Шесть типов данных](#66906b8dae)
    - [Основные операторы](#ac6e7e7427)
        - [Побитовые операторы](#564b0a92af)
        - [Сокращённая арифметика с присваиванием](#67871e562d)
        - [Оператор запятая `,`](#75d63c58c5)
        - [Операторы сравнения и логические значения](#5ede9da119)
        - [Логические операторы](#8bad5ce7b4)
        - [Оператор `typeof`](#5f62c420ce)
        - [Оператор `void`](#f36fe16dbf)
    - [Преобразование типов для примитивов](#c279c87be2)
        - [Вспомогательные функции `parseInt`, `toString`](#15da7b5ed4)
    - [Условные операторы: `if`, `?:`](#5cec5a1467)
        - [Тернарный оператор вопросительный знак ?:](#671d1d1b93)
    - [Циклы](#7617f64c55)
        - [Цикл `while`](#c7b4b37947)
        - [Цикл `do...while`](#1c036a9b5e)
        - [Цикл `for`](#f9871e7e1b)
        - [Прерывание цикла](#5f8ceb07c4)
            - [Метки для `break`/`continue`](#0ac95875d8)
    - [Конструкция `switch`](#d3f2ac6a0e)
    - [Функции](#3a2810302d)
        - [Параметры по умолчанию (ES6)](#632c0eb43a)
        - [Оператор spread вместо `arguments` (ES6)](#09b714f265)
        - [Объявление Function Expression](#1a9a1ce57b)
        - [Функции через `=>` (ES6)](#4902000938)
    - [Создание функции из текста - `new Function`](#164894d3a2)
        - [Рекурсия, стек](#a8885f0dcd)
    - [Взаимодействие с пользователем: `alert`, `prompt`, `confirm`](#74af2aa710)
    - [Консоль](#d0213abc66)
    - [Советы по стилю кода](#b880508191)
    - [Автоматические тесты при помощи chai и mocha](#76571e1907)
        - [Поток разработки](#64a3655d64)
        - [Виды `assert`](#86ceb11c15)
        - [Пример тестирования](#3949f295be)
    - [Структуры данных](#85e865cfbe)
        - [Числа](#09eabb9ce9)
            - [Округление](#79e8a62a42)
            - [Встроенные функции для тригонометрических вычислений](#9c6003f4af)
            - [Функции общего назначения](#b728a04ac4)
        - [Строки](#d228d35928)
            - [Строки в `` ` `` (ES6)](#1d49d0bd92)
            - [Функции шаблонизации (ES6)](#664952911c)
            - [Свойства и методы](#8d9f852b43)
        - [Объекты как ассоциативные массивы](#e2a3e1ea5d)
            - [Короткое свойство (ES6)](#b874216ae9)
            - [Вычисляемые свойства (ES6)](#dab44ffaa7)
            - [Цикл по свойствам](#b80713c583)
    - [Массивы c числовыми индексами](#bce9a5d8ca)
        - [`ArrayBuffer` (ES6)](#2d7f1a16ff)
        - [`DataView` (ES6)](#a9eb30af8d)
        - [TypedArray (ES6)](#119b30beea)
    - [Дата и Время](#4e8de4e859)
    - [Тип данных `Symbol` (ES6)](#1ea98fb123)
    - [`Map` (ES6)](#078bbda46d)
    - [`Set` (ES6)](#1cef0c5907)
    - [`WeakMap`, `WeakSet` (ES6)](#804434d7ef)
    - [Обещания `Promise` (ES6)](#3c4f2b7635)
    - [Генераторы (ES6)](#9a63c223c4)
        - [Композиция](#7690ee1a8b)
        - [Передача данных в генератор](#a814d2dd50)
        - [Плоский асинхронный код](#ca629e31c3)
        - [Асинхронное выполнение с генераторами](#eedb7211ba)
        - [Async/await (ES7)](#85822afc00)
    - [`Proxy` (ES6)](#81ef36cdf1)
        - [Ловушки](#4a7e1d530c)
    - [`Reflect` (ES6)](#bd61065968)
    - [Итераторы, цикл `for..of` (ES6)](#5946c347ff)
    - [Замыкания, область видимости](#5d621a7cd1)
        - [Глобальный объект](#651b3a86de)
        - [Лексическое окружение](#6ea94d744a)
        - [Модули через замыкания](#0ccb3986e7)
        - [Устаревшая конструкция `with`](#1ae248508c)
    - [Методы объектов и контекст вызова](#19155509ab)
        - [Методы объектов, `this`](#2390f986bb)
            - [Методы объекта (ES6) `[[HomeObject]]`](#5d7c6d01bb)
        - [Создание объектов через `new`](#3fc9614633)
        - [Дескриптор](#fb526cd02a)
        - [Статические и фабричные методы](#4cf2514c62)
        - [Вызовы функций](#7fca6d4ab4)
    - [Некоторые другие возможности, instanceof](#31f9301499)
        - [Формат JSON](#8bfe75785d)
        - [Внутренние таймеры-планировщики](#319fdb3e2c)
        - [Eval](#68b43ab9d0)
        - [Base64](#5368733099)
        - [Кодирование URI](#5f6e96e475)
        - [Кодировка `urlencoded`](#550f921adc)
    - [Перехват ошибок. `Error`](#61ae129682)
        - [Объект ошибки](#0970b77d06)
    - [ООП в функциональном стиле](#f58063760f)
        - [Классы](#f15d756789)
        - ["Геттеры" и "сеттеры"](#d1fc835c07)
        - [Наследование](#2baf77054d)
    - [ООП в прототипном стиле](#913c0c795b)
        - [Специальное свойство `__proto__`](#94b01c5d3a)
        - ["Псевдокласс"](#a560691e05)
        - [Наследование](#2baf77054d)
    - [Классы (ES6)](#7a4b7900bd)
        - [Статические свойства](#02f773ff76)
        - [Наследование](#2baf77054d)
    - [Примесь](#8f4f0d3204)
    - [Модули (ES6)](#ff6aeafc48)
- [Регулярные выражения](#90a3d1045b)
    - [RegExp](#190aa9637c)
    - [Методы String](#bac40e25eb)
    - [Методы RegExp](#46166dc095)
    - [Свойства RegExp](#8e3ada8f3a)
    - [Классы и спецсимволы](#87019a13b0)
    - [Наборы и диапазоны](#852c459693)
    - [Квантификаторы `+`, `*`, `?` и `{n}`](#3c552bb9a7)
        - [Жадные и ленивые квантификаторы](#ed01bf692e)
    - [Скобочные группы](#f6b2690bcf)
        - [Исключение из запоминания через `?:`](#a0fef6806b)
        - [Обратные ссылки](#15ee2e69aa)
    - [Альтернация (или) `|`](#c8b87870b4)
    - [Начало строки `^` и конец `$`](#02888f067b)
    - [Упреждение](#362af56460)
- [Документирование API](#0d498b5846)
    - [Основы](#3535f8046b)
    - [Основные теги](#2e30cbf6b5)
    - [Тип](#8c2f19db84)
    - [Описание структуры объекта типа](#484ca6f7dc)
    - [Описание произвольного типа](#47c4b15ddd)
    - [Описание колбека](#ae84aa968f)
    - [Описание функции как параметра функции](#e6cf6ae9f7)
    - [TODO: delete](#faab76ba7b)

<a id="40b09c1614" href="#40b09c1614">Основы JavaScript</a>
=================

## <a id="07036c5be3" href="#07036c5be3">Использование в HTML</a>
...
## <a id="aed01de426" href="#aed01de426">Структура кода</a>
...
## <a id="aaa65e442d" href="#aaa65e442d">Директива use strict</a>
...
## <a id="06423d48d5" href="#06423d48d5">Переменные</a>
...
JavaScript перемещает операторы `var` и определение `function` наверх ближайшей оборачивающей области видимости, переменные заданые через `var` до своего конкретного определения равны `undefined`.
...
### <a id="08b45b35d0" href="#08b45b35d0">Переменные: `let` и `const` (ES6)</a>
...
### <a id="bf58506de0" href="#bf58506de0">Правила именования</a>
...
### <a id="7c3f12664e" href="#7c3f12664e">Деструктуризация (ES6)</a>

**Деструктуризация** (*destructuring assignment*) - это особый синтаксис присваивания, при котором можно присвоить массив или объект сразу нескольким переменным, разбив его на части.

#### <a id="b872e1ee64" href="#b872e1ee64">Массив </a>
...
#### <a id="db4d75b73f" href="#db4d75b73f">Деструктуризация объекта</a>
...
## <a id="66906b8dae" href="#66906b8dae">Шесть типов данных</a>
...
## <a id="ac6e7e7427" href="#ac6e7e7427">Основные операторы</a>
...
### <a id="564b0a92af" href="#564b0a92af">Побитовые операторы</a>
...
### <a id="67871e562d" href="#67871e562d">Сокращённая арифметика с присваиванием</a>

Имеет вид:
`<имя_переменной> <бинарный_оператор> = <второй операнд>;`

### <a id="75d63c58c5" href="#75d63c58c5">Оператор запятая `,`</a>
...
### <a id="5ede9da119" href="#5ede9da119">Операторы сравнения и логические значения</a>
...
### <a id="8bad5ce7b4" href="#8bad5ce7b4">Логические операторы</a>
...
### <a id="5f62c420ce" href="#5f62c420ce">Оператор `typeof`</a>
...
### <a id="f36fe16dbf" href="#f36fe16dbf">Оператор `void`</a>
...
## <a id="c279c87be2" href="#c279c87be2">Преобразование типов для примитивов</a>
...
### <a id="15da7b5ed4" href="#15da7b5ed4">Вспомогательные функции `parseInt`, `toString`</a>
...
## <a id="5cec5a1467" href="#5cec5a1467">Условные операторы: `if`, `?:`</a>
...
### <a id="671d1d1b93" href="#671d1d1b93">Тернарный оператор вопросительный знак ?:</a>

## <a id="7617f64c55" href="#7617f64c55">Циклы</a>

### <a id="c7b4b37947" href="#c7b4b37947">Цикл `while`</a>
...
### <a id="1c036a9b5e" href="#1c036a9b5e">Цикл `do...while`</a>
...
### <a id="f9871e7e1b" href="#f9871e7e1b">Цикл `for`</a>
...
Поток выполнения: `<начало>` -> (если `<условие>` истино -> тело: `<код_тела_итерации_цикла>` -> `<шаг>`) ->(если `<условие>` истино -> тело: `<код_тела_итерации_цикла>` -> `<шаг>`) -> ... и так далее, пока верно условие. В цикле также можно определить переменную в `<начало>`. Любая часть `for` может быть пропущена.

### <a id="5f8ceb07c4" href="#5f8ceb07c4">Прерывание цикла</a>
...
#### <a id="0ac95875d8" href="#0ac95875d8">Метки для `break`/`continue`</a>
...
## <a id="d3f2ac6a0e" href="#d3f2ac6a0e">Конструкция `switch`</a>
...
## <a id="3a2810302d" href="#3a2810302d">Функции</a>
...
### <a id="632c0eb43a" href="#632c0eb43a">Параметры по умолчанию (ES6)</a>
...
### <a id="09b714f265" href="#09b714f265">Оператор spread вместо `arguments` (ES6)</a>
...
### <a id="1a9a1ce57b" href="#1a9a1ce57b">Объявление Function Expression</a>
...
### <a id="4902000938" href="#4902000938">Функции через `=>` (ES6)</a>

`<параметр> => {<возвращаемый_результат> | {... [return ...]}}`  
`(<параметр1>, <параметр2>[, ...]) => {<возвращаемый_результат> | {... [return ...]}}`  
`() => {<возвращаемый_результат> | {... [return ...]}}`
...
## <a id="164894d3a2" href="#164894d3a2">Создание функции из текста - `new Function`</a>

`new Function('<список_аргументов>', '<код_тело_функции>');` - возвращает функцию созданную из аргументов.

### <a id="a8885f0dcd" href="#a8885f0dcd">Рекурсия, стек</a>
...
## <a id="74af2aa710" href="#74af2aa710">Взаимодействие с пользователем: `alert`, `prompt`, `confirm`</a>
...
## <a id="d0213abc66" href="#d0213abc66">Консоль</a>
...
```javascript
console.dir(<объект>[, {
    showHidden: false, // если true, то будут отображать еще и неперечисляемые свойства и символы
...
## <a id="b880508191" href="#b880508191">Советы по стилю кода</a>
...
## <a id="76571e1907" href="#76571e1907">Автоматические тесты при помощи chai и mocha</a>
...
```javascript
describe("<имя_тестируемой_функции>", function () {
...
- `describe("<имя_тестируемой_функции>", function () {...})` - задаёт, что именно описывается, используется для группировки "рабочих лошадок" - блоков `it`.
- `it("<что_делает_функция>", function () {...})` - в названии блока `it` человеческим языком описывается, что должна делать функция, далее следует тест, который проверяет это.
...
### <a id="64a3655d64" href="#64a3655d64">Поток разработки</a>
...
В каждом блоке `describe` можно также задать функции `before(function () {...})`/ `after(function () {...})`, которые будут выполнены до/после запуска тестов, а также `beforeEach(function () {...})`/ `afterEach(function () {...})`, которые выполняются до/после каждого `it`.

### <a id="86ceb11c15" href="#86ceb11c15">Виды `assert`</a>

- `assert(<значение>)` - проверяет что `<значение>` является `true` в логическом контексте;
- `assert.equal(<значение1>, <значение1>)` - проверяет равенство `<значение1> == <значение2>`;
- `assert.strictEqual(<значение1>, <значение2>)` - проверяет строгое равенство `<значение1> === <значение2>`;
- `assert.notEqual(<значение1>, <значение2>)`, `assert.notStrictEqual(<значение1>, <значение2>)` - проверки, обратные двум предыдущим;
- `assert.isTrue(<значение>)` - проверяет, что `<значение> === true`;
- `assert.isFalse(<значение>)` - проверяет, что `<значение> === false`.
...
### <a id="3949f295be" href="#3949f295be">Пример тестирования</a>
...
## <a id="85e865cfbe" href="#85e865cfbe">Структуры данных</a>
...
### <a id="09eabb9ce9" href="#09eabb9ce9">Числа</a>
...
- `0x<число_в_шестнадцаричной_системе>`;
- `0o<число_в_восьмиричной_системе>`;
- `<число_в_ десятичной_системе>e<число_нулей>`.
...
Если математическая операция не может быть совершена, то возвращается специальное значение `NaN` (*Not-A-Number*). Деление `0/0` в математическом смысле неопределено, поэтому его результат `NaN`. Значение `NaN` используется для обозначения математической ошибки и обладает следующими свойствами:
...
#### <a id="79e8a62a42" href="#79e8a62a42">Округление</a>
...
#### <a id="9c6003f4af" href="#9c6003f4af">Встроенные функции для тригонометрических вычислений</a>
...
#### <a id="b728a04ac4" href="#b728a04ac4">Функции общего назначения</a>

- `Math.sqrt(x)` - возвращает квадратный корень из `x`;
- `Math.log(x)` - возвращает натуральный (по основанию e) логарифм `x`;
- `Math.pow(x, exp)` - возводит число в степень, возвращает `x^exp`. Работает в том числе с дробными и отрицательными степенями;
...
### <a id="d228d35928" href="#d228d35928">Строки</a>
...
#### <a id="1d49d0bd92" href="#1d49d0bd92">Строки в `` ` `` (ES6)</a>
...
#### <a id="664952911c" href="#664952911c">Функции шаблонизации (ES6)</a>
...
#### <a id="8d9f852b43" href="#8d9f852b43">Свойства и методы</a>
...
### <a id="e2a3e1ea5d" href="#e2a3e1ea5d">Объекты как ассоциативные массивы</a>
...
#### <a id="b874216ae9" href="#b874216ae9">Короткое свойство (ES6)</a>
...
#### <a id="dab44ffaa7" href="#dab44ffaa7">Вычисляемые свойства (ES6)</a>
...
#### <a id="b80713c583" href="#b80713c583">Цикл по свойствам</a>
...
## <a id="bce9a5d8ca" href="#bce9a5d8ca">Массивы c числовыми индексами</a>
...
- `Array.from(<псевдомассив>)` - (ES6) возвращает настоящий массив на основе псевдомассива;
...
`<массив>.sort([function (a, b) {...}])` - сортирует массив на месте [с помощью функции сортировки, при этом для функции необходимо чтобы она возвращала:
- Положительное значение, если a > b,
- Отрицательное значение, если a < b,
- Если равны - можно 0, но вообще - не важно, что возвращать, их взаимный порядок не имеет значения.]

`<массив>.reverse()` - меняет порядок элементов в массиве на обратный.  
...
Методу можно передать "начальное значение" `<начальное_значение>`. Если он есть, то на первом вызове значение `accumulator` будет равно начальному значению, а если у `reduce` нет второго аргумента, то оно равно **первому** элементу массива, а перебор начинается со **второго**.
...
### <a id="2d7f1a16ff" href="#2d7f1a16ff">`ArrayBuffer` (ES6)</a>
...
### <a id="a9eb30af8d" href="#a9eb30af8d">`DataView` (ES6)</a>

Представляет отображение сырого буфера в специфическом формате и используется для чтения или записи содержимого в буфер.

`let <dataView> = new DataView(<arrayBuffer>[, <отступ_байт>[, <размер_байт>]])` - создает на основании сырого массива [с определенного отступа в байтах [ и определенного размера]].
...
### <a id="119b30beea" href="#119b30beea">TypedArray (ES6)</a>
...
## <a id="4e8de4e859" href="#4e8de4e859">Дата и Время</a>
...
- `new Date(<год_из_4_цифр>, <месяц_с_0>[, <месяц_с_0>[, <день>, <час>, <мин>, <сек>, <мс>])`.
...
`Date.parse('<дата_в_строке>')` - разбирает строку в таком формате и возвращает соответствующее ей количество миллисекунд. Если это невозможно, возвращает `NaN`.

`Date.now()` - возвращает дату сразу в виде миллисекунд.

## <a id="1ea98fb123" href="#1ea98fb123">Тип данных `Symbol` (ES6)</a>
...
## <a id="078bbda46d" href="#078bbda46d">`Map` (ES6)</a>
...
- `value` - текущее перебираемое значение элемента колекции;
- `key` - ключ текущего элемента колекции;
- `map` - текущий объект `<map>`.

## <a id="1cef0c5907" href="#1cef0c5907">`Set` (ES6)</a>
...
## <a id="804434d7ef" href="#804434d7ef">`WeakMap`, `WeakSet` (ES6)</a>
...
## <a id="3c4f2b7635" href="#3c4f2b7635">Обещания `Promise` (ES6)</a>
...
`Promise.resolve` используют, когда хотят построить асинхронную цепочку, и начальный результ.
...
## <a id="9a63c223c4" href="#9a63c223c4">Генераторы (ES6)</a>
...
### <a id="7690ee1a8b" href="#7690ee1a8b">Композиция</a>
...
### <a id="a814d2dd50" href="#a814d2dd50">Передача данных в генератор</a>
...
### <a id="ca629e31c3" href="#ca629e31c3">Плоский асинхронный код</a>
...
### <a id="eedb7211ba" href="#eedb7211ba">Асинхронное выполнение с генераторами</a>
...
Для каждой асинхронной функции должен передаваться `callback` для обратного вызова, где в результат `<результат>` - запишется результат `callback`. В случае ошибки будет выбрашено исключение.

Все последующие асинхронные функции нужно оформлять в виде представленой.

### <a id="85822afc00" href="#85822afc00">Async/await (ES7)</a>
...
`async function <функция_генератор>([<параметр1>[, ...]]) {...}` - определяет асинхронную функцию.
...
Функция `async` может содержать выражение внутри своего тела `await <promise>`, которое приостанавливает выполнение функции `async` и ожидает ответа от переданного `Promise`, затем возобновляя выполнение функции `async` и возвращая полученное значение.

## <a id="81ef36cdf1" href="#81ef36cdf1">`Proxy` (ES6)</a>
...
### <a id="4a7e1d530c" href="#4a7e1d530c">Ловушки</a>
...
## <a id="bd61065968" href="#bd61065968">`Reflect` (ES6)</a>
...
`Reflect.construct(<функция_конструктор>, <массив_аргументов>[, <функция_прототип>]);` - вызвает конструктор без использования оператора `new` с указанными аргументами [и указаным прототипом] и возвращает созданный объект.

## <a id="5946c347ff" href="#5946c347ff">Итераторы, цикл `for..of` (ES6)</a>
...
## <a id="5d621a7cd1" href="#5d621a7cd1">Замыкания, область видимости</a>

### <a id="651b3a86de" href="#651b3a86de">Глобальный объект</a>
...
### <a id="6ea94d744a" href="#6ea94d744a">Лексическое окружение</a>
...
### <a id="0ccb3986e7" href="#0ccb3986e7">Модули через замыкания</a>
...
### <a id="1ae248508c" href="#1ae248508c">Устаревшая конструкция `with`</a>
...
## <a id="19155509ab" href="#19155509ab">Методы объектов и контекст вызова</a>

### <a id="2390f986bb" href="#2390f986bb">Методы объектов, `this`</a>
...
#### <a id="5d7c6d01bb" href="#5d7c6d01bb">Методы объекта (ES6) `[[HomeObject]]`</a>
...
### <a id="3fc9614633" href="#3fc9614633">Создание объектов через `new`</a>
...
### <a id="fb526cd02a" href="#fb526cd02a">Дескриптор</a>

`Object.defineProperty(<объект>, "<свойство_объекта>", <дескриптор>)` - позволяет объявить свойство для объекта `<объект>` и настроить его особые аспекты, которые никак иначе не изменить. Где `<дескриптор>` - это дескриптор, в виде объекта, который описывает поведение свойства. В нём могут быть следующие поля:
...
`Object.defineProperties(<объект>, {<свойство1>: <дескриптор>[, ...]})` - позволяет объявить несколько свойств сразу.  
...
`Object.seal(<объект>)` - запрещает добавление и удаление свойств, все текущие свойства делает configurable: `false`.
`Object.freeze(<объект>)` - запрещает добавление, удаление и изменение свойств, все текущие свойства делает `configurable`: `false`, `writable`: `false`.  
...
### <a id="4cf2514c62" href="#4cf2514c62">Статические и фабричные методы</a>
...
### <a id="7fca6d4ab4" href="#7fca6d4ab4">Вызовы функций</a>
...
## <a id="31f9301499" href="#31f9301499">Некоторые другие возможности, instanceof</a>
...
### <a id="8bfe75785d" href="#8bfe75785d">Формат JSON</a>
...
### <a id="319fdb3e2c" href="#319fdb3e2c">Внутренние таймеры-планировщики</a>
...
### <a id="68b43ab9d0" href="#68b43ab9d0">Eval</a>
...
### <a id="5368733099" href="#5368733099">Base64</a>
...
### <a id="5f6e96e475" href="#5f6e96e475">Кодирование URI</a>
...
### <a id="550f921adc" href="#550f921adc">Кодировка `urlencoded`</a>
...
## <a id="61ae129682" href="#61ae129682">Перехват ошибок. `Error`</a>
...
### <a id="0970b77d06" href="#0970b77d06">Объект ошибки</a>
...
`window.onerror` - если в него записать функцию `function (message, url, lineNumber) {...}`, то она выполнится и получит в аргументах сообщение ошибки `message`, текущий URL `url` и номер строки `lineNumber`, откуда "выпала" ошибка.

## <a id="f58063760f" href="#f58063760f">ООП в функциональном стиле</a>

### <a id="f15d756789" href="#f15d756789">Классы</a>
...
### <a id="d1fc835c07" href="#d1fc835c07">"Геттеры" и "сеттеры"</a>
...
### <a id="2baf77054d" href="#2baf77054d">Наследование</a>
...
## <a id="913c0c795b" href="#913c0c795b">ООП в прототипном стиле</a>

Объекты в JavaScript можно организовать в цепочки так, чтобы свойство, не найденное в одном объекте, автоматически искалось бы в другом.

### <a id="94b01c5d3a" href="#94b01c5d3a">Специальное свойство `__proto__`</a>
...
`Object.create(<прототип>[, <дескрипторы_свойств>])` - создаёт и возвращает пустой объект с `__proto__`, равным первому аргументу `<прототип>`, второй необязательный аргумент может содержать дескрипторы свойств.
...
### <a id="a560691e05" href="#a560691e05">"Псевдокласс"</a>
...
Базовая реализация, но у этого подхода **важный недостаток** он создает родителя, а не только унаследывает его методы:  
`Наследник>.prototype = new <Родитель>();`  
`Наследник>.prototype = <объект>;`

## <a id="7a4b7900bd" href="#7a4b7900bd">Классы (ES6)</a>
...
### <a id="02f773ff76" href="#02f773ff76">Статические свойства</a>
...
- в конструкторе потомка обязано вызвать `super()` до обращения к `this`. До вызова `super()` не существует `this`, так как по спецификации в этом случае именно `super()` инициализует `this`.

## <a id="8f4f0d3204" href="#8f4f0d3204">Примесь</a>
...
## <a id="ff6aeafc48" href="#ff6aeafc48">Модули (ES6)</a>
...
`import {* | {<импорт1>[ as <импортируемое_имя>][, ...]}} from "<путь_к_модулю>";`



<a id="90a3d1045b" href="#90a3d1045b">Регулярные выражения</a>
====================
...
## <a id="190aa9637c" href="#190aa9637c">RegExp</a>
...
## <a id="bac40e25eb" href="#bac40e25eb">Методы String</a>
...
## <a id="46166dc095" href="#46166dc095">Методы RegExp</a>
...
## <a id="8e3ada8f3a" href="#8e3ada8f3a">Свойства RegExp</a>
...
## <a id="87019a13b0" href="#87019a13b0">Классы и спецсимволы</a>
...
## <a id="852c459693" href="#852c459693">Наборы и диапазоны</a>

`[[^]<символ1>[<символ2>[...]]]` - это набор, который означает один любой символ из указанных.
...
## <a id="3c552bb9a7" href="#3c552bb9a7">Квантификаторы `+`, `*`, `?` и `{n}`</a>
...
### <a id="ed01bf692e" href="#ed01bf692e">Жадные и ленивые квантификаторы</a>
...
## <a id="f6b2690bcf" href="#f6b2690bcf">Скобочные группы</a>
...
### <a id="a0fef6806b" href="#a0fef6806b">Исключение из запоминания через `?:`</a>
...
### <a id="15ee2e69aa" href="#15ee2e69aa">Обратные ссылки</a>
...
Ссылки в шаблоне прегулярного выражения имеют вид `\<n>`, где `<n>` - это номер скобочной группы. Вместо `\<n>` подставляется содержимое соответствующей скобки.

Скобочные группы вида `(?:...)` не участвуют в нумерации.

## <a id="c8b87870b4" href="#c8b87870b4">Альтернация (или) `|`</a>
...
## <a id="02888f067b" href="#02888f067b">Начало строки `^` и конец `$`</a>
...
## <a id="362af56460" href="#362af56460">Упреждение</a>
...
<a id="0d498b5846" href="#0d498b5846">Документирование API</a>
====================

## <a id="3535f8046b" href="#3535f8046b">Основы</a>

Документирование располагается спазу перед тем участком кода, который нужно задокументировать, и пишется в таком формате:
```javascript
/**
 * <описание>
 * @<тег> <значение>
...
## <a id="2e30cbf6b5" href="#2e30cbf6b5">Основные теги</a>
...
## <a id="8c2f19db84" href="#8c2f19db84">Тип</a>
...
## <a id="484ca6f7dc" href="#484ca6f7dc">Описание структуры объекта типа</a>
...
Если это массив объектов, то тогда описание свойст выглядит как:  
`@param {<тип>} <имя_аргумента>[].<имя_свойства> <описание>`

## <a id="47c4b15ddd" href="#47c4b15ddd">Описание произвольного типа</a>
...
## <a id="ae84aa968f" href="#ae84aa968f">Описание колбека</a>
...
## <a id="e6cf6ae9f7" href="#e6cf6ae9f7">Описание функции как параметра функции</a>
...
## <a id="faab76ba7b" href="#faab76ba7b">TODO: delete</a>
