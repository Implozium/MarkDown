...
#### <a id="Деструктуризация-массива" href="#Деструктуризация-массива">Деструктуризация массива</a>
...
`<строка>.repeat(<кол_повторений>)` - (ES2017) заполняет текущую строку вконце (справа) символом пробела `" "` [строкой `<строка>`] (несколько раз, если нужно) так, что итоговая строка достигает заданной длины `<длина>`.
...
### <a id="Async--await-ES2017" href="#Async--await-ES2017">Async / await (ES2017)</a>
...
### <a id="Отменяемый-Proxy" href="#Отменяемый-Proxy">Отменяемый `Proxy`</a>
...
### <a id="Именованые-скобочные-группы-ES2018" href="#Именованые-скобочные-группы-ES2018">Именованые скобочные группы (ES2018)</a>
...
## <a id="Описание-колбэка" href="#Описание-колбэка">Описание колбэка</a>
