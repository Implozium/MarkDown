...
- [Основы JavaScript](#user-content-Основы-JavaScript)
    ...
    - [Переменные](#user-content-Переменные)
        - [Переменные: `let` и `const` (ES6)](#user-content-Переменные-let-и-const-ES6)
        - [Правила именования](#user-content-Правила-именования)
        - [Деструктуризация (ES6)](#user-content-Деструктуризация-ES6)
    ...
    - [Условные операторы: `if`, `?:`](#user-content-Условные-операторы-if-)
        ...
        - [Опциональный оператор `?.` (ES2020)](#user-content-Опциональный-оператор--ES2020)
        - [Оператор проверки на null `??` (ES2020)](#user-content-Оператор-проверки-на-null--ES2020)
    ...
    - [Функции](#user-content-Функции)
        - [Параметры по умолчанию (ES6)](#user-content-Параметры-по-умолчанию-ES6)
        - [Оператор spread вместо `arguments` (ES6)](#user-content-Оператор-spread-вместо-arguments-ES6)
        - [Объявление Function Expression](#user-content-Объявление-Function-Expression)
        - [Функции через `=>` (ES6)](#user-content-Функции-через--ES6)
    ...
    - [Структуры данных](#user-content-Структуры-данных)
        ...
        - [Строки](#user-content-Строки)
            - [Строки в `` ` `` (ES6)](#user-content-Строки-в----ES6)
            - [Функции шаблонизации (ES6)](#user-content-Функции-шаблонизации-ES6)
        ...
        - [Объекты как ассоциативные массивы](#user-content-Объекты-как-ассоциативные-массивы)
            - [Короткое свойство (ES6)](#user-content-Короткое-свойство-ES6)
            - [Вычисляемые свойства (ES6)](#user-content-Вычисляемые-свойства-ES6)
            - [Цикл по свойствам](#user-content-Цикл-по-свойствам)
    - [Массивы c числовыми индексами](#user-content-Массивы-c-числовыми-индексами)
        - [`ArrayBuffer` (ES6)](#user-content-ArrayBuffer-ES6)
        - [`SharedArrayBuffer` (ES2017)](#user-content-SharedArrayBuffer-ES2017)
            - [Глобальный объект `Atomics` (ES2017)](#user-content-Глобальный-объект-Atomics-ES2017)
        - [`DataView` (ES6)](#user-content-DataView-ES6)
        - [TypedArray (ES6)](#user-content-TypedArray-ES6)
    - [Дата и Время](#user-content-Дата-и-Время)
    - [Тип данных `Symbol` (ES6)](#user-content-Тип-данных-Symbol-ES6)
    ...
    - [`Map` (ES6)](#user-content-Map-ES6)
    - [`Set` (ES6)](#user-content-Set-ES6)
    - [`WeakMap`, `WeakSet` (ES6)](#user-content-WeakMap-WeakSet-ES6)
    - [Обещания `Promise` (ES6)](#user-content-Обещания-Promise-ES6)
        - [`thenable` объект](#user-content-thenable-объект)
    - [Генераторы (ES6)](#user-content-Генераторы-ES6)
        ...
        - [Async / await (ES2017)](#user-content-Async--await-ES2017)
    - [`Proxy` (ES6)](#user-content-Proxy-ES6)
        - [Ловушки](#user-content-Ловушки)
        - [Отменяемый `Proxy`](#user-content-Отменяемый-Proxy)
    - [`Reflect` (ES6)](#user-content-Reflect-ES6)
    - [Итераторы, цикл `for..of` (ES6)](#user-content-Итераторы-цикл-forof-ES6)
    ...
    - [Методы объектов и контекст вызова](#user-content-Методы-объектов-и-контекст-вызова)
        - [Методы объектов, `this`](#user-content-Методы-объектов-this)
            - [Методы объекта (ES6) `[[HomeObject]]`](#user-content-Методы-объекта-ES6-HomeObject)
    ...
    - [ООП в прототипном стиле](#user-content-ООП-в-прототипном-стиле)
        ...
        - [Наследование](#user-content-Наследование)
    - [Классы (ES6)](#user-content-Классы-ES6)
    ...
    - [Модули (ES6)](#user-content-Модули-ES6)
- [Регулярные выражения](#user-content-Регулярные-выражения)
    ...
    - [Скобочные группы](#user-content-Скобочные-группы)
        - [Именованые скобочные группы (ES2018)](#user-content-Именованые-скобочные-группы-ES2018)
...
### <a id="Переменные-let-и-const-ES6" href="#Переменные-let-и-const-ES6">Переменные: `let` и `const` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Деструктуризация-ES6" href="#Деструктуризация-ES6">Деструктуризация (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
- **Специальное значение `undefined`** - значение `undefined`, как и `null`, образует свой собственный тип, состоящий из одного этого значения. Оно имеет смысл "**значение не присвоено**". Если переменная объявлена, но в нее ничего не записано, то ее значение как раз и есть `undefined`;
...
### <a id="Опциональный-оператор--ES2020" href="#Опциональный-оператор--ES2020">Опциональный оператор `?.` (ES2020)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Оператор-проверки-на-null--ES2020" href="#Оператор-проверки-на-null--ES2020">Оператор проверки на null `??` (ES2020)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Параметры-по-умолчанию-ES6" href="#Параметры-по-умолчанию-ES6">Параметры по умолчанию (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Оператор-spread-вместо-arguments-ES6" href="#Оператор-spread-вместо-arguments-ES6">Оператор spread вместо `arguments` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функции-через--ES6" href="#Функции-через--ES6">Функции через `=>` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Строки-в----ES6" href="#Строки-в----ES6">Строки в `` ` `` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Функции-шаблонизации-ES6" href="#Функции-шаблонизации-ES6">Функции шаблонизации (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
`<строка>.at(<позиция>)` - (ES2022) возвращает строку, состоящую из выбранного символа по позиции, при отрицательной позиции отсчет идет с конца (-1 - последний символ).
...
Можно использовать с операторами по аналогии с типом `Number`. Тип `BigInt` и `Number` смешивать нельзя. Поддерживаются операторы: `+`, `*`, `-`, `**`, `%`, `/` (результат округляется в меньшую сторону) и битовые, кроме `>>>`.
...
#### <a id="Короткое-свойство-ES6" href="#Короткое-свойство-ES6">Короткое свойство (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Вычисляемые-свойства-ES6" href="#Вычисляемые-свойства-ES6">Вычисляемые свойства (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
`<массив>.at(<позиция>)` - (ES2022) возвращает элемент по позиции, при отрицательной позиции отсчет идет с конца (-1 - последний элемент).
...
`<массив>.find(function (item, i, arr) {...}[, <this_контекст>])` - (ES6) возвращает ссылку на значение в массиве, если вызов callback-функции вернет `true` для какого-нибудь элемента массива, в противном случае возвращается `undefined`.

`<массив>.findIndex(function (item, i, arr) {...}[, <this_контекст>])` - (ES6) возвращает индекс в массиве, если вызов callback-функции вернет `true` для какого-нибудь элемента массива, в противном случае возвращается `-1`.
...
### <a id="ArrayBuffer-ES6" href="#ArrayBuffer-ES6">`ArrayBuffer` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="SharedArrayBuffer-ES2017" href="#SharedArrayBuffer-ES2017">`SharedArrayBuffer` (ES2017)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Глобальный-объект-Atomics-ES2017" href="#Глобальный-объект-Atomics-ES2017">Глобальный объект `Atomics` (ES2017)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="DataView-ES6" href="#DataView-ES6">`DataView` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="TypedArray-ES6" href="#TypedArray-ES6">TypedArray (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Тип-данных-Symbol-ES6" href="#Тип-данных-Symbol-ES6">Тип данных `Symbol` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Map-ES6" href="#Map-ES6">`Map` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Set-ES6" href="#Set-ES6">`Set` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="WeakMap-WeakSet-ES6" href="#WeakMap-WeakSet-ES6">`WeakMap`, `WeakSet` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Обещания-Promise-ES6" href="#Обещания-Promise-ES6">Обещания `Promise` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Генераторы-ES6" href="#Генераторы-ES6">Генераторы (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Async--await-ES2017" href="#Async--await-ES2017">Async / await (ES2017)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Proxy-ES6" href="#Proxy-ES6">`Proxy` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Reflect-ES6" href="#Reflect-ES6">`Reflect` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Итераторы-цикл-forof-ES6" href="#Итераторы-цикл-forof-ES6">Итераторы, цикл `for..of` (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Методы-объекта-ES6-HomeObject" href="#Методы-объекта-ES6-HomeObject">Методы объекта (ES6) `[[HomeObject]]`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
`Object.hasOwn(<объект>, '<свойство>')` - (ES2022) возвращает `true`, если свойство есть в объекте, а не в его прототипе.
...
`<функция>.name` - содержит имя функции, (ES6) а при создании анонимной функции с одновременной записью в переменную или свойство - ее имя равно названию переменной (или свойства).  
...
## <a id="Классы-ES6" href="#Классы-ES6">Классы (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Модули-ES6" href="#Модули-ES6">Модули (ES6)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Именованые-скобочные-группы-ES2018" href="#Именованые-скобочные-группы-ES2018">Именованые скобочные группы (ES2018)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
