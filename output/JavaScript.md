...
- [Основы JavaScript](#Основы-JavaScript)
    ...
    - [Переменные](#Переменные)
        ...
        - [Деструктуризация (ES6)](#Деструктуризация-ES6)
            - [Деструктуризация массива](#Деструктуризация-массива)
    ...
    - [Основные операторы](#Основные-операторы)
        ...
        - [Сокращенная арифметика с присваиванием](#Сокращенная-арифметика-с-присваиванием)
    ...
    - [Условные операторы: `if`, `?:`](#Условные-операторы-if-)
        ...
        - [Опциональный оператор `?.` (ES2020)](#Опциональный-оператор--ES2020)
        - [Оператор проверки на null `??` (ES2020)](#Оператор-проверки-на-null--ES2020)
    - [Циклы](#Циклы)
    ...
    - [Консоль](#Консоль)
        - [Специальные методы (Chrome)](#Специальные-методы-Chrome)
    ...
    - [Структуры данных](#Структуры-данных)
        ...
        - [Большие числа `BigInt`](#Большие-числа-BigInt)
    ...
    - [Массивы c числовыми индексами](#Массивы-c-числовыми-индексами)
        ...
        - [`SharedArrayBuffer` (ES2017)](#SharedArrayBuffer-ES2017)
            - [Глобальный объект `Atomics` (ES2017)](#Глобальный-объект-Atomics-ES2017)
        - [`DataView` (ES6)](#DataView-ES6)
        - [TypedArray (ES6)](#TypedArray-ES6)
    - [Дата и Время](#Дата-и-Время)
    - [Тип данных `Symbol` (ES6)](#Тип-данных-Symbol-ES6)
        - [`Symbol.iterator`](#Symboliterator)
        - [`Symbol.instanceof`](#Symbolinstanceof)
        - [`Symbol.toPrimitive`](#SymboltoPrimitive)
        - [`Symbol.toStringTag`](#SymboltoStringTag)
        - [`Symbol.species`](#Symbolspecies)
        - [`Symbol.match`, `Symbol.replace`, `Symbol.search`, `Symbol.split`](#Symbolmatch-Symbolreplace-Symbolsearch-Symbolsplit)
    ...
    - [Обещания `Promise` (ES6)](#Обещания-Promise-ES6)
        - [`thenable` объект](#thenable-объект)
    ...
    - [`Proxy` (ES6)](#Proxy-ES6)
        - [Ловушки](#Ловушки)
        - [Отменяемый `Proxy`](#Отменяемый-Proxy)
...
- [Регулярные выражения](#Регулярные-выражения)
    ...
    - [Скобочные группы](#Скобочные-группы)
        - [Именованые скобочные группы (ES2018)](#Именованые-скобочные-группы-ES2018)
...
- [Документирование API (JSDoc)](#Документирование-API-JSDoc)
    ...
    - [Описание произвольного типа](#Описание-произвольного-типа)
        - [Импортирование типа](#Импортирование-типа)
    - [Описание колбэка](#Описание-колбэка)
...
- [Тестирование](#Тестирование)
    ...
    - [Автоматические тесты при помощи jest](#Автоматические-тесты-при-помощи-jest)
        - [Имитация `mock`](#Имитация-mock)
        - [Проверки](#Проверки)
            - [Проверки значений](#Проверки-значений)
            - [Проверки вызова функций](#Проверки-вызова-функций)
    - [Цикломатическая сложность](#Цикломатическая-сложность)
    - [Покрытие кода](#Покрытие-кода)
    - [Приемы тестирования](#Приемы-тестирования)
- [Приемы](#Приемы)
