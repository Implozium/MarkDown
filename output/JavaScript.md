...
`<массив>.sort([function (a, b) {...}])` - сортирует массив на месте [с помощью функции сортировки, то элементы массива сортируются в соответствии с её возвращаемым значением:
