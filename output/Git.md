...
`gitk` — это наглядный вариант `git log`, к тому же он принимает почти те же фильтрующие опции, что и `git log`. Если наберать в командной строке `gitk`, находясь в проекте то можно увидить визуализацию истории.
