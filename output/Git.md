...
- [Первоначальная настройка Git](#46dcce8473)
    - [Основные настройки](#1e309d145e)
    - [Справка](#7cfd858c35)
- [Основы Git](#fea4cb0ac8)
    - [Создание Git-репозитория](#c553cac396)
    - [Запись изменений в репозиторий](#80d5e5530b)
    - [File Status Lifecycle](#772e64964e)
        - [Игнорирование файлов](#19de766d92)
        - [Просмотр индексированных и неиндексированных изменений](#65e95d4844)
        - [Фиксация изменений](#60995dc84d)
        - [Удаление файлов](#adeaee24af)
        - [Перемещение файлов](#e762490b11)
    - [Просмотр истории коммитов](#129e6fb675)
            - [Наиболее полезные параметры формата](#662b5d2b7a)
            - [Другие параметы](#f315325e96)
        - [Дополнительное ограничения вывода команды log](#1b581cfb38)
            - [Дополнительные опции](#8f8e88c4e7)
        - [Использование графического интерфейса для визуализации истории](#b03242d1b8)
    - [Отмена изменений](#6ada907230)
        - [Откат к нужной версии](#fe952f3d4b)
            - [Отмена индексации файла](#7fa8d55933)
            - [Отмена изменений файла](#ff5c4bfedc)
        - [Скрытие (stashing) изменений до коммита](#4e57df4e1d)
        - [Перемещение по коммитам](#108e9daf3e)
- [Ветвление в Git](#ed08c498d9)
    - [Основы ветвления и слияния](#4779d2e461)
        - [Основы конфликтов при слиянии](#6a60c0b7ae)
    - [Управление ветками](#4516d4c13a)
    - [Приёмы работы с ветками](#4836c6a8d3)
        - [Долгоживущие ветки](#8cd9c6394c)
        - [Тематические ветки](#3cffe316fd)
    - [Удалённые ветки](#2818a215f4)
        - [Отслеживание веток](#e117a28d2a)
        - [Удаление веток на удалённом сервере](#5a0cd5d78b)
        - [Просмотр информации удалённого репозитория](#55bdb71b03)
    - [Перемещение по веткам](#92121bd12a)
- [Git на сервере](#8186e70d69)
    - [Протоколы](#db0786884b)
        - [Локальный протокол](#16e92ed91e)
        - [Протокол SSH](#aeace10a07)
        - [Git-протокол](#39d9fa8dec)
        - [Протокол HTTP/S](#ae7d5b2428)
    - [Настройка Git на сервере](#72e561dc45)
- [Полезные команды](#a045edb71e)
        - [Сбор всех файлов ветки в архив](#8e2141abcd)
        - [Вывод всех комитов и их файлов, которые есть только в указанной ветке, но не в другой](#eddadbff1e)

<a id="46dcce8473" href="#46dcce8473">Первоначальная настройка Git</a>
============================
...
## <a id="1e309d145e" href="#1e309d145e">Основные настройки</a>
...
## <a id="7cfd858c35" href="#7cfd858c35">Справка</a>

`git help <команда>`  
`git <команда> --help` - выводит справку по команде.

<a id="fea4cb0ac8" href="#fea4cb0ac8">Основы Git</a>
==========

## <a id="c553cac396" href="#c553cac396">Создание Git-репозитория</a>
...
## <a id="80d5e5530b" href="#80d5e5530b">Запись изменений в репозиторий</a>
...
## <a id="772e64964e" href="#772e64964e">File Status Lifecycle</a>
...
### <a id="19de766d92" href="#19de766d92">Игнорирование файлов</a>
...
### <a id="65e95d4844" href="#65e95d4844">Просмотр индексированных и неиндексированных изменений</a>
...
`git diff <хэш_последовательность_коммита>` - сравнивает текущее состояние с указанным коммитом.  
`git diff <хэш_последь_коммита1>..<хэш_послед_коммита2> [<имя_файла>]` - сравнивает коммиты [для указанного файла].

### <a id="60995dc84d" href="#60995dc84d">Фиксация изменений</a>
...
### <a id="adeaee24af" href="#adeaee24af">Удаление файлов</a>
...
### <a id="e762490b11" href="#e762490b11">Перемещение файлов</a>

`git mv <файл_откуда> <файл_куда>` - переименовывает файл.

## <a id="129e6fb675" href="#129e6fb675">Просмотр истории коммитов</a>
...
#### <a id="662b5d2b7a" href="#662b5d2b7a">Наиболее полезные параметры формата</a>
...
#### <a id="f315325e96" href="#f315325e96">Другие параметы</a>
...
### <a id="1b581cfb38" href="#1b581cfb38">Дополнительное ограничения вывода команды log</a>
...
#### <a id="8f8e88c4e7" href="#8f8e88c4e7">Дополнительные опции</a>
...
### <a id="b03242d1b8" href="#b03242d1b8">Использование графического интерфейса для визуализации истории</a>
...
## <a id="6ada907230" href="#6ada907230">Отмена изменений</a>

`git commit --amend` – отменяет текущий коммит, именно коммит, а не сами изменения файлов. Перезаписывает его.

### <a id="fe952f3d4b" href="#fe952f3d4b">Откат к нужной версии</a>
...
#### <a id="7fa8d55933" href="#7fa8d55933">Отмена индексации файла</a>
...
#### <a id="ff5c4bfedc" href="#ff5c4bfedc">Отмена изменений файла</a>

### <a id="4e57df4e1d" href="#4e57df4e1d">Скрытие (stashing) изменений до коммита</a>
...
### <a id="108e9daf3e" href="#108e9daf3e">Перемещение по коммитам</a>
...
<a id="ed08c498d9" href="#ed08c498d9">Ветвление в Git</a>
===============
...
## <a id="4779d2e461" href="#4779d2e461">Основы ветвления и слияния</a>
...
### <a id="6a60c0b7ae" href="#6a60c0b7ae">Основы конфликтов при слиянии</a>
...
## <a id="4516d4c13a" href="#4516d4c13a">Управление ветками</a>
...
## <a id="4836c6a8d3" href="#4836c6a8d3">Приёмы работы с ветками</a>

### <a id="8cd9c6394c" href="#8cd9c6394c">Долгоживущие ветки</a>
...
### <a id="3cffe316fd" href="#3cffe316fd">Тематические ветки</a>
...
## <a id="2818a215f4" href="#2818a215f4">Удалённые ветки</a>
...
`git push <имя_удал_репоз> <ветка>[:<новое_имя>]` - отправляет (push) ветку на удалённый сервер, на котором есть права на запись, вместо `<ветка>` можно использовать `HEAD`, который будет синонимом `<ветка>`.  
...
### <a id="e117a28d2a" href="#e117a28d2a">Отслеживание веток</a>
...
<a id="8186e70d69" href="#8186e70d69">Git на сервере</a>
==============
...
## <a id="db0786884b" href="#db0786884b">Протоколы</a>

### <a id="16e92ed91e" href="#16e92ed91e">Локальный протокол</a>
...
### <a id="aeace10a07" href="#aeace10a07">Протокол SSH</a>
...
### <a id="39d9fa8dec" href="#39d9fa8dec">Git-протокол</a>
...
### <a id="ae7d5b2428" href="#ae7d5b2428">Протокол HTTP/S</a>
...
## <a id="72e561dc45" href="#72e561dc45">Настройка Git на сервере</a>
...
<a id="a045edb71e" href="#a045edb71e">Полезные команды</a>
================

### <a id="8e2141abcd" href="#8e2141abcd">Сбор всех файлов ветки в архив</a>

`git diff --name-status master | tr \' \" | awk '{ if ($1 != D && $2 !~ /\"/) print $2 }' > list.txt ; tar -cvf release.tar.gz -T list.txt ; rm list.txt`

### <a id="eddadbff1e" href="#eddadbff1e">Вывод всех комитов и их файлов, которые есть только в указанной ветке, но не в другой</a>
