...
- [Ветвление в Git](#Ветвление-в-Git)
    ...
    - [Приемы работы с ветками](#Приемы-работы-с-ветками)
    ...
    - [Удаленные ветки](#Удаленные-ветки)
        ...
        - [Удаление веток на удаленном сервере](#Удаление-веток-на-удаленном-сервере)
        - [Просмотр информации удаленного репозитория](#Просмотр-информации-удаленного-репозитория)
...
`git init` - создает в текущем каталоге новый подкаталог с именем `.git` содержащий все необходимые файлы репозитория - основу Git-репозитория.  
