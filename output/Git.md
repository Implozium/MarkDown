...
- [Основы Git](#Основы-Git)
    ...
    - [File Status Lifecycle](#File-Status-Lifecycle)
        - [Игнорирование файлов](#Игнорирование-файлов)
            - [Глобальное игнорирование файлов](#Глобальное-игнорирование-файлов)
        ...
        - [Фиксация изменений](#Фиксация-изменений)
            - [Правила составления комментариев к коммиту:](#Правила-составления-комментариев-к-коммиту)
        - [Удаление файлов](#Удаление-файлов)
        - [Перемещение файлов](#Перемещение-файлов)
    - [Просмотр истории коммитов](#Просмотр-истории-коммитов)
        - [Наиболее полезные параметры формата](#Наиболее-полезные-параметры-формата)
        - [Другие параметы](#Другие-параметы)
        - [Дополнительное ограничения вывода команды log](#Дополнительное-ограничения-вывода-команды-log)
        - [Дополнительные опции](#Дополнительные-опции)
        - [Использование графического интерфейса для визуализации истории](#Использование-графического-интерфейса-для-визуализации-истории)
        - [Общий лог](#Общий-лог)
        - [Аннотация файла](#Аннотация-файла)
    - [Отмена изменений](#Отмена-изменений)
        - [Откат к нужной версии](#Откат-к-нужной-версии)
            - [Отмена индексации файла](#Отмена-индексации-файла)
            - [Отмена изменений файла](#Отмена-изменений-файла)
        - [Скрытие (stashing) изменений до коммита](#Скрытие-stashing-изменений-до-коммита)
        - [Очистка рабочей директории](#Очистка-рабочей-директории)
        - [Перемещение по коммитам](#Перемещение-по-коммитам)
- [Ветвление в Git](#Ветвление-в-Git)
    - [Основы ветвления и слияния](#Основы-ветвления-и-слияния)
        - [Основы конфликтов при слиянии](#Основы-конфликтов-при-слиянии)
    - [Управление ветками](#Управление-ветками)
    - [Приёмы работы с ветками](#Приёмы-работы-с-ветками)
        - [Долгоживущие ветки](#Долгоживущие-ветки)
        - [Тематические ветки](#Тематические-ветки)
    - [Удалённые ветки](#Удалённые-ветки)
        - [Отслеживание веток](#Отслеживание-веток)
        - [Удаление веток на удалённом сервере](#Удаление-веток-на-удалённом-сервере)
        - [Просмотр информации удалённого репозитория](#Просмотр-информации-удалённого-репозитория)
    - [Перемещение по веткам](#Перемещение-по-веткам)
- [Git на сервере](#Git-на-сервере)
    - [Протоколы](#Протоколы)
        - [Локальный протокол](#Локальный-протокол)
        - [Протокол SSH](#Протокол-SSH)
        - [Git-протокол](#Git-протокол)
        - [Протокол HTTP/S](#Протокол-HTTPS)
    - [Настройка Git на сервере](#Настройка-Git-на-сервере)
- [Полезные команды](#Полезные-команды)
    - [Сбор всех файлов ветки в архив](#Сбор-всех-файлов-ветки-в-архив)
    - [Вывод всех комитов и их файлов, которые есть только в указанной ветке, но не в другой](#Вывод-всех-комитов-и-их-файлов-которые-есть-только-в-указанной-ветке-но-не-в-другой)
    - [Вывод всех файлов](#Вывод-всех-файлов)
    - [Обновление текущей ветки мастером](#Обновление-текущей-ветки-мастером)
    - [Вывод последних коммитов всех веток](#Вывод-последних-коммитов-всех-веток)

<a id="Первоначальная-настройка-Git" href="#Первоначальная-настройка-Git">Первоначальная настройка Git</a>
============================
...
## <a id="Основные-настройки" href="#Основные-настройки">Основные настройки</a>
...
## <a id="Справка" href="#Справка">Справка</a>

`git help <команда>`  
`git <команда> --help` - выводит справку по команде.

<a id="Основы-Git" href="#Основы-Git">Основы Git</a>
==========

## <a id="Создание-Git-репозитория" href="#Создание-Git-репозитория">Создание Git-репозитория</a>
...
## <a id="Запись-изменений-в-репозиторий" href="#Запись-изменений-в-репозиторий">Запись изменений в репозиторий</a>
...
## <a id="File-Status-Lifecycle" href="#File-Status-Lifecycle">File Status Lifecycle</a>
...
### <a id="Игнорирование-файлов" href="#Игнорирование-файлов">Игнорирование файлов</a>
...
#### <a id="Глобальное-игнорирование-файлов" href="#Глобальное-игнорирование-файлов">Глобальное игнорирование файлов</a>
...
### <a id="Просмотр-индексированных-и-неиндексированных-изменений" href="#Просмотр-индексированных-и-неиндексированных-изменений">Просмотр индексированных и неиндексированных изменений</a>
...
### <a id="Фиксация-изменений" href="#Фиксация-изменений">Фиксация изменений</a>
...
#### <a id="Правила-составления-комментариев-к-коммиту" href="#Правила-составления-комментариев-к-коммиту">Правила составления комментариев к коммиту:</a>
...
### <a id="Удаление-файлов" href="#Удаление-файлов">Удаление файлов</a>
...
### <a id="Перемещение-файлов" href="#Перемещение-файлов">Перемещение файлов</a>

`git mv <файл_откуда> <файл_куда>` - переименовывает файл.

## <a id="Просмотр-истории-коммитов" href="#Просмотр-истории-коммитов">Просмотр истории коммитов</a>
...
### <a id="Наиболее-полезные-параметры-формата" href="#Наиболее-полезные-параметры-формата">Наиболее полезные параметры формата</a>
...
### <a id="Другие-параметы" href="#Другие-параметы">Другие параметы</a>
...
### <a id="Дополнительное-ограничения-вывода-команды-log" href="#Дополнительное-ограничения-вывода-команды-log">Дополнительное ограничения вывода команды log</a>
...
### <a id="Дополнительные-опции" href="#Дополнительные-опции">Дополнительные опции</a>
...
### <a id="Использование-графического-интерфейса-для-визуализации-истории" href="#Использование-графического-интерфейса-для-визуализации-истории">Использование графического интерфейса для визуализации истории</a>
...
### <a id="Общий-лог" href="#Общий-лог">Общий лог</a>
...
### <a id="Аннотация-файла" href="#Аннотация-файла">Аннотация файла</a>
...
С ключем `-C` Git проанализирует аннотируемый файл и попытается выявить, откуда фрагменты кода в нём появились изначально, если они были скопированы откуда-то.

## <a id="Отмена-изменений" href="#Отмена-изменений">Отмена изменений</a>

`git commit --amend` – отменяет текущий коммит, именно коммит, а не сами изменения файлов. Перезаписывает его.

### <a id="Откат-к-нужной-версии" href="#Откат-к-нужной-версии">Откат к нужной версии</a>
...
#### <a id="Отмена-индексации-файла" href="#Отмена-индексации-файла">Отмена индексации файла</a>
...
#### <a id="Отмена-изменений-файла" href="#Отмена-изменений-файла">Отмена изменений файла</a>
...
### <a id="Скрытие-stashing-изменений-до-коммита" href="#Скрытие-stashing-изменений-до-коммита">Скрытие (stashing) изменений до коммита</a>
...
### <a id="Очистка-рабочей-директории" href="#Очистка-рабочей-директории">Очистка рабочей директории</a>
...
### <a id="Перемещение-по-коммитам" href="#Перемещение-по-коммитам">Перемещение по коммитам</a>
...
<a id="Ветвление-в-Git" href="#Ветвление-в-Git">Ветвление в Git</a>
===============
...
## <a id="Основы-ветвления-и-слияния" href="#Основы-ветвления-и-слияния">Основы ветвления и слияния</a>
...
С помощью опции `--no-commit` позволяется слить ветку без закрывания коммита мерджа при удачном слиянии.
...
### <a id="Основы-конфликтов-при-слиянии" href="#Основы-конфликтов-при-слиянии">Основы конфликтов при слиянии</a>
...
## <a id="Управление-ветками" href="#Управление-ветками">Управление ветками</a>
...
- `--contains <коммит>` и `--no-contains <коммит>` - оставляют в списке только те ветки, которые содержат указаный коммит (или не содержат его).

## <a id="Приёмы-работы-с-ветками" href="#Приёмы-работы-с-ветками">Приёмы работы с ветками</a>

### <a id="Долгоживущие-ветки" href="#Долгоживущие-ветки">Долгоживущие ветки</a>
...
### <a id="Тематические-ветки" href="#Тематические-ветки">Тематические ветки</a>
...
## <a id="Удалённые-ветки" href="#Удалённые-ветки">Удалённые ветки</a>
...
### <a id="Отслеживание-веток" href="#Отслеживание-веток">Отслеживание веток</a>
...
### <a id="Удаление-веток-на-удалённом-сервере" href="#Удаление-веток-на-удалённом-сервере">Удаление веток на удалённом сервере</a>

`git push <имя_удал_репоз> :<ветка>` - удаляет (push) ветку на удалённом сервере, на котором есть права на запись.

### <a id="Просмотр-информации-удалённого-репозитория" href="#Просмотр-информации-удалённого-репозитория">Просмотр информации удалённого репозитория</a>

`git remote show <имя_удал_репоз>` - выдаёт URL удалённого репозитория, а также информацию об отслеживаемых ветках.

## <a id="Перемещение-по-веткам" href="#Перемещение-по-веткам">Перемещение по веткам</a>
...
<a id="Git-на-сервере" href="#Git-на-сервере">Git на сервере</a>
==============
...
## <a id="Протоколы" href="#Протоколы">Протоколы</a>

### <a id="Локальный-протокол" href="#Локальный-протокол">Локальный протокол</a>
...
### <a id="Протокол-SSH" href="#Протокол-SSH">Протокол SSH</a>
...
### <a id="Git-протокол" href="#Git-протокол">Git-протокол</a>
...
### <a id="Протокол-HTTPS" href="#Протокол-HTTPS">Протокол HTTP/S</a>
...
## <a id="Настройка-Git-на-сервере" href="#Настройка-Git-на-сервере">Настройка Git на сервере</a>
...
<a id="Полезные-команды" href="#Полезные-команды">Полезные команды</a>
================

## <a id="Сбор-всех-файлов-ветки-в-архив" href="#Сбор-всех-файлов-ветки-в-архив">Сбор всех файлов ветки в архив</a>

`git diff --name-status master | tr \' \" | awk '{ if ($1 != D && $2 !~ /\"/) print $2 }' > list.txt ; tar -cvf release.tar.gz -T list.txt ; rm list.txt`

## <a id="Вывод-всех-комитов-и-их-файлов-которые-есть-только-в-указанной-ветке-но-не-в-другой" href="#Вывод-всех-комитов-и-их-файлов-которые-есть-только-в-указанной-ветке-но-не-в-другой">Вывод всех комитов и их файлов, которые есть только в указанной ветке, но не в другой</a>

`git log master..<ветка> --pretty=format:"%H" --name-only`

## <a id="Вывод-всех-файлов" href="#Вывод-всех-файлов">Вывод всех файлов</a>
...
## <a id="Обновление-текущей-ветки-мастером" href="#Обновление-текущей-ветки-мастером">Обновление текущей ветки мастером</a>
...
## <a id="Вывод-последних-коммитов-всех-веток" href="#Вывод-последних-коммитов-всех-веток">Вывод последних коммитов всех веток</a>
