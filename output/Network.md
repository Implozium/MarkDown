...
- [Канальный уровень](#Канальный-уровень)
    - [Приемы обнаружения и исправления ошибок](#Приемы-обнаружения-и-исправления-ошибок)
        - [Контроль четности](#Контроль-четности)
        - [Методы контрольных сумм](#Методы-контрольных-сумм)
        - [Код циклического контроля](#Код-циклического-контроля)
    - [Протоколы и каналы множественного доступа](#Протоколы-и-каналы-множественного-доступа)
        - [Протоколы разделения канала](#Протоколы-разделения-канала)
        - [Протоколы произвольного доступа](#Протоколы-произвольного-доступа)
            - [Дискретный протокол ALOHA](#Дискретный-протокол-ALOHA)
            - [Чистый протокол ALOHA](#Чистый-протокол-ALOHA)
            - [Протокол множественного доступа с контролем несущей (CSMA)](#Протокол-множественного-доступа-с-контролем-несущей-CSMA)
        - [Протоколы поочередного доступа](#Протоколы-поочередного-доступа)
        - [DOCSIS: протокол канального уровня для кабельного доступа в Интернет](#DOCSIS-протокол-канального-уровня-для-кабельного-доступа-в-Интернет)
    - [Локальная сеть с коммутируемым доступом](#Локальная-сеть-с-коммутируемым-доступом)
    - [Виртуализация каналов](#Виртуализация-каналов)
...
### <a id="Протоколы-разделения-канала" href="#Протоколы-разделения-канала">Протоколы разделения канала</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Протоколы-произвольного-доступа" href="#Протоколы-произвольного-доступа">Протоколы произвольного доступа</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Дискретный-протокол-ALOHA" href="#Дискретный-протокол-ALOHA">Дискретный протокол ALOHA</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
#### <a id="Чистый-протокол-ALOHA" href="#Чистый-протокол-ALOHA">Чистый протокол ALOHA</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Это дискретный протокол ALOHA, только без синхронизации времени начала передачи кадров.

#### <a id="Протокол-множественного-доступа-с-контролем-несущей-CSMA" href="#Протокол-множественного-доступа-с-контролем-несущей-CSMA">Протокол множественного доступа с контролем несущей (CSMA)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
**Экспоненциальный двоичный алгоритм выдержки** - используется для установки случайного интервала. При передаче кадра, с которым уже произошло `n` коллизий, узел случайным образом выбирает значение `K` из интервала `{0, 1, 2, ... 2^(n-1)}`.
...
### <a id="Протоколы-поочередного-доступа" href="#Протоколы-поочередного-доступа">Протоколы поочередного доступа</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="DOCSIS-протокол-канального-уровня-для-кабельного-доступа-в-Интернет" href="#DOCSIS-протокол-канального-уровня-для-кабельного-доступа-в-Интернет">DOCSIS: протокол канального уровня для кабельного доступа в Интернет</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Локальная-сеть-с-коммутируемым-доступом" href="#Локальная-сеть-с-коммутируемым-доступом">Локальная сеть с коммутируемым доступом</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
МАС-адрес постоянен и уникален. Первые 3 байта остаются за компанией выпускающей адаптеры.
...
## <a id="Виртуализация-каналов" href="#Виртуализация-каналов">Виртуализация каналов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
