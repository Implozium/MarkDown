...
- [Канальный уровень](#user-content-Канальный-уровень)
    ...
    - [Протоколы и каналы множественного доступа](#user-content-Протоколы-и-каналы-множественного-доступа)
...
MAC-адрес идентифицирует компьютеры, IP-адрес определяет их местоположение, а ARP-таблицы хранят результаты сопоставления этих фрагментов информации.
