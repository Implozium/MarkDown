...
- [Рекомендации](#Рекомендации)
    - [Смещение нулевых значения на периферию типов](#Смещение-нулевых-значения-напериферию-типов)
...
- `unknown` - универсальное множество - любое значение, перед использованием необходимо привести к определенному типу. Любой тип является подтипом `unknown`, поэтому утверждения с ним всегда срабатывают.
...
Используется для интерфейсов, а не примитивных типов.
...
`<T extends {<Интерфейс> | <Класс>}>` - устанавливает что только можно передавать объекты, которые расширяют `{<Интерфейс> | <Класс>}`, то есть ограничивается всеми "наследниками" этого типа.
...
## <a id="Смещение-нулевых-значения-напериферию-типов" href="#Смещение-нулевых-значения-напериферию-типов">Смещение нулевых значения на периферию типов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
