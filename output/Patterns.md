...
<a id="Паттерны-программирования" href="#Паттерны-программирования">Паттерны программирования</a>
=========================
...
## <a id="Принципы-паттернов" href="#Принципы-паттернов">Принципы паттернов</a>

### <a id="Основной-принцип-построения-паттернов" href="#Основной-принцип-построения-паттернов">Основной принцип построения паттернов</a>
...
### <a id="Принцип-проектирования-предпочтение-композиции-перед-наследованием" href="#Принцип-проектирования-предпочтение-композиции-перед-наследованием">Принцип проектирования: предпочтение композиции перед наследованием</a>
...
### <a id="Принцип-инверсии-зависимостей" href="#Принцип-инверсии-зависимостей">Принцип инверсии зависимостей</a>
...
### <a id="Принцип-минимальной-информированости" href="#Принцип-минимальной-информированости">Принцип минимальной информированости</a>
...
### <a id="Голливудский-принцип" href="#Голливудский-принцип">Голливудский принцип</a>
...
### <a id="Принцип-одной-обязанности" href="#Принцип-одной-обязанности">Принцип одной обязанности</a>
...
## <a id="Паттерны" href="#Паттерны">Паттерны</a>

### <a id="Порождающие-шаблоны-проектирования" href="#Порождающие-шаблоны-проектирования">Порождающие шаблоны проектирования</a>
...
#### <a id="Паттерн-Простая-Фабрика-Factory" href="#Паттерн-Простая-Фабрика-Factory">Паттерн Простая Фабрика (Factory)</a>
...
#### <a id="Паттерн-Фабричный-Метод-Factory-method" href="#Паттерн-Фабричный-Метод-Factory-method">Паттерн Фабричный Метод (Factory method)</a>
...
#### <a id="Паттерн-Абстрактная-фабрика-Abstract-factory" href="#Паттерн-Абстрактная-фабрика-Abstract-factory">Паттерн Абстрактная фабрика (Abstract factory)</a>
...
#### <a id="Паттерн-Строитель-Builder" href="#Паттерн-Строитель-Builder">Паттерн Строитель (Builder)</a>
...
#### <a id="Паттерн-Прототип-Prototype" href="#Паттерн-Прототип-Prototype">Паттерн Прототип (Prototype)</a>
...
#### <a id="Паттерн-Одиночка-Singleton" href="#Паттерн-Одиночка-Singleton">Паттерн Одиночка (Singleton)</a>
...
### <a id="Структурные-шаблоны-проектирования" href="#Структурные-шаблоны-проектирования">Структурные шаблоны проектирования</a>
...
#### <a id="Паттерн-Адаптер-Adapter" href="#Паттерн-Адаптер-Adapter">Паттерн Адаптер (Adapter)</a>
...
#### <a id="Паттерн-Мост-Bridge" href="#Паттерн-Мост-Bridge">Паттерн Мост (Bridge)</a>
...
#### <a id="Паттерн-Компоновщик-Composite" href="#Паттерн-Компоновщик-Composite">Паттерн Компоновщик (Composite)</a>
...
#### <a id="Паттерн-Декоратор-Decorator" href="#Паттерн-Декоратор-Decorator">Паттерн Декоратор (Decorator)</a>
...
#### <a id="Паттерн-Фасад-Facade" href="#Паттерн-Фасад-Facade">Паттерн Фасад (Facade)</a>
...
#### <a id="Паттерн-Приспособленец-Flyweight" href="#Паттерн-Приспособленец-Flyweight">Паттерн Приспособленец (Flyweight)</a>
...
#### <a id="Паттерн-Заместитель-Proxy" href="#Паттерн-Заместитель-Proxy">Паттерн Заместитель (Proxy)</a>
...
### <a id="Поведенческие-шаблоны-проектирования" href="#Поведенческие-шаблоны-проектирования">Поведенческие шаблоны проектирования</a>
...
#### <a id="Паттерн-Цепочка-обязанностей-Chain-of-responsibility" href="#Паттерн-Цепочка-обязанностей-Chain-of-responsibility">Паттерн Цепочка обязанностей (Chain of responsibility)</a>
...
#### <a id="Паттерн-Команда-Command" href="#Паттерн-Команда-Command">Паттерн Команда (Command)</a>
...
#### <a id="Паттерн-Интерпретатор-Interpreter" href="#Паттерн-Интерпретатор-Interpreter">Паттерн Интерпретатор (Interpreter)</a>
...
#### <a id="Паттерн-Итератор-Iterator" href="#Паттерн-Итератор-Iterator">Паттерн Итератор (Iterator)</a>
...
#### <a id="Паттерн-Посредник-Mediator" href="#Паттерн-Посредник-Mediator">Паттерн Посредник (Mediator)</a>
...
#### <a id="Паттерн-Хранитель-Memento" href="#Паттерн-Хранитель-Memento">Паттерн Хранитель (Memento)</a>
...
#### <a id="Паттерн-Наблюдатель-Observer" href="#Паттерн-Наблюдатель-Observer">Паттерн Наблюдатель (Observer)</a>
...
#### <a id="Паттерн-Посетитель-Visitor" href="#Паттерн-Посетитель-Visitor">Паттерн Посетитель (Visitor)</a>
...
### <a id="Паттерн-Стратегия-Strategy" href="#Паттерн-Стратегия-Strategy">Паттерн Стратегия (Strategy)</a>
...
### <a id="Паттерн-Состояние-State" href="#Паттерн-Состояние-State">Паттерн Состояние (State)</a>
...
### <a id="Паттерн-Шаблонный-метод-Template-method" href="#Паттерн-Шаблонный-метод-Template-method">Паттерн Шаблонный метод (Template method)</a>
...
## <a id="Составные-паттерны" href="#Составные-паттерны">Составные паттерны</a>

### <a id="Паттерн-Модель-Представление-Контроллер" href="#Паттерн-Модель-Представление-Контроллер">Паттерн Модель-Представление-Контроллер</a>
...
<a id="Принципы-проектирования" href="#Принципы-проектирования">Принципы проектирования</a>
=======================

## <a id="SOLID" href="#SOLID">SOLID</a>
...
### <a id="Принцип-единственной-ответственности-Single-Responsibility-Principle-SRP" href="#Принцип-единственной-ответственности-Single-Responsibility-Principle-SRP">Принцип единственной ответственности (Single Responsibility Principle, SRP)</a>
...
### <a id="Принцип-открытостизакрытости-OpenClosed-Principle-OCP" href="#Принцип-открытостизакрытости-OpenClosed-Principle-OCP">Принцип открытости/закрытости (Open/Closed Principle, OCP)</a>
...
### <a id="Принцип-подстановки-Барбары-Лисков-Liskov-Substitution-Principle-LSP" href="#Принцип-подстановки-Барбары-Лисков-Liskov-Substitution-Principle-LSP">Принцип подстановки Барбары Лисков (Liskov Substitution Principle, LSP)</a>
...
### <a id="Принцип-разделения-интерфейса-Interface-Segregation-Principle-ISP" href="#Принцип-разделения-интерфейса-Interface-Segregation-Principle-ISP">Принцип разделения интерфейса (Interface Segregation Principle, ISP)</a>
...
### <a id="Принцип-инверсии-зависимостей-Dependency-Inversion-Principle-DIP" href="#Принцип-инверсии-зависимостей-Dependency-Inversion-Principle-DIP">Принцип инверсии зависимостей (Dependency Inversion Principle, DIP)</a>
...
## <a id="KISS-Keep-it-short-and-simple" href="#KISS-Keep-it-short-and-simple">KISS (Keep it short and simple)</a>
...
## <a id="Чем-хуже-тем-лучше" href="#Чем-хуже-тем-лучше">Чем хуже, тем лучше</a>
...
## <a id="DRY-Dont-repeat-yourself" href="#DRY-Dont-repeat-yourself">DRY (Don’t repeat yourself)</a>
...
## <a id="YAGNI-You-aint-gonna-need-it" href="#YAGNI-You-aint-gonna-need-it">YAGNI (You ain't gonna need it)</a>
...
## <a id="GIGO-Garbage-In-Garbage-Out" href="#GIGO-Garbage-In-Garbage-Out">GIGO (Garbage In, Garbage Out)</a>
...
## <a id="HTTP-методы" href="#HTTP-методы">HTTP методы</a>
...
### <a id="Метод-GET" href="#Метод-GET">Метод **GET**</a>
...
### <a id="Метод-PUT" href="#Метод-PUT">Метод **PUT**</a>
...
### <a id="Метод-POST" href="#Метод-POST">Метод **POST**</a>
...
### <a id="Метод-DELETE" href="#Метод-DELETE">Метод **DELETE**</a>
...
## <a id="Именование-ресурсов" href="#Именование-ресурсов">Именование ресурсов</a>
...
### <a id="Наименование-ресурса" href="#Наименование-ресурса">Наименование ресурса</a>
...
### <a id="Взаимодействие-с-подресурсом-ресурса" href="#Взаимодействие-с-подресурсом-ресурса">Взаимодействие с подресурсом ресурса</a>
...
## <a id="Идемпотентность" href="#Идемпотентность">Идемпотентность</a>
...
## <a id="Безопасность" href="#Безопасность">Безопасность</a>
...
<a id="Рекомендации-по-проектированию-HTTP-API" href="#Рекомендации-по-проектированию-HTTP-API">Рекомендации по проектированию HTTP API</a>
=======================================

## <a id="Основные-принципы" href="#Основные-принципы">Основные принципы</a>

### <a id="Принцип-разделения-ответственности" href="#Принцип-разделения-ответственности">Принцип разделения ответственности</a>
...
### <a id="Требование-использования-защищенных-соединений" href="#Требование-использования-защищенных-соединений">Требование использования защищенных соединений</a>
...
### <a id="Требование-наличие-версии-в-заголовке-Accept" href="#Требование-наличие-версии-в-заголовке-Accept">Требование наличие версии в заголовке `Accept`</a>
...
### <a id="Использовать-заголовок-ETags-для-кеширования" href="#Использовать-заголовок-ETags-для-кеширования">Использовать заголовок `ETags` для кеширования</a>
...
### <a id="Использовать-Request-ID-для-интроспекции" href="#Использовать-Request-ID-для-интроспекции">Использовать `Request-ID` для интроспекции</a>
...
### <a id="Необходимо-разбивать-большие-ответы-сервера-на-несколько-небольших-при-помощи-заголовка-Range" href="#Необходимо-разбивать-большие-ответы-сервера-на-несколько-небольших-при-помощи-заголовка-Range">Необходимо разбивать большие ответы сервера на несколько небольших при помощи заголовка `Range`</a>

Большие ответы необходимо разбивать на более мелкие, используя заголовок `Range`.

## <a id="Запросы" href="#Запросы">Запросы</a>

### <a id="Соответствующие-коды-состояний" href="#Соответствующие-коды-состояний">Соответствующие коды состояний</a>
...
### <a id="Предоставление-полных-версии-ресурсов" href="#Предоставление-полных-версии-ресурсов">Предоставление полных версии ресурсов</a>
...
### <a id="API-должен-принимать-сериализованный-JSON-в-теле-запроса" href="#API-должен-принимать-сериализованный-JSON-в-теле-запроса">API должен принимать сериализованный JSON в теле запроса</a>
...
## <a id="Конструировании-пути-к-ресурсу" href="#Конструировании-пути-к-ресурсу">Конструировании пути к ресурсу</a>

### <a id="Названия-ресурсов" href="#Названия-ресурсов">Названия ресурсов</a>
...
### <a id="Действия" href="#Действия">Действия</a>
...
### <a id="Названия-компонентов-пути-и-атрибутов" href="#Названия-компонентов-пути-и-атрибутов">Названия компонентов пути и атрибутов</a>
...
### <a id="API-должен-поддерживать-доступ-к-ресурсу-не-только-по-его-id" href="#API-должен-поддерживать-доступ-к-ресурсу-не-только-по-его-id">API должен поддерживать доступ к ресурсу не только по его id</a>
...
### <a id="Необходимо-свести-к-минимуму-количество-вложений-в-пути-для-доступа-к-ресурсу" href="#Необходимо-свести-к-минимуму-количество-вложений-в-пути-для-доступа-к-ресурсу">Необходимо свести к минимуму количество вложений в пути для доступа к ресурсу</a>
...
## <a id="Ответы" href="#Ответы">Ответы</a>

### <a id="Необходимо-предоставлять-UUID-запрашиваемых-ресурсов" href="#Необходимо-предоставлять-UUID-запрашиваемых-ресурсов">Необходимо предоставлять UUID запрашиваемых ресурсов</a>
...
### <a id="Необходимо-предоставлять-информацию-о-дате-создания-и-изменения-ресурса" href="#Необходимо-предоставлять-информацию-о-дате-создания-и-изменения-ресурса">Необходимо предоставлять информацию о дате создания и изменения ресурса</a>

По умолчанию ресурс должен хранить информацию о дате его создания `created_at` и обновления `updated_at`.

### <a id="Временные-величины-должны-быть-форматированы-согласно-ISO8601" href="#Временные-величины-должны-быть-форматированы-согласно-ISO8601">Временные величины должны быть форматированы согласно ISO8601</a>

Необходимо принимать и возвращать временные данные только в **UTC**, а выводить в формате **ISO8601**.

### <a id="Отношения-с-внешними-сущностями-должны-быть-вынесены-во-вложенный-объект" href="#Отношения-с-внешними-сущностями-должны-быть-вынесены-во-вложенный-объект">Отношения с внешними сущностями должны быть вынесены во вложенный объект</a>
...
### <a id="Необходимо-создавать-структурированные-ответы-в-случае-возникновения-ошибок" href="#Необходимо-создавать-структурированные-ответы-в-случае-возникновения-ошибок">Необходимо создавать структурированные ответы в случае возникновения ошибок</a>
...
### <a id="Необходимо-показывайть-ограничение-по-количеству-запросов" href="#Необходимо-показывайть-ограничение-по-количеству-запросов">Необходимо показывайть ограничение по количеству запросов</a>
...
### <a id="JSON-во-всех-ответах-должен-быть-минимизирован" href="#JSON-во-всех-ответах-должен-быть-минимизирован">JSON во всех ответах должен быть минимизирован</a>
...
## <a id="Артефакты" href="#Артефакты">Артефакты</a>

Это отчуждаемый результат организованной деятельности, предусмотренный методологией ведения проекта.

### <a id="Необходимо-предоставлять-удобную-для-обработки-JSON-схему" href="#Необходимо-предоставлять-удобную-для-обработки-JSON-схему">Необходимо предоставлять удобную для обработки JSON-схему</a>
...
### <a id="Необходимо-предоставлять-удобочитаемую-документацию" href="#Необходимо-предоставлять-удобочитаемую-документацию">Необходимо предоставлять удобочитаемую документацию</a>
...
### <a id="Необходимо-предоставлять-примеры-запросов-которые-можно-протестировать" href="#Необходимо-предоставлять-примеры-запросов-которые-можно-протестировать">Необходимо предоставлять примеры запросов, которые можно протестировать</a>
...
### <a id="Стабильность-API" href="#Стабильность-API">Стабильность API</a>
...
<a id="Коды-состояния-HTTP" href="#Коды-состояния-HTTP">Коды состояния HTTP</a>
===================

## <a id="1xx-Informational-информационные" href="#1xx-Informational-информационные">**1xx: Informational** (информационные)</a>
...
## <a id="2xx-Success-успешно" href="#2xx-Success-успешно">**2xx: Success** (успешно)</a>
...
## <a id="3xx-Redirection-перенаправление" href="#3xx-Redirection-перенаправление">**3xx: Redirection** (перенаправление)</a>
...
## <a id="4xx-Client-Error-ошибка-клиента" href="#4xx-Client-Error-ошибка-клиента">**4xx: Client Error** (ошибка клиента)</a>
...
- **404 Not Found** ("не найдено") - в случае если сервер не находит ничего по указаной `URI`;
...
## <a id="5xx-Server-Error-ошибка-сервера" href="#5xx-Server-Error-ошибка-сервера">**5xx: Server Error** (ошибка сервера)</a>
...
<a id="HTTP-Авторизация" href="#HTTP-Авторизация">HTTP Авторизация</a>
================
...
## <a id="Доступность" href="#Доступность">Доступность</a>
...
### <a id="Измерение-доступности" href="#Измерение-доступности">Измерение доступности</a>
...
### <a id="Автоматизация-ручных-процессов" href="#Автоматизация-ручных-процессов">Автоматизация ручных процессов</a>
...
## <a id="Управление-рисками" href="#Управление-рисками">Управление рисками</a>
...
### <a id="Принципы-управления-рисками" href="#Принципы-управления-рисками">Принципы управления рисками</a>
...
### <a id="Матрица-рисков" href="#Матрица-рисков">Матрица рисков</a>
...
### <a id="Смягчение-рисков" href="#Смягчение-рисков">Смягчение рисков</a>
...
### <a id="Избыточность" href="#Избыточность">Избыточность</a>
...
### <a id="Сложность" href="#Сложность">Сложность</a>
...
### <a id="Самовосстановление" href="#Самовосстановление">Самовосстановление</a>
...
## <a id="Сервисы-и-микросервисы" href="#Сервисы-и-микросервисы">Сервисы и микросервисы</a>
...
### <a id="Обработка-отказов-сервисов" href="#Обработка-отказов-сервисов">Обработка отказов сервисов</a>
