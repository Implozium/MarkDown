...
- [Документ, события, интерфейсы](#072a140206)
    - [Дерево DOM](#50eac79890)
    - [Навигация по DOM-элементам](#ff7c8ab143)
    - [Поиск](#715c28b3ae)
    - [Свойства узлов](#bb340da4c5)
    - [Полифиллы](#8cdd59c055)
    - [Свои DOM-свойства](#e900029b1d)
    - [Атрибуты](#50147ccfce)
    - [Относительное расположение узлов](#25b98d2bdd)
    - [Добавление и удаление узлов](#922b0859e4)
        - [Мультивставка](#0fdec9d038)
        - [`DocumentFragment`](#f79e9ba902)
        - [Новые методы](#221ce7490b)
    - [Метод `document.write`](#2bf0627f83)
    - [Стили](#4f07f2c57d)
        - [Полный стиль](#f1a79eb844)
    - [Размеры и прокрутка элементов](#203bcf4fc4)
    - [Размеры и прокрутка страницы](#40d2de976c)
    - [Координаты в окне](#8a6d68c8ed)
    - [Координаты в документе](#f64f0c1d3e)
    - [`MutationObserver`](#da201e3c1a)
- [Основы работы с событиями](#166b8b5794)
    - [События мыши](#b010b5c239)
    - [События на элементах управления](#609140c1f6)
    - [Клавиатурные события](#846327de7b)
    - [События манипулирования текстом](#eca9017803)
    - [События выделения текста](#82e02238e5)
    - [События перетаскивания Drag'n'Drop](#0230938d13)
    - [События печати](#38670e8f0d)
    - [События CSS transition](#eea2e5eb34)
    - [События CSS анимации](#cad66d043f)
    - [События `Frame` и `Object`](#924449405a)
    - [События касания](#d6e44920d6)
    - [Другие события](#a88effe6e4)
    - [Обработка событий](#cd39bc9c09)
        - [Очередь событий](#878d809306)
        - [Основные свойства объекта события `Event`](#08fd267df9)
        - [Всплытие](#5289500bf9)
        - [Погружение](#87be6c9ec5)
        - [Делегирование событий](#48fddd66b1)
        - [Приём проектирования "поведение"](#db9c1f8b67)
        - [Отмена действия браузера по умолчанию](#0e2fdaf313)
        - [Генерация событий на элементах](#59aa0c35cd)
        - [Свои события](#2a0ae6edd9)
        - [Старое API](#6f407dcfbc)
        - [Мышь: Drag'n'Drop](#927b2a59a3)
- [Формы, элементы управления](#7fb2dcb02c)
    - [Навигация и свойства элементов формы](#c175b5cce7)
    - [Файлы](#208718e0d4)
    - [Фокусировка](#76ecf5bd2f)
    - [Изменение](#221fe33b25)
    - [Формы](#39956544c0)
- [Создание графических компонентов](#c340674c27)
    - [Основные принципы при создании виджета](#fcdbcfcf4c)
    - [Вёрстка графических компонентов](#8a27560315)
    - [Создание анимации с помощью `requestAnimationFrame`](#410babbc8d)
    - [Шаблонизация](#6ab3444af5)
    - [Коллбэки](#610c3ed322)
- [AJAX и COMET](#27ab0f5c41)
    - [`XMLHttpRequest`](#38c2e32e62)
        - [Событие `readystatechange`](#e0a8c81261)
        - [HTTP-заголовки](#64c8ba92d0)
        - [POST](#f68dd40d31)
            - [POST-запрос в кодировке multipart/form-data](#4d2a94afef)
        - [`FormData`](#c031b7c5c2)
    - [Кросс-доменные запросы](#32a0afcb4b)
        - [Стадия закачки](#bb189d84ae)
    - [COMET с XMLHttpRequest: длинные опросы](#09f945b203)
    - [WebSocket](#84b86c7ee5)
    - [Протокол JSONP](#bb9150cf44)
        - [Реестр CallbackRegistry](#38341f76a0)
        - [Обнаружение ошибок](#304099fa2f)
        - [COMET](#e0ff8e314c)
    - [Server Side Events - события с сервера](#0c92e95a44)
        - [Идентификатор id](#d0068e81be)
        - [Статус соединения `readyState`](#35cc7a8e04)
        - [Кросс-доменность](#04e8220225)
    - [Атака CSRF](#17e596356f)
        - [Защита](#7cf3cc798f)
        - [Токен и AJAX](#7fd68396dc)
    - [Метод `fetch`: замена `XMLHttpRequest` (ES6)](#dccf96bc2f)
- [Куки, `document.cookie`](#579e92aa2a)
- [Локальное хранилище](#51d550db3e)
- [Управление историей браузера](#0db4cd8750)
- [Worker](#d8241f40b4)
    - [Выделенные воркеры](#70513377e5)
        - [Строение воркера](#eed41a9845)
    - [Сервис-воркеры](#7f32ad3bc2)
        - [Строение воркера](#eed41a9845)
    - [Широковещательный канал передачи данных `BroadcastChannel`](#46e8aad2da)
- [Push API и Notifications API](#e73526ced0)
    - [Push API](#f0e2ac7c84)
- [jQuery](#20b2deab4d)
    - [Команды jQuery](#7a8b28bfde)
        - [Загрузка кода после загрузки страници](#66d13f1610)
        - [Цепочки команд](#ca0ef7e4a9)
        - [Перебор выборки всех элементов](#c36168aab0)
    - [Методы навигации по DOM](#7dba91ce41)
    - [Атрибуты элементов и CSS](#c939c053d9)
        - [CSS свойства](#e91eec6549)
        - [CSS классы](#02f06c4542)
        - [Атрибуты](#50147ccfce)
        - [data-атрибуты](#7899f06976)
        - [Свойства элементов](#28275c215b)
    - [События](#984f25dbcf)
        - [Пространство имен](#732c016404)
    - [Анимация](#bed2e50789)
        - [`animate`](#26a4e2153e)
            - [Остановка анимации](#1abfffbeb0)
    - [Манипуляции с DOM](#7134927e6b)
        - [Создания элементов](#00e51128ff)
        - [Перемещение элементов](#2e98055b26)
        - [Размеры элементов](#904bd21a1a)
        - [Прокрутка](#cc177bf0b0)
    - [Работа с формами](#6f5690bf04)
    - [AJAX](#1bf1f3e5fc)
        - [Префильтры](#f4c0bd89d5)
        - [Конверторы](#e962f80f61)
        - [Транспорт](#40ff1b6162)
    - [Объект `Deferred` и подобные](#f9f6a6268b)
        - [Методы уведомлений](#0c855c8856)
    - [`Callbacks`](#724aca68f0)
    - [Дополнительные методы](#9f47598b37)
    - [jQuery плагин](#7511d5649d)
        - [Публичные методы](#ee2a2f1cc9)
- [Webpack](#a5c0e89efa)
    - [Включение зависимостей](#702792ece6)
        - [Сборка](#bde5ca2203)
    - [Конфигурация](#b84b3ec275)
    - [Сойства](#48cc1219df)
        - [Плагины](#45f4625472)
            - [Плагин `webpack.EnviromentPlugin`](#1128a2002f)
            - [Плагин `webpack.DefinePlugin`](#586fb77200)
            - [Плагин ` webpack.optimize.UglifyJsPlugin`](#62a1ce3f11)
            - [Плагин `webpack.NormalModuleReplacementPlugin`](#62dfc4ff0a)
            - [Плагин `webpack.NoErrorsPlugin`](#0c440c1440)
            - [Плагин `webpack.CommonsChunkPlugin`](#0171da2ec1)

<a id="072a140206" href="#072a140206">Документ, события, интерфейсы</a>
=============================

## <a id="50eac79890" href="#50eac79890">Дерево DOM</a>
...
## <a id="ff7c8ab143" href="#ff7c8ab143">Навигация по DOM-элементам</a>
...
## <a id="715c28b3ae" href="#715c28b3ae">Поиск</a>
...
## <a id="bb340da4c5" href="#bb340da4c5">Свойства узлов</a>
...
## <a id="8cdd59c055" href="#8cdd59c055">Полифиллы</a>
...
## <a id="e900029b1d" href="#e900029b1d">Свои DOM-свойства</a>
...
## <a id="50147ccfce" href="#50147ccfce">Атрибуты</a>
...
## <a id="25b98d2bdd" href="#25b98d2bdd">Относительное расположение узлов</a>
...
## <a id="922b0859e4" href="#922b0859e4">Добавление и удаление узлов</a>
...
### <a id="0fdec9d038" href="#0fdec9d038">Мультивставка</a>
...
### <a id="f79e9ba902" href="#f79e9ba902">`DocumentFragment`</a>
...
### <a id="221ce7490b" href="#221ce7490b">Новые методы</a>
...
## <a id="2bf0627f83" href="#2bf0627f83">Метод `document.write`</a>
...
## <a id="4f07f2c57d" href="#4f07f2c57d">Стили</a>
...
### <a id="f1a79eb844" href="#f1a79eb844">Полный стиль</a>
...
## <a id="203bcf4fc4" href="#203bcf4fc4">Размеры и прокрутка элементов</a>
...
## <a id="40d2de976c" href="#40d2de976c">Размеры и прокрутка страницы</a>
...
## <a id="8a6d68c8ed" href="#8a6d68c8ed">Координаты в окне</a>
...
## <a id="f64f0c1d3e" href="#f64f0c1d3e">Координаты в документе</a>
...
## <a id="da201e3c1a" href="#da201e3c1a">`MutationObserver`</a>
...
<a id="166b8b5794" href="#166b8b5794">Основы работы с событиями</a>
=========================

**Событие** - это сигнал от браузера о том, что что-то произошло. Существует много видов событий.

## <a id="b010b5c239" href="#b010b5c239">События мыши</a>
...
## <a id="609140c1f6" href="#609140c1f6">События на элементах управления</a>
...
## <a id="846327de7b" href="#846327de7b">Клавиатурные события</a>
...
## <a id="eca9017803" href="#eca9017803">События манипулирования текстом</a>
...
## <a id="82e02238e5" href="#82e02238e5">События выделения текста</a>
...
## <a id="0230938d13" href="#0230938d13">События перетаскивания Drag'n'Drop</a>
...
## <a id="38670e8f0d" href="#38670e8f0d">События печати</a>
...
## <a id="eea2e5eb34" href="#eea2e5eb34">События CSS transition</a>
...
## <a id="cad66d043f" href="#cad66d043f">События CSS анимации</a>
...
## <a id="924449405a" href="#924449405a">События `Frame` и `Object`</a>
...
## <a id="d6e44920d6" href="#d6e44920d6">События касания</a>
...
## <a id="a88effe6e4" href="#a88effe6e4">Другие события</a>
...
## <a id="cd39bc9c09" href="#cd39bc9c09">Обработка событий</a>
...
### <a id="878d809306" href="#878d809306">Очередь событий</a>
...
### <a id="08fd267df9" href="#08fd267df9">Основные свойства объекта события `Event`</a>
...
### <a id="5289500bf9" href="#5289500bf9">Всплытие</a>
...
### <a id="87be6c9ec5" href="#87be6c9ec5">Погружение</a>
...
### <a id="48fddd66b1" href="#48fddd66b1">Делегирование событий</a>
...
### <a id="db9c1f8b67" href="#db9c1f8b67">Приём проектирования "поведение"</a>
...
### <a id="0e2fdaf313" href="#0e2fdaf313">Отмена действия браузера по умолчанию</a>
...
### <a id="59aa0c35cd" href="#59aa0c35cd">Генерация событий на элементах</a>
...
### <a id="2a0ae6edd9" href="#2a0ae6edd9">Свои события</a>
...
### <a id="6f407dcfbc" href="#6f407dcfbc">Старое API</a>
...
### <a id="927b2a59a3" href="#927b2a59a3">Мышь: Drag'n'Drop</a>
...
<a id="7fb2dcb02c" href="#7fb2dcb02c">Формы, элементы управления</a>
==========================

## <a id="c175b5cce7" href="#c175b5cce7">Навигация и свойства элементов формы</a>
...
## <a id="208718e0d4" href="#208718e0d4">Файлы</a>
...
## <a id="76ecf5bd2f" href="#76ecf5bd2f">Фокусировка</a>
...
## <a id="221fe33b25" href="#221fe33b25">Изменение</a>
...
## <a id="39956544c0" href="#39956544c0">Формы</a>
...
<a id="c340674c27" href="#c340674c27">Создание графических компонентов</a>
================================

**Виджет** - это объект, который либо контролирует готовое дерево DOM, либо создаёт своё.

## <a id="fcdbcfcf4c" href="#fcdbcfcf4c">Основные принципы при создании виджета</a>
...
## <a id="8a27560315" href="#8a27560315">Вёрстка графических компонентов</a>
...
## <a id="410babbc8d" href="#410babbc8d">Создание анимации с помощью `requestAnimationFrame`</a>
...
## <a id="6ab3444af5" href="#6ab3444af5">Шаблонизация</a>
...
## <a id="610c3ed322" href="#610c3ed322">Коллбэки</a>
...
<a id="27ab0f5c41" href="#27ab0f5c41">AJAX и COMET</a>
============
...
## <a id="38c2e32e62" href="#38c2e32e62">`XMLHttpRequest`</a>
...
### <a id="e0a8c81261" href="#e0a8c81261">Событие `readystatechange`</a>
...
### <a id="64c8ba92d0" href="#64c8ba92d0">HTTP-заголовки</a>
...
### <a id="f68dd40d31" href="#f68dd40d31">POST</a>
...
#### <a id="4d2a94afef" href="#4d2a94afef">POST-запрос в кодировке multipart/form-data</a>
...
### <a id="c031b7c5c2" href="#c031b7c5c2">`FormData`</a>
...
## <a id="32a0afcb4b" href="#32a0afcb4b">Кросс-доменные запросы</a>
...
### <a id="bb189d84ae" href="#bb189d84ae">Стадия закачки</a>
...
## <a id="09f945b203" href="#09f945b203">COMET с XMLHttpRequest: длинные опросы</a>
...
## <a id="84b86c7ee5" href="#84b86c7ee5">WebSocket</a>
...
## <a id="bb9150cf44" href="#bb9150cf44">Протокол JSONP</a>
...
### <a id="38341f76a0" href="#38341f76a0">Реестр CallbackRegistry</a>
...
### <a id="304099fa2f" href="#304099fa2f">Обнаружение ошибок</a>
...
### <a id="e0ff8e314c" href="#e0ff8e314c">COMET</a>
...
## <a id="0c92e95a44" href="#0c92e95a44">Server Side Events - события с сервера</a>
...
### <a id="d0068e81be" href="#d0068e81be">Идентификатор id</a>
...
### <a id="35cc7a8e04" href="#35cc7a8e04">Статус соединения `readyState`</a>
...
### <a id="04e8220225" href="#04e8220225">Кросс-доменность</a>
...
## <a id="17e596356f" href="#17e596356f">Атака CSRF</a>
...
### <a id="7cf3cc798f" href="#7cf3cc798f">Защита</a>
...
### <a id="7fd68396dc" href="#7fd68396dc">Токен и AJAX</a>
...
## <a id="dccf96bc2f" href="#dccf96bc2f">Метод `fetch`: замена `XMLHttpRequest` (ES6)</a>
...
<a id="579e92aa2a" href="#579e92aa2a">Куки, `document.cookie`</a>
=====================
...
<a id="51d550db3e" href="#51d550db3e">Локальное хранилище</a>
===================
...
<a id="0db4cd8750" href="#0db4cd8750">Управление историей браузера</a>
============================
...
<a id="d8241f40b4" href="#d8241f40b4">Worker</a>
======
...
## <a id="70513377e5" href="#70513377e5">Выделенные воркеры</a>
...
### <a id="eed41a9845" href="#eed41a9845">Строение воркера</a>
...
## <a id="7f32ad3bc2" href="#7f32ad3bc2">Сервис-воркеры</a>
...
## <a id="46e8aad2da" href="#46e8aad2da">Широковещательный канал передачи данных `BroadcastChannel`</a>
...
<a id="e73526ced0" href="#e73526ced0">Push API и Notifications API</a>
============================
...
## <a id="f0e2ac7c84" href="#f0e2ac7c84">Push API</a>
...
<a id="20b2deab4d" href="#20b2deab4d">jQuery</a>
======
...
## <a id="7a8b28bfde" href="#7a8b28bfde">Команды jQuery</a>
...
### <a id="66d13f1610" href="#66d13f1610">Загрузка кода после загрузки страници</a>
...
### <a id="ca0ef7e4a9" href="#ca0ef7e4a9">Цепочки команд</a>
...
### <a id="c36168aab0" href="#c36168aab0">Перебор выборки всех элементов</a>
...
## <a id="7dba91ce41" href="#7dba91ce41">Методы навигации по DOM</a>
...
## <a id="c939c053d9" href="#c939c053d9">Атрибуты элементов и CSS</a>

### <a id="e91eec6549" href="#e91eec6549">CSS свойства</a>
...
### <a id="02f06c4542" href="#02f06c4542">CSS классы</a>
...
### <a id="7899f06976" href="#7899f06976">data-атрибуты</a>
...
### <a id="28275c215b" href="#28275c215b">Свойства элементов</a>
...
## <a id="984f25dbcf" href="#984f25dbcf">События</a>
...
### <a id="732c016404" href="#732c016404">Пространство имен</a>
...
## <a id="bed2e50789" href="#bed2e50789">Анимация</a>
...
### <a id="26a4e2153e" href="#26a4e2153e">`animate`</a>
...
#### <a id="1abfffbeb0" href="#1abfffbeb0">Остановка анимации</a>
...
## <a id="7134927e6b" href="#7134927e6b">Манипуляции с DOM</a>

### <a id="00e51128ff" href="#00e51128ff">Создания элементов</a>

`$('<<имя_тега>>'[, <объект_атрибутов_элемента>])` - создает jQuery элемент.

### <a id="2e98055b26" href="#2e98055b26">Перемещение элементов</a>
...
### <a id="904bd21a1a" href="#904bd21a1a">Размеры элементов</a>
...
### <a id="cc177bf0b0" href="#cc177bf0b0">Прокрутка</a>
...
## <a id="6f5690bf04" href="#6f5690bf04">Работа с формами</a>
...
## <a id="1bf1f3e5fc" href="#1bf1f3e5fc">AJAX</a>
...
### <a id="f4c0bd89d5" href="#f4c0bd89d5">Префильтры</a>
...
### <a id="e962f80f61" href="#e962f80f61">Конверторы</a>
...
### <a id="40ff1b6162" href="#40ff1b6162">Транспорт</a>
...
## <a id="f9f6a6268b" href="#f9f6a6268b">Объект `Deferred` и подобные</a>
...
### <a id="0c855c8856" href="#0c855c8856">Методы уведомлений</a>
...
## <a id="724aca68f0" href="#724aca68f0">`Callbacks`</a>
...
## <a id="9f47598b37" href="#9f47598b37">Дополнительные методы</a>
...
## <a id="7511d5649d" href="#7511d5649d">jQuery плагин</a>
...
### <a id="ee2a2f1cc9" href="#ee2a2f1cc9">Публичные методы</a>
...
### <a id="bde5ca2203" href="#bde5ca2203">Сборка</a>
...
## <a id="b84b3ec275" href="#b84b3ec275">Конфигурация</a>
...
## <a id="48cc1219df" href="#48cc1219df">Сойства</a>
...
### <a id="45f4625472" href="#45f4625472">Плагины</a>

Плагины можно повторять.

#### <a id="1128a2002f" href="#1128a2002f">Плагин `webpack.EnviromentPlugin`</a>
...
#### <a id="586fb77200" href="#586fb77200">Плагин `webpack.DefinePlugin`</a>
...
#### <a id="62a1ce3f11" href="#62a1ce3f11">Плагин ` webpack.optimize.UglifyJsPlugin`</a>
...
#### <a id="62dfc4ff0a" href="#62dfc4ff0a">Плагин `webpack.NormalModuleReplacementPlugin`</a>
...
#### <a id="0c440c1440" href="#0c440c1440">Плагин `webpack.NoErrorsPlugin`</a>

Позволяет не собирать сборку, если есть какая-то ошибка в сборке.

`const NoErrorsPlugin = new webpack.NoErrorsPlugin();`.

#### <a id="0171da2ec1" href="#0171da2ec1">Плагин `webpack.CommonsChunkPlugin`</a>
