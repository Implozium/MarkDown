...
class <CustomElement> extends HTMLElement {
    ...
    constructor() {
        ...
        this.shadowRoot; // возвращает ShadowRoot с которым можно взаимодействовать как с DOM-узлом
...
У элемента связанного со слотом есть свойство `assignedSlot` - которое является ссылочным типом на слот если он есть или `null`.
