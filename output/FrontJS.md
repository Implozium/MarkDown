...
- [Подключение](#Подключение)
    - [Использование в HTML](#Использование-в-HTML)
- [Документ, события, интерфейсы](#Документ-события-интерфейсы)
    - [Дерево DOM](#Дерево-DOM)
    - [Навигация по DOM-элементам](#Навигация-по-DOM-элементам)
    - [Поиск](#Поиск)
    - [Свойства узлов](#Свойства-узлов)
        - [Таблица](#Таблица)
    - [Полифиллы](#Полифиллы)
    - [Свои DOM-свойства](#Свои-DOM-свойства)
    - [Атрибуты](#Атрибуты)
    - [Относительное расположение узлов](#Относительное-расположение-узлов)
    - [Добавление и удаление узлов](#Добавление-и-удаление-узлов)
        - [Мультивставка](#Мультивставка)
        - [`DocumentFragment`](#DocumentFragment)
        - [Новые методы](#Новые-методы)
    - [Метод `document.write`](#Метод-documentwrite)
    - [Стили](#Стили)
        - [Полный стиль](#Полный-стиль)
    - [Размеры и прокрутка элементов](#Размеры-и-прокрутка-элементов)
    - [Размеры и прокрутка страницы](#Размеры-и-прокрутка-страницы)
    - [Координаты в окне](#Координаты-в-окне)
    - [Координаты в документе](#Координаты-в-документе)
    - [`MutationObserver`](#MutationObserver)
- [Основы работы с событиями](#Основы-работы-с-событиями)
    - [События мыши](#События-мыши)
    - [События на элементах управления](#События-на-элементах-управления)
    - [Клавиатурные события](#Клавиатурные-события)
    - [События манипулирования текстом](#События-манипулирования-текстом)
    - [События выделения текста](#События-выделения-текста)
    - [События перетаскивания Drag'n'Drop](#События-перетаскивания-DragnDrop)
    - [События печати](#События-печати)
    - [События CSS transition](#События-CSS-transition)
    - [События CSS анимации](#События-CSS-анимации)
    - [События `Frame` и `Object`](#События-Frame-и-Object)
    - [События касания](#События-касания)
    - [Другие события](#Другие-события)
    - [Обработка событий](#Обработка-событий)
        - [Очередь событий](#Очередь-событий)
        - [Основные свойства объекта события `Event`](#Основные-свойства-объекта-события-Event)
        - [Всплытие](#Всплытие)
        - [Погружение](#Погружение)
        - [Делегирование событий](#Делегирование-событий)
        - [Приём проектирования "поведение"](#Приём-проектирования-поведение)
        - [Отмена действия браузера по умолчанию](#Отмена-действия-браузера-по-умолчанию)
        - [Генерация событий на элементах](#Генерация-событий-на-элементах)
        - [Свои события](#Свои-события)
        - [Старое API](#Старое-API)
        - [Мышь: Drag'n'Drop](#Мышь-DragnDrop)
- [Формы, элементы управления](#Формы-элементы-управления)
    - [Навигация и свойства элементов формы](#Навигация-и-свойства-элементов-формы)
    - [Файлы](#Файлы)
    - [Фокусировка](#Фокусировка)
    - [Изменение](#Изменение)
    - [Формы](#Формы)
- [Обработка ошибок](#Обработка-ошибок)
- [Взаимодействие с пользователем: `alert`, `prompt`, `confirm`](#Взаимодействие-с-пользователем-alert-prompt-confirm)
- [Создание графических компонентов](#Создание-графических-компонентов)
    - [Основные принципы при создании виджета](#Основные-принципы-при-создании-виджета)
    - [Вёрстка графических компонентов](#Вёрстка-графических-компонентов)
    - [Создание анимации с помощью `requestAnimationFrame`](#Создание-анимации-с-помощью-requestAnimationFrame)
    - [Шаблонизация](#Шаблонизация)
    - [Коллбэки](#Коллбэки)
- [AJAX и COMET](#AJAX-и-COMET)
    - [`XMLHttpRequest`](#XMLHttpRequest)
        - [Событие `readystatechange`](#Событие-readystatechange)
        - [HTTP-заголовки](#HTTP-заголовки)
        - [POST](#POST)
            - [POST-запрос в кодировке multipart/form-data](#POST-запрос-в-кодировке-multipartform-data)
        - [`FormData`](#FormData)
    - [Кросс-доменные запросы](#Кросс-доменные-запросы)
        - [Стадия закачки](#Стадия-закачки)
    - [COMET с XMLHttpRequest: длинные опросы](#COMET-с-XMLHttpRequest-длинные-опросы)
    - [WebSocket](#WebSocket)
    - [Протокол JSONP](#Протокол-JSONP)
        - [Реестр CallbackRegistry](#Реестр-CallbackRegistry)
        - [Обнаружение ошибок](#Обнаружение-ошибок)
        - [COMET](#COMET)
    - [Server Side Events - события с сервера](#Server-Side-Events---события-с-сервера)
        - [Идентификатор id](#Идентификатор-id)
        - [Статус соединения `readyState`](#Статус-соединения-readyState)
        - [Кросс-доменность](#Кросс-доменность)
    - [Атака CSRF](#Атака-CSRF)
        - [Защита](#Защита)
        - [Токен и AJAX](#Токен-и-AJAX)
    - [Метод `fetch`: замена `XMLHttpRequest` (ES6)](#Метод-fetch-замена-XMLHttpRequest-ES6)
- [Куки, `document.cookie`](#Куки-documentcookie)
- [Локальное хранилище](#Локальное-хранилище)
- [Управление историей браузера](#Управление-историей-браузера)
- [Worker](#Worker)
    - [Выделенные воркеры](#Выделенные-воркеры)
        - [Строение воркера](#Строение-воркера)
    - [Сервис-воркеры](#Сервис-воркеры)
        - [Строение воркера](#Строение-воркера)
    - [Широковещательный канал передачи данных `BroadcastChannel`](#Широковещательный-канал-передачи-данных-BroadcastChannel)
- [Push API и Notifications API](#Push-API-и-Notifications-API)
    - [Push API](#Push-API)
- [jQuery](#jQuery)
    - [Команды jQuery](#Команды-jQuery)
        - [Загрузка кода после загрузки страници](#Загрузка-кода-после-загрузки-страници)
        - [Цепочки команд](#Цепочки-команд)
        - [Перебор выборки всех элементов](#Перебор-выборки-всех-элементов)
    - [Методы навигации по DOM](#Методы-навигации-по-DOM)
    - [Атрибуты элементов и CSS](#Атрибуты-элементов-и-CSS)
    ...
    - [Анимация](#Анимация)
        - [`animate`](#animate)
            - [Остановка анимации](#Остановка-анимации)
    - [Манипуляции с DOM](#Манипуляции-с-DOM)
        - [Создания элементов](#Создания-элементов)
        - [Перемещение элементов](#Перемещение-элементов)
        - [Размеры элементов](#Размеры-элементов)
        - [Прокрутка](#Прокрутка)
    - [Работа с формами](#Работа-с-формами)
    - [AJAX](#AJAX)
        - [Префильтры](#Префильтры)
        - [Конверторы](#Конверторы)
        - [Транспорт](#Транспорт)
    - [Объект `Deferred` и подобные](#Объект-Deferred-и-подобные)
        - [Методы уведомлений](#Методы-уведомлений)
    - [`Callbacks`](#Callbacks)
    - [Дополнительные методы](#Дополнительные-методы)
    - [jQuery плагин](#jQuery-плагин)
        - [Публичные методы](#Публичные-методы)
- [Webpack](#Webpack)
    - [Включение зависимостей](#Включение-зависимостей)
        - [Сборка](#Сборка)
    - [Конфигурация](#Конфигурация)
    - [Сойства](#Сойства)
        - [Плагины](#Плагины)
            - [Плагин `webpack.EnviromentPlugin`](#Плагин-webpackEnviromentPlugin)
            - [Плагин `webpack.DefinePlugin`](#Плагин-webpackDefinePlugin)
            - [Плагин ` webpack.optimize.UglifyJsPlugin`](#Плагин--webpackoptimizeUglifyJsPlugin)
            - [Плагин `webpack.NormalModuleReplacementPlugin`](#Плагин-webpackNormalModuleReplacementPlugin)
            - [Плагин `webpack.NoErrorsPlugin`](#Плагин-webpackNoErrorsPlugin)
            - [Плагин `webpack.CommonsChunkPlugin`](#Плагин-webpackCommonsChunkPlugin)
- [Пример тестирования](#Пример-тестирования)

<a id="Подключение" href="#Подключение">Подключение</a>
===========

## <a id="Использование-в-HTML" href="#Использование-в-HTML">Использование в HTML</a>
...
Атрибут `defer` - скрипт также выполняется асинхронно, не заставляет ждать страницу, но есть два отличия от `async`: первое - браузер гарантирует, что относительный порядок скриптов с `defer` будет сохранён; второе отличие - скрипт с `defer` сработает, когда весь HTML-документ будет обработан браузером.
...
<a id="Документ-события-интерфейсы" href="#Документ-события-интерфейсы">Документ, события, интерфейсы</a>
=============================

## <a id="Дерево-DOM" href="#Дерево-DOM">Дерево DOM</a>
...
## <a id="Навигация-по-DOM-элементам" href="#Навигация-по-DOM-элементам">Навигация по DOM-элементам</a>
...
## <a id="Свойства-узлов" href="#Свойства-узлов">Свойства узлов</a>
...
### <a id="Таблица" href="#Таблица">Таблица</a>
...
## <a id="Полифиллы" href="#Полифиллы">Полифиллы</a>
...
## <a id="Свои-DOM-свойства" href="#Свои-DOM-свойства">Свои DOM-свойства</a>
...
## <a id="Атрибуты" href="#Атрибуты">Атрибуты</a>
...
## <a id="Относительное-расположение-узлов" href="#Относительное-расположение-узлов">Относительное расположение узлов</a>
...
## <a id="Добавление-и-удаление-узлов" href="#Добавление-и-удаление-узлов">Добавление и удаление узлов</a>
...
### <a id="Мультивставка" href="#Мультивставка">Мультивставка</a>
...
### <a id="DocumentFragment" href="#DocumentFragment">`DocumentFragment`</a>
...
### <a id="Новые-методы" href="#Новые-методы">Новые методы</a>
...
## <a id="Метод-documentwrite" href="#Метод-documentwrite">Метод `document.write`</a>
...
### <a id="Полный-стиль" href="#Полный-стиль">Полный стиль</a>
...
## <a id="Размеры-и-прокрутка-элементов" href="#Размеры-и-прокрутка-элементов">Размеры и прокрутка элементов</a>
...
## <a id="Размеры-и-прокрутка-страницы" href="#Размеры-и-прокрутка-страницы">Размеры и прокрутка страницы</a>
...
## <a id="Координаты-в-окне" href="#Координаты-в-окне">Координаты в окне</a>
...
## <a id="Координаты-в-документе" href="#Координаты-в-документе">Координаты в документе</a>
...
## <a id="MutationObserver" href="#MutationObserver">`MutationObserver`</a>
...
<a id="Основы-работы-с-событиями" href="#Основы-работы-с-событиями">Основы работы с событиями</a>
=========================

**Событие** - это сигнал от браузера о том, что что-то произошло. Существует много видов событий.

## <a id="События-мыши" href="#События-мыши">События мыши</a>
...
## <a id="События-на-элементах-управления" href="#События-на-элементах-управления">События на элементах управления</a>
...
## <a id="Клавиатурные-события" href="#Клавиатурные-события">Клавиатурные события</a>
...
## <a id="События-манипулирования-текстом" href="#События-манипулирования-текстом">События манипулирования текстом</a>
...
## <a id="События-выделения-текста" href="#События-выделения-текста">События выделения текста</a>
...
## <a id="События-перетаскивания-DragnDrop" href="#События-перетаскивания-DragnDrop">События перетаскивания Drag'n'Drop</a>
...
## <a id="События-печати" href="#События-печати">События печати</a>
...
## <a id="События-CSS-transition" href="#События-CSS-transition">События CSS transition</a>
...
## <a id="События-CSS-анимации" href="#События-CSS-анимации">События CSS анимации</a>
...
## <a id="События-Frame-и-Object" href="#События-Frame-и-Object">События `Frame` и `Object`</a>
...
## <a id="События-касания" href="#События-касания">События касания</a>
...
## <a id="Другие-события" href="#Другие-события">Другие события</a>
...
### <a id="Очередь-событий" href="#Очередь-событий">Очередь событий</a>
...
### <a id="Основные-свойства-объекта-события-Event" href="#Основные-свойства-объекта-события-Event">Основные свойства объекта события `Event`</a>
...
### <a id="Всплытие" href="#Всплытие">Всплытие</a>
...
### <a id="Погружение" href="#Погружение">Погружение</a>
...
### <a id="Делегирование-событий" href="#Делегирование-событий">Делегирование событий</a>
...
### <a id="Приём-проектирования-поведение" href="#Приём-проектирования-поведение">Приём проектирования "поведение"</a>
...
### <a id="Отмена-действия-браузера-по-умолчанию" href="#Отмена-действия-браузера-по-умолчанию">Отмена действия браузера по умолчанию</a>
...
### <a id="Генерация-событий-на-элементах" href="#Генерация-событий-на-элементах">Генерация событий на элементах</a>
...
### <a id="Свои-события" href="#Свои-события">Свои события</a>
...
### <a id="Старое-API" href="#Старое-API">Старое API</a>
...
### <a id="Мышь-DragnDrop" href="#Мышь-DragnDrop">Мышь: Drag'n'Drop</a>
...
<a id="Формы-элементы-управления" href="#Формы-элементы-управления">Формы, элементы управления</a>
==========================

## <a id="Навигация-и-свойства-элементов-формы" href="#Навигация-и-свойства-элементов-формы">Навигация и свойства элементов формы</a>
...
## <a id="Фокусировка" href="#Фокусировка">Фокусировка</a>
...
## <a id="Изменение" href="#Изменение">Изменение</a>
...
<a id="Обработка-ошибок" href="#Обработка-ошибок">Обработка ошибок</a>
================
...
<a id="Создание-графических-компонентов" href="#Создание-графических-компонентов">Создание графических компонентов</a>
================================

**Виджет** - это объект, который либо контролирует готовое дерево DOM, либо создаёт своё.

## <a id="Основные-принципы-при-создании-виджета" href="#Основные-принципы-при-создании-виджета">Основные принципы при создании виджета</a>
...
## <a id="Вёрстка-графических-компонентов" href="#Вёрстка-графических-компонентов">Вёрстка графических компонентов</a>
...
## <a id="Создание-анимации-с-помощью-requestAnimationFrame" href="#Создание-анимации-с-помощью-requestAnimationFrame">Создание анимации с помощью `requestAnimationFrame`</a>
...
## <a id="Шаблонизация" href="#Шаблонизация">Шаблонизация</a>
...
## <a id="Коллбэки" href="#Коллбэки">Коллбэки</a>
...
<a id="AJAX-и-COMET" href="#AJAX-и-COMET">AJAX и COMET</a>
============
...
## <a id="XMLHttpRequest" href="#XMLHttpRequest">`XMLHttpRequest`</a>
...
### <a id="Событие-readystatechange" href="#Событие-readystatechange">Событие `readystatechange`</a>
...
### <a id="HTTP-заголовки" href="#HTTP-заголовки">HTTP-заголовки</a>
...
#### <a id="POST-запрос-в-кодировке-multipartform-data" href="#POST-запрос-в-кодировке-multipartform-data">POST-запрос в кодировке multipart/form-data</a>
...
### <a id="FormData" href="#FormData">`FormData`</a>
...
## <a id="Кросс-доменные-запросы" href="#Кросс-доменные-запросы">Кросс-доменные запросы</a>
...
### <a id="Стадия-закачки" href="#Стадия-закачки">Стадия закачки</a>
...
## <a id="COMET-с-XMLHttpRequest-длинные-опросы" href="#COMET-с-XMLHttpRequest-длинные-опросы">COMET с XMLHttpRequest: длинные опросы</a>
...
## <a id="WebSocket" href="#WebSocket">WebSocket</a>
...
## <a id="Протокол-JSONP" href="#Протокол-JSONP">Протокол JSONP</a>
...
### <a id="Реестр-CallbackRegistry" href="#Реестр-CallbackRegistry">Реестр CallbackRegistry</a>
...
### <a id="Обнаружение-ошибок" href="#Обнаружение-ошибок">Обнаружение ошибок</a>
...
## <a id="Server-Side-Events---события-с-сервера" href="#Server-Side-Events---события-с-сервера">Server Side Events - события с сервера</a>
...
### <a id="Идентификатор-id" href="#Идентификатор-id">Идентификатор id</a>
...
### <a id="Статус-соединения-readyState" href="#Статус-соединения-readyState">Статус соединения `readyState`</a>
...
### <a id="Кросс-доменность" href="#Кросс-доменность">Кросс-доменность</a>
...
## <a id="Атака-CSRF" href="#Атака-CSRF">Атака CSRF</a>
...
### <a id="Защита" href="#Защита">Защита</a>
...
### <a id="Токен-и-AJAX" href="#Токен-и-AJAX">Токен и AJAX</a>
...
## <a id="Метод-fetch-замена-XMLHttpRequest-ES6" href="#Метод-fetch-замена-XMLHttpRequest-ES6">Метод `fetch`: замена `XMLHttpRequest` (ES6)</a>
...
<a id="Куки-documentcookie" href="#Куки-documentcookie">Куки, `document.cookie`</a>
=====================
...
<a id="Локальное-хранилище" href="#Локальное-хранилище">Локальное хранилище</a>
===================
...
<a id="Управление-историей-браузера" href="#Управление-историей-браузера">Управление историей браузера</a>
============================
...
<a id="Worker" href="#Worker">Worker</a>
======
...
## <a id="Выделенные-воркеры" href="#Выделенные-воркеры">Выделенные воркеры</a>
...
### <a id="Строение-воркера" href="#Строение-воркера">Строение воркера</a>
...
## <a id="Сервис-воркеры" href="#Сервис-воркеры">Сервис-воркеры</a>
...
## <a id="Широковещательный-канал-передачи-данных-BroadcastChannel" href="#Широковещательный-канал-передачи-данных-BroadcastChannel">Широковещательный канал передачи данных `BroadcastChannel`</a>
...
<a id="Push-API-и-Notifications-API" href="#Push-API-и-Notifications-API">Push API и Notifications API</a>
============================
...
## <a id="Push-API" href="#Push-API">Push API</a>
...
## <a id="Команды-jQuery" href="#Команды-jQuery">Команды jQuery</a>
...
### <a id="Загрузка-кода-после-загрузки-страници" href="#Загрузка-кода-после-загрузки-страници">Загрузка кода после загрузки страници</a>
...
### <a id="Цепочки-команд" href="#Цепочки-команд">Цепочки команд</a>
...
### <a id="Перебор-выборки-всех-элементов" href="#Перебор-выборки-всех-элементов">Перебор выборки всех элементов</a>
...
## <a id="Методы-навигации-по-DOM" href="#Методы-навигации-по-DOM">Методы навигации по DOM</a>
...
## <a id="Атрибуты-элементов-и-CSS" href="#Атрибуты-элементов-и-CSS">Атрибуты элементов и CSS</a>

### <a id="CSS-свойства" href="#CSS-свойства">CSS свойства</a>
...
### <a id="CSS-классы" href="#CSS-классы">CSS классы</a>
...
### <a id="data-атрибуты" href="#data-атрибуты">data-атрибуты</a>
...
### <a id="Свойства-элементов" href="#Свойства-элементов">Свойства элементов</a>
...
## <a id="События" href="#События">События</a>
...
### <a id="Пространство-имен" href="#Пространство-имен">Пространство имен</a>
...
## <a id="Анимация" href="#Анимация">Анимация</a>
...
### <a id="animate" href="#animate">`animate`</a>
...
#### <a id="Остановка-анимации" href="#Остановка-анимации">Остановка анимации</a>
...
## <a id="Манипуляции-с-DOM" href="#Манипуляции-с-DOM">Манипуляции с DOM</a>

### <a id="Создания-элементов" href="#Создания-элементов">Создания элементов</a>

`$('<<имя_тега>>'[, <объект_атрибутов_элемента>])` - создает jQuery элемент.

### <a id="Перемещение-элементов" href="#Перемещение-элементов">Перемещение элементов</a>
...
### <a id="Размеры-элементов" href="#Размеры-элементов">Размеры элементов</a>
...
### <a id="Прокрутка" href="#Прокрутка">Прокрутка</a>
...
### <a id="Префильтры" href="#Префильтры">Префильтры</a>
...
### <a id="Конверторы" href="#Конверторы">Конверторы</a>
...
### <a id="Транспорт" href="#Транспорт">Транспорт</a>
...
## <a id="Объект-Deferred-и-подобные" href="#Объект-Deferred-и-подобные">Объект `Deferred` и подобные</a>
...
### <a id="Методы-уведомлений" href="#Методы-уведомлений">Методы уведомлений</a>
...
## <a id="Callbacks" href="#Callbacks">`Callbacks`</a>
...
## <a id="jQuery-плагин" href="#jQuery-плагин">jQuery плагин</a>
...
### <a id="Публичные-методы" href="#Публичные-методы">Публичные методы</a>
...
<a id="Webpack" href="#Webpack">Webpack</a>
=======

`npm i -g webpack` - инсталляция.  
`npm i webpack` - инсталляция локальная, для установки всех дополнительных модулей.

## <a id="Включение-зависимостей" href="#Включение-зависимостей">Включение зависимостей</a>
...
## <a id="Конфигурация" href="#Конфигурация">Конфигурация</a>
...
## <a id="Сойства" href="#Сойства">Сойства</a>
...
### <a id="Плагины" href="#Плагины">Плагины</a>

Плагины можно повторять.

#### <a id="Плагин-webpackEnviromentPlugin" href="#Плагин-webpackEnviromentPlugin">Плагин `webpack.EnviromentPlugin`</a>
...
#### <a id="Плагин-webpackDefinePlugin" href="#Плагин-webpackDefinePlugin">Плагин `webpack.DefinePlugin`</a>
...
#### <a id="Плагин--webpackoptimizeUglifyJsPlugin" href="#Плагин--webpackoptimizeUglifyJsPlugin">Плагин ` webpack.optimize.UglifyJsPlugin`</a>
...
#### <a id="Плагин-webpackNormalModuleReplacementPlugin" href="#Плагин-webpackNormalModuleReplacementPlugin">Плагин `webpack.NormalModuleReplacementPlugin`</a>
...
#### <a id="Плагин-webpackNoErrorsPlugin" href="#Плагин-webpackNoErrorsPlugin">Плагин `webpack.NoErrorsPlugin`</a>

Позволяет не собирать сборку, если есть какая-то ошибка в сборке.

`const NoErrorsPlugin = new webpack.NoErrorsPlugin();`.

#### <a id="Плагин-webpackCommonsChunkPlugin" href="#Плагин-webpackCommonsChunkPlugin">Плагин `webpack.CommonsChunkPlugin`</a>
...
<a id="Пример-тестирования" href="#Пример-тестирования">Пример тестирования</a>
===================
...
- **Блок `<head>`** - в нём подключаются библиотеки и стили для тестирования, кода там нет.
