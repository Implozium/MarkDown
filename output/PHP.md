...
- [Основы PHP](#user-content-Основы-PHP)
    - [Код PHP](#user-content-Код-PHP)
    - [Оператор echo](#user-content-Оператор-echo)
    - [Синтаксис HEREDOC](#user-content-Синтаксис-HEREDOC)
    - [Комментарии в скриптах](#user-content-Комментарии-в-скриптах)
    - [Переменные](#user-content-Переменные)
    - [Ссылки](#user-content-Ссылки)
    - [Константы в PHP](#user-content-Константы-в-PHP)
        - [Поддержка массивов в объявлениях `define` (PHP7)](#user-content-Поддержка-массивов-в-объявлениях-define-PHP7)
    - [Типы данных](#user-content-Типы-данных)
        - [Скалярные типы (PHP7)](#user-content-Скалярные-типы-PHP7)
    - [Математические операторы и математические функции](#user-content-Математические-операторы-и-математические-функции)
    - [Операторы присвоения](#user-content-Операторы-присвоения)
    - [Увеличение и уменьшение](#user-content-Увеличение-и-уменьшение)
    - [Приоритет операторов](#user-content-Приоритет-операторов)
    - [Оператор исполнения](#user-content-Оператор-исполнения)
    - [Строковые операторы](#user-content-Строковые-операторы)
    - [Условные операторы](#user-content-Условные-операторы)
        - [Условный оператор if](#user-content-Условный-оператор-if)
        - [Операторы сравнения](#user-content-Операторы-сравнения)
        - [Логические операторы](#user-content-Логические-операторы)
        - [Тернарный оператор](#user-content-Тернарный-оператор)
        - [Объединенный оператор сравнения (PHP7)](#user-content-Объединенный-оператор-сравнения-PHP7)
        - [?? - Оператор null coalescing (PHP7)](#user-content----Оператор-null-coalescing-PHP7)
        - [Оператор switch](#user-content-Оператор-switch)
    - [Цикл for](#user-content-Цикл-for)
    - [Цикл while](#user-content-Цикл-while)
    - [Цикл do ... while](#user-content-Цикл-do--while)
    - [Цикл foreach](#user-content-Цикл-foreach)
        - [foreach (PHP7)](#user-content-foreach-PHP7)
    - [Оператор break](#user-content-Оператор-break)
    - [Оператор continue](#user-content-Оператор-continue)
    - [Альтернативный синтаксис](#user-content-Альтернативный-синтаксис)
    - [Оператор include](#user-content-Оператор-include)
    - [Оператор require](#user-content-Оператор-require)
    - [Исключения](#user-content-Исключения)
    - [Оператор управления ошибками `@`](#user-content-Оператор-управления-ошибками-)
- [Тип данных: строка](#user-content-Тип-данных-строка)
    - [Поддержка юникод управляющих (escape-) последовательностей (PHP7)](#user-content-Поддержка-юникод-управляющих-escape--последовательностей-PHP7)
    - [Функции для обработки строк](#user-content-Функции-для-обработки-строк)
...
- [Регулярные выражения](#user-content-Регулярные-выражения)
    ...
    - [Функция `preg_replace_callback_array()` (PHP7)](#user-content-Функция-pregreplacecallbackarray-PHP7)
- [Массивы](#user-content-Массивы)
    - [Функции для работы с массивами](#user-content-Функции-для-работы-с-массивами)
    - [Дополнительные методы](#user-content-Дополнительные-методы)
    - [JSON](#user-content-JSON)
    - [URL](#user-content-URL)
- [Работа с файловой системой](#user-content-Работа-с-файловой-системой)
    - [Функции для работы с файлами](#user-content-Функции-для-работы-с-файлами)
    - [Функции для работы с каталогами](#user-content-Функции-для-работы-с-каталогами)
- [Дата](#user-content-Дата)
    - [Функции для работы с датой](#user-content-Функции-для-работы-с-датой)
    - [Объект DateTime](#user-content-Объект-DateTime)
    - [Объект DateInterval](#user-content-Объект-DateInterval)
- [Сессии](#user-content-Сессии)
- [Функции](#user-content-Функции)
    - [Объявления типов](#user-content-Объявления-типов)
    - [Объявления возвращаемых типов (PHP7)](#user-content-Объявления-возвращаемых-типов-PHP7)
    - [Методы доступные в функции](#user-content-Методы-доступные-в-функции)
    - [Генераторы](#user-content-Генераторы)
        - [Возврат выражений в генераторах (PHP7)](#user-content-Возврат-выражений-в-генераторах-PHP7)
        - [Делегирование генераторов (PHP7)](#user-content-Делегирование-генераторов-PHP7)
    - [callable](#user-content-callable)
- [Взаимодействие с HTML](#user-content-Взаимодействие-с-HTML)
    - [Загрузка файлов на сервер](#user-content-Загрузка-файлов-на-сервер)
    - [Выгрузка файла](#user-content-Выгрузка-файла)
- [ООП](#user-content-ООП)
    - [Основные термины и понятия](#user-content-Основные-термины-и-понятия)
    - [Классы](#user-content-Классы)
        - [Анонимные классы (PHP7)](#user-content-Анонимные-классы-PHP7)
    - [Интерфейсы](#user-content-Интерфейсы)
    - [Перегрузка свойств](#user-content-Перегрузка-свойств)
    - [Перегрузка методов](#user-content-Перегрузка-методов)
    - [Метод `__toString`](#user-content-Метод-toString)
    - [Метод `__invoke`](#user-content-Метод-invoke)
    - [Клонирование объектов](#user-content-Клонирование-объектов)
    - [Метод `__clone`](#user-content-Метод-clone)
    - [Контроль типа](#user-content-Контроль-типа)
    - [Трейты](#user-content-Трейты)
    - [Сериализация](#user-content-Сериализация)
- [Пространства имен](#user-content-Пространства-имен)
    - [Группировка объявлений `use` (PHP7)](#user-content-Группировка-объявлений-use-PHP7)
- [PDO](#user-content-PDO)
- [SimpleXML](#user-content-SimpleXML)
- [Шаблоны Smarty](#user-content-Шаблоны-Smarty)
    - [Подключение](#user-content-Подключение)
    - [Строение шаблонов](#user-content-Строение-шаблонов)
    - [Встроенные функции](#user-content-Встроенные-функции)
        - [Функция `config_load`](#user-content-Функция-configload)
        - [Функция `capture`](#user-content-Функция-capture)
        - [Функция `section`](#user-content-Функция-section)
        - [Функция `foreach`](#user-content-Функция-foreach)
        - [Оператор `if, elseif, else`](#user-content-Оператор-if-elseif-else)
        - [Функция `include`](#user-content-Функция-include)
        - [Функция `literal`](#user-content-Функция-literal)
        - [Функция `assign`](#user-content-Функция-assign)
    - [Функция php](#user-content-Функция-php)
    - [Модификаторы](#user-content-Модификаторы)
    - [Конфигурационные файлы](#user-content-Конфигурационные-файлы)
    - [Использование шаблонов](#user-content-Использование-шаблонов)
- [PHP 7](#user-content-PHP-7)
    - [Метод `call()` у замыканий Closure (PHP7)](#user-content-Метод-call-у-замыканий-Closure-PHP7)
    - [Ожидания - Expectations (PHP7)](#user-content-Ожидания---Expectations-PHP7)
    - [Целочисленное деление `intdiv()` (PHP7)](#user-content-Целочисленное-деление-intdiv-PHP7)
    - [Функции CSPRNG (PHP7)](#user-content-Функции-CSPRNG-PHP7)
    - [Целочисленная семантика (PHP7)](#user-content-Целочисленная-семантика-PHP7)

<a id="Основы-PHP" href="#Основы-PHP">Основы PHP</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
==========

## <a id="Код-PHP" href="#Код-PHP">Код PHP</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-echo" href="#Оператор-echo">Оператор echo</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

`echo {'<строка>' | <значение>}[, ...];` - вывод текста на экран.  
`<?=<строка>?>` - сокращенная запись.

## <a id="Синтаксис-HEREDOC" href="#Синтаксис-HEREDOC">Синтаксис HEREDOC</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Комментарии-в-скриптах" href="#Комментарии-в-скриптах">Комментарии в скриптах</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Константы-в-PHP" href="#Константы-в-PHP">Константы в PHP</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Поддержка-массивов-в-объявлениях-define-PHP7" href="#Поддержка-массивов-в-объявлениях-define-PHP7">Поддержка массивов в объявлениях `define` (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Скалярные-типы-PHP7" href="#Скалярные-типы-PHP7">Скалярные типы (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Математические-операторы-и-математические-функции" href="#Математические-операторы-и-математические-функции">Математические операторы и математические функции</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Операторы-присвоения" href="#Операторы-присвоения">Операторы присвоения</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Увеличение-и-уменьшение" href="#Увеличение-и-уменьшение">Увеличение и уменьшение</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Приоритет-операторов" href="#Приоритет-операторов">Приоритет операторов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-исполнения" href="#Оператор-исполнения">Оператор исполнения</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Строковые-операторы" href="#Строковые-операторы">Строковые операторы</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Условный-оператор-if" href="#Условный-оператор-if">Условный оператор if</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Операторы-сравнения" href="#Операторы-сравнения">Операторы сравнения</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Тернарный-оператор" href="#Тернарный-оператор">Тернарный оператор</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Объединенный-оператор-сравнения-PHP7" href="#Объединенный-оператор-сравнения-PHP7">Объединенный оператор сравнения (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="---Оператор-null-coalescing-PHP7" href="#---Оператор-null-coalescing-PHP7">?? - Оператор null coalescing (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Оператор-switch" href="#Оператор-switch">Оператор switch</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Цикл-do--while" href="#Цикл-do--while">Цикл do ... while</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Цикл-foreach" href="#Цикл-foreach">Цикл foreach</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="foreach-PHP7" href="#foreach-PHP7">foreach (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-break" href="#Оператор-break">Оператор break</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-continue" href="#Оператор-continue">Оператор continue</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Альтернативный-синтаксис" href="#Альтернативный-синтаксис">Альтернативный синтаксис</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-include" href="#Оператор-include">Оператор include</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-require" href="#Оператор-require">Оператор require</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Оператор-управления-ошибками-" href="#Оператор-управления-ошибками-">Оператор управления ошибками `@`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="Тип-данных-строка" href="#Тип-данных-строка">Тип данных: строка</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
==================

Строки являются изменяемыми.

## <a id="Поддержка-юникод-управляющих-escape--последовательностей-PHP7" href="#Поддержка-юникод-управляющих-escape--последовательностей-PHP7">Поддержка юникод управляющих (escape-) последовательностей (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Функции-для-обработки-строк" href="#Функции-для-обработки-строк">Функции для обработки строк</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Функция-pregreplacecallbackarray-PHP7" href="#Функция-pregreplacecallbackarray-PHP7">Функция `preg_replace_callback_array()` (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Функции-для-работы-с-массивами" href="#Функции-для-работы-с-массивами">Функции для работы с массивами</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="JSON" href="#JSON">JSON</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="Работа-с-файловой-системой" href="#Работа-с-файловой-системой">Работа с файловой системой</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
==========================

## <a id="Функции-для-работы-с-файлами" href="#Функции-для-работы-с-файлами">Функции для работы с файлами</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Функции-для-работы-с-каталогами" href="#Функции-для-работы-с-каталогами">Функции для работы с каталогами</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="Дата" href="#Дата">Дата</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
====

## <a id="Функции-для-работы-с-датой" href="#Функции-для-работы-с-датой">Функции для работы с датой</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Объект-DateTime" href="#Объект-DateTime">Объект DateTime</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Объект-DateInterval" href="#Объект-DateInterval">Объект DateInterval</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="Сессии" href="#Сессии">Сессии</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
======
...
## <a id="Объявления-типов" href="#Объявления-типов">Объявления типов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Объявления-возвращаемых-типов-PHP7" href="#Объявления-возвращаемых-типов-PHP7">Объявления возвращаемых типов (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Методы-доступные-в-функции" href="#Методы-доступные-в-функции">Методы доступные в функции</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Возврат-выражений-в-генераторах-PHP7" href="#Возврат-выражений-в-генераторах-PHP7">Возврат выражений в генераторах (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Делегирование-генераторов-PHP7" href="#Делегирование-генераторов-PHP7">Делегирование генераторов (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="callable" href="#callable">callable</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="Взаимодействие-с-HTML" href="#Взаимодействие-с-HTML">Взаимодействие с HTML</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
=====================
...
## <a id="Загрузка-файлов-на-сервер" href="#Загрузка-файлов-на-сервер">Загрузка файлов на сервер</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Выгрузка-файла" href="#Выгрузка-файла">Выгрузка файла</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Основные-термины-и-понятия" href="#Основные-термины-и-понятия">Основные термины и понятия</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Анонимные-классы-PHP7" href="#Анонимные-классы-PHP7">Анонимные классы (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Перегрузка-свойств" href="#Перегрузка-свойств">Перегрузка свойств</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Перегрузка-методов" href="#Перегрузка-методов">Перегрузка методов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Метод-toString" href="#Метод-toString">Метод `__toString`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Метод `__toString()` будет срабатывать при попытке преобразования класса в строку. Синтаксис (переопределяются в классе):  
`public string __toString()`

## <a id="Метод-invoke" href="#Метод-invoke">Метод `__invoke`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Клонирование-объектов" href="#Клонирование-объектов">Клонирование объектов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Метод-clone" href="#Метод-clone">Метод `__clone`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Контроль-типа" href="#Контроль-типа">Контроль типа</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Трейты" href="#Трейты">Трейты</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Сериализация" href="#Сериализация">Сериализация</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Группировка-объявлений-use-PHP7" href="#Группировка-объявлений-use-PHP7">Группировка объявлений `use` (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="PDO" href="#PDO">PDO</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
===
...
<a id="SimpleXML" href="#SimpleXML">SimpleXML</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
=========
...
<a id="Шаблоны-Smarty" href="#Шаблоны-Smarty">Шаблоны Smarty</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
==============
...
## <a id="Строение-шаблонов" href="#Строение-шаблонов">Строение шаблонов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-configload" href="#Функция-configload">Функция `config_load`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-capture" href="#Функция-capture">Функция `capture`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-section" href="#Функция-section">Функция `section`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-foreach" href="#Функция-foreach">Функция `foreach`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Оператор-if-elseif-else" href="#Оператор-if-elseif-else">Оператор `if, elseif, else`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-include" href="#Функция-include">Функция `include`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
### <a id="Функция-literal" href="#Функция-literal">Функция `literal`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

`{literal}<текст>{/literal}` - текст внутри не интерпретируется, а выводится "как есть".

### <a id="Функция-assign" href="#Функция-assign">Функция `assign`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Функция-php" href="#Функция-php">Функция php</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Конфигурационные-файлы" href="#Конфигурационные-файлы">Конфигурационные файлы</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Использование-шаблонов" href="#Использование-шаблонов">Использование шаблонов</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
<a id="PHP-7" href="#PHP-7">PHP 7</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
=====

## <a id="Метод-call-у-замыканий-Closure-PHP7" href="#Метод-call-у-замыканий-Closure-PHP7">Метод `call()` у замыканий Closure (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Ожидания---Expectations-PHP7" href="#Ожидания---Expectations-PHP7">Ожидания - Expectations (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Целочисленное-деление-intdiv-PHP7" href="#Целочисленное-деление-intdiv-PHP7">Целочисленное деление `intdiv()` (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]

Функция `intdiv(<число1>, <число2>)` - позволяет делить числа на выходе получая целые числа.

## <a id="Функции-CSPRNG-PHP7" href="#Функции-CSPRNG-PHP7">Функции CSPRNG (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
## <a id="Целочисленная-семантика-PHP7" href="#Целочисленная-семантика-PHP7">Целочисленная семантика (PHP7)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
