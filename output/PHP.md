...
- [Основы PHP](#da52f5fec2)
    - [Код PHP](#0285d5cd9c)
    - [Оператор echo](#e4c931696c)
    - [Синтаксис HEREDOC](#55fdcdf3ed)
    - [Комментарии в скриптах](#8e91732140)
    - [Переменные](#06423d48d5)
    - [Ссылки](#74a5b5e7aa)
    - [Константы в PHP](#8efef2c21c)
        - [Поддержка массивов в объявлениях `define` (PHP7)](#0434419ea4)
    - [Типы данных](#803f71de28)
        - [Скалярные типы (PHP7)](#1eb83b7916)
    - [Математические операторы и математические функции](#4f7874d948)
    - [Операторы присвоения](#0bfc1dacc3)
    - [Увеличение и уменьшение](#c527fd7668)
    - [Приоритет операторов](#b682fa8719)
    - [Оператор исполнения](#3a81a4be52)
    - [Строковые операторы](#8ad781b8e8)
    - [Условные операторы](#24fdd180d5)
        - [Условный оператор if](#a3dea7b73d)
        - [Операторы сравнения](#1f733d32ad)
        - [Логические операторы](#8bad5ce7b4)
        - [Тернарный оператор](#ba12964d58)
        - [Объединенный оператор сравнения (PHP7)](#8edcce1692)
        - [?? - Оператор null coalescing (PHP7)](#4aad7725c2)
        - [Оператор switch](#c97552907a)
    - [Цикл for](#b4a1674b20)
    - [Цикл while](#2ed1488602)
    - [Цикл do ... while](#6d232bf2ff)
    - [Цикл foreach](#fc95914ba5)
        - [foreach (PHP7)](#ea316ec63e)
    - [Оператор break](#bb76b3f21c)
    - [Оператор continue](#95b9ad5d8b)
    - [Альтернативный синтаксис](#705e27e812)
    - [Оператор include](#020603eb82)
    - [Оператор require](#0ebc9e0451)
    - [Исключения](#d327ef4029)
    - [Оператор управления ошибками `@`](#cfb7f80e90)
- [Тип данных: строка](#decf35d7d1)
    - [Поддержка юникод управляющих (escape-) последовательностей (PHP7)](#34fed94462)
    - [Функции для обработки строк](#c981183360)
    - [Кодировки](#e5ef04ebc4)
- [Регулярные выражения](#90a3d1045b)
    - [Модификаторы](#10cacf0c1a)
    - [Функция `preg_replace_callback_array()` (PHP7)](#8073e69944)
- [Массивы](#9720546dc4)
    - [Функции для работы с массивами](#9d936b775a)
    - [Дополнительные методы](#9f47598b37)
    - [JSON](#f15597165c)
- [Работа с файловой системой](#efcfef98c4)
    - [Функции для работы с файлами](#2711724faf)
    - [Функции для работы с каталогами](#b85c6e5fac)
- [Дата](#4a3d835b8e)
    - [Функции для работы с датой](#07d441abd4)
    - [Объект DateTime](#407d13f5f2)
    - [Объект DateInterval](#e1233dbfb8)
- [Сессии](#4b47649104)
- [Функции](#3a2810302d)
    - [Объявления типов](#ddb7b6e4de)
    - [Объявления возвращаемых типов (PHP7)](#58a1365daa)
    - [Методы доступные в функции](#6a9e39962a)
    - [Генераторы](#f0d29e8305)
        - [Возврат выражений в генераторах (PHP7)](#e60bee0ac2)
        - [Делегирование генераторов (PHP7)](#16b70b9c95)
    - [callable](#57f073aca2)
- [Взаимодействие с HTML](#4863453453)
    - [Загрузка файлов на сервер](#879a5b219e)
    - [Выгрузка файла](#81aed5e2d7)
- [ООП](#ca48e5dc67)
    - [Основные термины и понятия](#490cac5020)
    - [Классы](#f15d756789)
        - [Анонимные классы (PHP7)](#624936b2a2)
    - [Интерфейсы](#746440afa4)
    - [Перегрузка свойств](#7c560a4df4)
    - [Перегрузка методов](#5aa60640d9)
    - [Метод `__toString`](#c639747f7f)
    - [Метод `__invoke`](#2a34db2f8b)
    - [Клонирование объектов](#3c92c2e1a1)
    - [Метод `__clone`](#6b3784e68a)
    - [Контроль типа](#16529fffa4)
    - [Трейты](#c327892439)
    - [Сериализация](#bc2c34aa2e)
- [Пространства имен](#816d0e4b66)
    - [Группировка объявлений `use` (PHP7)](#f1c7b5d975)
- [PDO](#77b325cad7)
- [SimpleXML](#074af31135)
- [Шаблоны Smarty](#31137c984b)
    - [Подключение](#ae028287ff)
    - [Строение шаблонов](#d0651c362e)
    - [Встроенные функции](#ddca9b5207)
        - [Функция `config_load`](#8fa60f9c22)
        - [Функция `capture`](#b2ed121dad)
        - [Функция `section`](#a4a1a04b0c)
        - [Функция `foreach`](#38ac334dab)
        - [Оператор `if, elseif, else`](#047bc8ccfd)
        - [Функция `include`](#cac770b6e0)
        - [Функция `literal`](#63a115ea29)
        - [Функция `assign`](#f01baf4668)
    - [Функция php](#88ccd9125a)
    - [Модификаторы](#10cacf0c1a)
    - [Конфигурационные файлы](#5da385118d)
    - [Использование шаблонов](#7524cb5f5a)
- [PHP 7](#aa4c44bb0a)
    - [Метод `call()` у замыканий Closure (PHP7)](#ccbd269f91)
    - [Ожидания - Expectations (PHP7)](#c42bb7b343)
    - [Целочисленное деление `intdiv()` (PHP7)](#84473b0a0c)
    - [Функции CSPRNG (PHP7)](#e95e095f92)
    - [Целочисленная семантика (PHP7)](#9bbdcf843f)

<a id="da52f5fec2" href="#da52f5fec2">Основы PHP</a>
==========

## <a id="0285d5cd9c" href="#0285d5cd9c">Код PHP</a>
...
## <a id="e4c931696c" href="#e4c931696c">Оператор echo</a>

`echo {'<строка>'|<значение>}[, ...];` - вывод текста на экран.  
`<?=<строка>?>` - сокращенная запись.

## <a id="55fdcdf3ed" href="#55fdcdf3ed">Синтаксис HEREDOC</a>
...
## <a id="8e91732140" href="#8e91732140">Комментарии в скриптах</a>
...
## <a id="74a5b5e7aa" href="#74a5b5e7aa">Ссылки</a>
...
## <a id="8efef2c21c" href="#8efef2c21c">Константы в PHP</a>
...
### <a id="0434419ea4" href="#0434419ea4">Поддержка массивов в объявлениях `define` (PHP7)</a>

`define('<объявление>', <массив>);`

## <a id="803f71de28" href="#803f71de28">Типы данных</a>
...
### <a id="1eb83b7916" href="#1eb83b7916">Скалярные типы (PHP7)</a>
...
## <a id="4f7874d948" href="#4f7874d948">Математические операторы и математические функции</a>
...
## <a id="0bfc1dacc3" href="#0bfc1dacc3">Операторы присвоения</a>
...
## <a id="c527fd7668" href="#c527fd7668">Увеличение и уменьшение</a>
...
## <a id="b682fa8719" href="#b682fa8719">Приоритет операторов</a>
...
## <a id="3a81a4be52" href="#3a81a4be52">Оператор исполнения</a>
...
## <a id="8ad781b8e8" href="#8ad781b8e8">Строковые операторы</a>
...
## <a id="24fdd180d5" href="#24fdd180d5">Условные операторы</a>

### <a id="a3dea7b73d" href="#a3dea7b73d">Условный оператор if</a>
...
### <a id="1f733d32ad" href="#1f733d32ad">Операторы сравнения</a>
...
### <a id="ba12964d58" href="#ba12964d58">Тернарный оператор</a>
...
### <a id="8edcce1692" href="#8edcce1692">Объединенный оператор сравнения (PHP7)</a>
...
### <a id="4aad7725c2" href="#4aad7725c2">?? - Оператор null coalescing (PHP7)</a>
...
### <a id="c97552907a" href="#c97552907a">Оператор switch</a>
...
## <a id="b4a1674b20" href="#b4a1674b20">Цикл for</a>
...
## <a id="2ed1488602" href="#2ed1488602">Цикл while</a>
...
## <a id="6d232bf2ff" href="#6d232bf2ff">Цикл do ... while</a>
...
## <a id="fc95914ba5" href="#fc95914ba5">Цикл foreach</a>
...
### <a id="ea316ec63e" href="#ea316ec63e">foreach (PHP7)</a>
...
## <a id="bb76b3f21c" href="#bb76b3f21c">Оператор break</a>
...
## <a id="95b9ad5d8b" href="#95b9ad5d8b">Оператор continue</a>
...
## <a id="705e27e812" href="#705e27e812">Альтернативный синтаксис</a>
...
## <a id="020603eb82" href="#020603eb82">Оператор include</a>
...
## <a id="0ebc9e0451" href="#0ebc9e0451">Оператор require</a>
...
## <a id="d327ef4029" href="#d327ef4029">Исключения</a>
...
## <a id="cfb7f80e90" href="#cfb7f80e90">Оператор управления ошибками `@`</a>
...
<a id="decf35d7d1" href="#decf35d7d1">Тип данных: строка</a>
==================

Строки являются изменяемыми.

## <a id="34fed94462" href="#34fed94462">Поддержка юникод управляющих (escape-) последовательностей (PHP7)</a>
...
## <a id="c981183360" href="#c981183360">Функции для обработки строк</a>
...
## <a id="e5ef04ebc4" href="#e5ef04ebc4">Кодировки</a>
...
## <a id="10cacf0c1a" href="#10cacf0c1a">Модификаторы</a>
...
## <a id="8073e69944" href="#8073e69944">Функция `preg_replace_callback_array()` (PHP7)</a>
...
<a id="9720546dc4" href="#9720546dc4">Массивы</a>
=======
...
## <a id="9d936b775a" href="#9d936b775a">Функции для работы с массивами</a>
...
## <a id="f15597165c" href="#f15597165c">JSON</a>
...
<a id="efcfef98c4" href="#efcfef98c4">Работа с файловой системой</a>
==========================

## <a id="2711724faf" href="#2711724faf">Функции для работы с файлами</a>
...
## <a id="b85c6e5fac" href="#b85c6e5fac">Функции для работы с каталогами</a>
...
<a id="4a3d835b8e" href="#4a3d835b8e">Дата</a>
====

## <a id="07d441abd4" href="#07d441abd4">Функции для работы с датой</a>
...
## <a id="407d13f5f2" href="#407d13f5f2">Объект DateTime</a>
...
## <a id="e1233dbfb8" href="#e1233dbfb8">Объект DateInterval</a>
...
<a id="4b47649104" href="#4b47649104">Сессии</a>
======
...
## <a id="ddb7b6e4de" href="#ddb7b6e4de">Объявления типов</a>
...
## <a id="58a1365daa" href="#58a1365daa">Объявления возвращаемых типов (PHP7)</a>
...
## <a id="6a9e39962a" href="#6a9e39962a">Методы доступные в функции</a>
...
## <a id="f0d29e8305" href="#f0d29e8305">Генераторы</a>
...
### <a id="e60bee0ac2" href="#e60bee0ac2">Возврат выражений в генераторах (PHP7)</a>
...
### <a id="16b70b9c95" href="#16b70b9c95">Делегирование генераторов (PHP7)</a>
...
## <a id="57f073aca2" href="#57f073aca2">callable</a>
...
<a id="4863453453" href="#4863453453">Взаимодействие с HTML</a>
=====================
...
## <a id="879a5b219e" href="#879a5b219e">Загрузка файлов на сервер</a>
...
## <a id="81aed5e2d7" href="#81aed5e2d7">Выгрузка файла</a>
...
<a id="ca48e5dc67" href="#ca48e5dc67">ООП</a>
===

## <a id="490cac5020" href="#490cac5020">Основные термины и понятия</a>
...
### <a id="624936b2a2" href="#624936b2a2">Анонимные классы (PHP7)</a>
...
## <a id="746440afa4" href="#746440afa4">Интерфейсы</a>
...
## <a id="7c560a4df4" href="#7c560a4df4">Перегрузка свойств</a>
...
## <a id="5aa60640d9" href="#5aa60640d9">Перегрузка методов</a>
...
## <a id="3c92c2e1a1" href="#3c92c2e1a1">Клонирование объектов</a>
...
## <a id="6b3784e68a" href="#6b3784e68a">Метод `__clone`</a>
...
## <a id="16529fffa4" href="#16529fffa4">Контроль типа</a>
...
## <a id="c327892439" href="#c327892439">Трейты</a>
...
## <a id="bc2c34aa2e" href="#bc2c34aa2e">Сериализация</a>
...
<a id="816d0e4b66" href="#816d0e4b66">Пространства имен</a>
=================
...
## <a id="f1c7b5d975" href="#f1c7b5d975">Группировка объявлений `use` (PHP7)</a>
...
<a id="77b325cad7" href="#77b325cad7">PDO</a>
===
...
<a id="074af31135" href="#074af31135">SimpleXML</a>
=========
...
<a id="31137c984b" href="#31137c984b">Шаблоны Smarty</a>
==============
...
## <a id="ae028287ff" href="#ae028287ff">Подключение</a>
...
## <a id="d0651c362e" href="#d0651c362e">Строение шаблонов</a>
...
## <a id="ddca9b5207" href="#ddca9b5207">Встроенные функции</a>

### <a id="8fa60f9c22" href="#8fa60f9c22">Функция `config_load`</a>
...
### <a id="b2ed121dad" href="#b2ed121dad">Функция `capture`</a>
...
### <a id="a4a1a04b0c" href="#a4a1a04b0c">Функция `section`</a>
...
### <a id="38ac334dab" href="#38ac334dab">Функция `foreach`</a>
...
### <a id="047bc8ccfd" href="#047bc8ccfd">Оператор `if, elseif, else`</a>
...
### <a id="cac770b6e0" href="#cac770b6e0">Функция `include`</a>
...
### <a id="63a115ea29" href="#63a115ea29">Функция `literal`</a>

`{literal}<текст>{/literal}` - текст внутри не интерпретируется, а выводится "как есть".

### <a id="f01baf4668" href="#f01baf4668">Функция `assign`</a>
...
## <a id="88ccd9125a" href="#88ccd9125a">Функция php</a>
...
## <a id="5da385118d" href="#5da385118d">Конфигурационные файлы</a>
...
## <a id="7524cb5f5a" href="#7524cb5f5a">Использование шаблонов</a>
...
<a id="aa4c44bb0a" href="#aa4c44bb0a">PHP 7</a>
=====

## <a id="ccbd269f91" href="#ccbd269f91">Метод `call()` у замыканий Closure (PHP7)</a>
...
## <a id="c42bb7b343" href="#c42bb7b343">Ожидания - Expectations (PHP7)</a>
...
## <a id="84473b0a0c" href="#84473b0a0c">Целочисленное деление `intdiv()` (PHP7)</a>

Функция `intdiv(<число1>, <число2>)` - позволяет делить числа на выходе получая целые числа.

## <a id="e95e095f92" href="#e95e095f92">Функции CSPRNG (PHP7)</a>
...
## <a id="9bbdcf843f" href="#9bbdcf843f">Целочисленная семантика (PHP7)</a>
