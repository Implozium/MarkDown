...
- [Правила задания свойств](#user-content-Правила-задания-свойств)
    ...
    - [Цвет](#user-content-Цвет)
        - [Задание цвета с помощью HSL (CSS3)](#user-content-Задание-цвета-с-помощью-HSL-CSS3)
        - [Задание цвета с помощью RGBA, HSLA (CSS3)](#user-content-Задание-цвета-с-помощью-RGBA-HSLA-CSS3)
...
- [Основные свойства](#user-content-Основные-свойства)
    ...
    - [Свойства для работы с текстом](#user-content-Свойства-для-работы-с-текстом)
        ...
        - [Свойство `@font-face` (CSS3)](#user-content-Свойство-font-face-CSS3)
        ...
        - [Добавление теней к тексту: свойство `text-shadow` (CSS3)](#user-content-Добавление-теней-к-тексту-свойство-text-shadow-CSS3)
        - [Свойство `text-overflow` (CSS3)](#user-content-Свойство-text-overflow-CSS3)
        ...
        - [Свойство `word-wrap` (CSS3)](#user-content-Свойство-word-wrap-CSS3)
        - [Свойство `overflow-wrap` (CSS3)](#user-content-Свойство-overflow-wrap-CSS3)
    ...
    - [Свойства для работы с фоном](#user-content-Свойства-для-работы-с-фоном)
        ...
        - [Размер фонового изображения: свойство `background-size` (CSS3)](#user-content-Размер-фонового-изображения-свойство-background-size-CSS3)
        - [Несколько фоновых изображений (CSS3)](#user-content-Несколько-фоновых-изображений-CSS3)
        - [Свойство `background-origin` (CSS3)](#user-content-Свойство-background-origin-CSS3)
    - [Свойства для компоновки CSS](#user-content-Свойства-для-компоновки-CSS)
        ...
        - [Создание элементов со сглаженными углами: свойство `border-radius` (CSS3)](#user-content-Создание-элементов-со-сглаженными-углами-свойство-border-radius-CSS3)
        ...
        - [Свойство `box-sizing` (CSS3)](#user-content-Свойство-box-sizing-CSS3)
        - [Добавление к элементам тени: свойство `box-shadow` (CSS3)](#user-content-Добавление-к-элементам-тени-свойство-box-shadow-CSS3)
        - [Создание прозрачных элементов и картинок: свойство `opacity` (CSS3)](#user-content-Создание-прозрачных-элементов-и-картинок-свойство-opacity-CSS3)
    ...
    - [Курсор](#user-content-Курсор)
        - [Свойство `pointer-events` (CSS3)](#user-content-Свойство-pointer-events-CSS3)
        - [Свойство `user-select` (CSS3)](#user-content-Свойство-user-select-CSS3)
    - [Трансформирование элементов: свойство `transform` (CSS3)](#user-content-Трансформирование-элементов-свойство-transform-CSS3)
    - [Градиенты (CSS3)](#user-content-Градиенты-CSS3)
    ...
    - [Анимация](#user-content-Анимация)
        - [Переходы: свойство `transition` (CSS3)](#user-content-Переходы-свойство-transition-CSS3)
        ...
        - [Анимация: свойство `@keyframes`, свойство `animation` (CSS3)](#user-content-Анимация-свойство-keyframes-свойство-animation-CSS3)
            - [Ход выполнения анимации](#user-content-Ход-выполнения-анимации)
        - [Правила анимациии](#user-content-Правила-анимациии)
        - [Разбиение текста на столбцы (CSS3)](#user-content-Разбиение-текста-на-столбцы-CSS3)
...
- [Flexbox (CSS3)](#user-content-Flexbox-CSS3)
...
`:where(<селектор>)`           | выбирает все элементы, которые удолетворяют селектору и имеет специфичность равную 0
`:is(<селектор>)`              | выбирает все элементы, которые удолетворяют селектору и имеет специфичность равную специфичности селекторов
`:has(<селектор>)`             | выбирает все элементы, которые удолетворяют условию, что внутри них есть элементы, которые удолетворяют селектору (`:scope <селектор>`)
`:not(<селектор>)`             | выбирает все селекторы, которые не удолетворяют простому селектору, примененному к одному элементу, то есть не исключает родителей элемента
...
`::slotted(<селектор>)`| для доступа к элементам содержимся в `slot` , которые удолетворяют селектору, где `<селектор>` - это тег с классами и атрибутами или `*`
...
### <a id="Разбиение-текста-на-столбцы-CSS3" href="#Разбиение-текста-на-столбцы-CSS3">Разбиение текста на столбцы (CSS3)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
...
`--<имя_переменной>: var(--<имя_переменной_флага1>, <значение1>) var(--<имя_переменной_флага2>, <значение2>;`

Если установить значение переменной `--<имя_переменной_флага1>` равное `initial`, а значение переменной `--<имя_переменной_флага2>` равное чему-то не валидному, к примеру пробелу, то будет использоватья значение `<значение1>`. Для обратного поведения используюется аналогичная запись.
...
<a id="Flexbox-CSS3" href="#Flexbox-CSS3">Flexbox (CSS3)</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
==============
...
Используется для применения стилей к селекторам, которые находятся внутри контейнера и удолетворяют условиям:
```css
...
Для того чтобы контейнер применился к селектору, необходимо его назначить ему контейнер с помощью свойства `container-name` или `container` если он именованный или указать что он контейнер с помощью `container-type` и тогда все селекторы будут применяться только внутри него.
