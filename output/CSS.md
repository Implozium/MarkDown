...
- [Специфичность](#Специфичность)
    - [Разнообразные селекторы](#Разнообразные-селекторы)
...
- [Основные свойства](#Основные-свойства)
    ...
    - [Произвольные свойства и переменные CSS](#Произвольные-свойства-и-переменные-CSS)
            - [Использование переключение переменных](#Использование-переключение-переменных)
            - [Использование переменных в JS](#Использование-переменных-в-JS)
...
- [Адаптивность](#Адаптивность)
    ...
    - [Директива `@container`](#Директива-container)
- [Приемы](#Приемы)
...
`:where(<селектор>)`           | выбирает все селекторы, которые удолетворяют селектору и имеет специфичность равную 0
`:is(<селектор>)`              | выбирает все селекторы, которые удолетворяют селектору и имеет специфичность равную специфичности електоров
`:has(<селектор>)`             | выбирает все селекторы, которые удолетворяют селектору, который находится внутри этих селекторов (внутри `:scope`)
...
`:host-context(<селектор>)`    | применяет стиль к селекторам в shadow хосте
...
`::slotted(<селектор>)`| для доступа в содержимое `slot` к элементам, которые удолетворяют селектору, где `<селектор>` - это тег с классами и атрибутами или `*`
