...
- [CSS. Правила построения](#703de1fd82)
    - [Группировка селекторов](#fdb91ebe7f)
    - [Псевдоклассы](#ec5c4b24b9)
    - [Псевдоэлементы](#af2cc1c996)
    - [Комментарии](#808547a980)
    - [Наследование](#2baf77054d)
- [Специфичность](#525233b244)
- [Правила форматирования CSS](#eb4d16e83e)
- [Включение таблиц стилей в HTML-документ](#606cc8a99f)
- [Правила задания свойств](#2a59dd3297)
    - [Значения стилевых свойств](#498e64affa)
    - [Размеры](#d573fbe00c)
        - [Вычисления значений](#7aebae23b0)
            - [`calc`](#24376d259c)
            - [`repeat`](#cea9a3fba7)
    - [Цвет](#b12fd791fa)
        - [Задание цвета с помощью HSL (CSS3)](#3b4434c233)
        - [Задание цвета с помощью RGBA, HSLA (CSS3)](#a6917a02df)
    - [Адреса](#43e86907b5)
    - [Ключевые слова](#f949999cc9)
- [Основные свойства](#75aab0875c)
    - [Свойства для работы с текстом](#fcb7d21a96)
        - [Семейство шрифтов: свойство `font-family`](#299e1a29a8)
        - [Размер шрифтов: свойство `font-size`](#d74cbe0399)
        - [Насыщенность шрифтов: свойство `font-weight`](#a57edc9f4d)
        - [Стиль шрифта: свойство `font-style`](#084c666156)
        - [Капитель: свойство `font-variant`](#72f2b1fac8)
        - [Свойство `font`](#7b5b4103ab)
        - [Свойство `@font-face` (CSS3)](#b7f37bcbf8)
        - [Преобразование текста: свойство `text-transform`](#fcb1f96a53)
        - [Украшение текста: свойство `text-decoration`](#a8d23f8fbb)
        - [Добавление теней к тексту: свойство `text-shadow` (CSS3)](#3e1a894b0c)
        - [Свойство `text-overflow` (CSS3)](#2007ab2e9c)
        - [Интервал между словами: свойство `word-spacing`](#b85c3a01a6)
        - [Свойство `word-wrap` (CSS3)](#87e143a6bd)
        - [Пробелы между словами: свойство `white-space`](#175e6a1a8c)
        - [Выравнивание текста: свойство `text-align`](#572145bc7c)
        - [Интерлиньяж: свойство `line-height`](#9b221b0314)
        - [Интервал между буквами: свойство `letter-spacing`](#1208e3113b)
        - [Управление цветом переднего плана: свойство `color`](#f948bae976)
    - [Свойства для работы с фоном](#88ed8a81fa)
        - [Управление цветом фона: свойство `background-color`](#71a1ef903c)
        - [Повторение фонового изображения: свойство `background-repeat`](#5059eb160a)
        - [Присоединение: свойство `background-attachment`](#ddd2263f56)
        - [Положение фонового изображения: свойство `background-position`](#3442a89856)
        - [Свойство `background`](#c9355951cb)
        - [Размер фонового изображения: свойство `background-size` (CSS3)](#580efba956)
        - [Несколько фоновых изображений (CSS3)](#8a8cc9f45b)
        - [Свойство `background-origin` (CSS3)](#2d6e1df701)
    - [Свойства для компоновки CSS](#ae98c5893b)
        - [Поля элемента: свойство `margin`](#27ccd9c3b0)
        - [Добавление границы: свойство `border`](#01e32c77d7)
        - [Толщина границы: свойство `border-width`](#afc8bd0365)
        - [Стиль границы: свойство `border-style`](#d88adc6d32)
        - [Цвет границы: свойства `border-color`](#b5c1f67f6d)
        - [Создание элементов со сглаженными углами: свойство `border-radius` (CSS3)](#4c2ec146cc)
        - [Заполнение элемента: свойство `padding`](#7d9ef52b1b)
        - [Установка высоты и ширины элемента](#58965f18d3)
        - [Область вырезки: свойство `clip`](#1381aaa37f)
        - [Свойство `clip-path`](#fed1cac742)
        - [Свойство `box-sizing` (CSS3)](#4eb346df5d)
        - [Добавление к элементам тени: свойство `box-shadow` (CSS3)](#5f7360c7ba)
        - [Создание прозрачных элементов и картинок: свойство `opacity` (CSS3)](#2251947baf)
    - [Работа с потоком элементов](#801f18fd00)
        - [Типы блоков: свойство `display`](#92b3d45dd2)
        - ["Всплывающие" элементы: свойства `float` и `clear`](#d4e30281b7)
        - [Свойство `position` ](#01190deed6)
        - [Третье измерение веб-страницы: свойство `z-index`](#c4ccf940c0)
        - [Переполнение контейнеров: свойство `overflow`](#e3ff15b979)
        - [Видимость элемента: свойство `visibility`](#f17f9dfe69)
    - [Курсор](#12f8cd3285)
        - [Свойство `pointer-events` (CSS3)](#782c5b9990)
    - [Трансформирование элементов: свойство `transform` (CSS3)](#7ac607c910)
    - [Градиенты (CSS3)](#4cca151bca)
        - [Линейные градиенты](#63a7034eea)
        - [Сферические градиенты](#951f34b137)
        - [Повторяющиеся градиенты](#d992a87931)
    - [Переходы: свойство `transition` (CSS3)](#efb13d64a5)
        - [Шаги: steps](#9339ef2322)
        - [Функции смягчения](#ada6a2a22c)
        - [Свойство `will-change`](#887c13b4de)
    - [Анимация: свойство `@keyframes`, свойство `animation` (CSS3)](#e2f41a8faf)
        - [Ход выполнения анимации](#5f82633d13)
        - [Разбиение текста на столбцы (CSS3)](#b7aec872b1)
    - [Произвольные свойства и переменные CSS](#3d7226460b)
    - [Атрибуты данных](#1b5399545d)
- [Flexbox (CSS3)](#c4b50f95fb)
    - [Основные свойства flex-контейнера](#1c3cf44c72)
        - [Главная и поперечная ось: свойство `flex-direction`](#a03c657f4f)
        - [Выравнивание по главной оси: свойство `justify-content`](#1e151c930e)
        - [Выравнивание по поперечной оси: свойство `align-items`](#c8d2be1357)
        - [Многострочная организация блоков](#330920c13a)
    - [CSS правила для дочерних элементов (flex-блоков)](#4356b2472f)
        - [Базовый размер отдельно взятого flex-блока: свойство `flex-basis`](#232b3c8675)
        - ["Жадность" отдельно взятого flex-блока: свойство `flex-grow`](#7c335ba65c)
        - [Фактор "сжимаемости" отдельно взятого flex-блока: свойство `flex-shrink`](#9684f0eb9e)
        - [Свойство `flex`](#576a70a1c9)
        - [Выравнивание отдельно взятого flex-блока по поперечной оси: свойство `align-self`](#e4cd6d59a2)
        - [Порядок следования отдельно взятого flex-блока внутри flex-контейнера: свойство `order`](#6d65b021c2)
- [Grid](#371b89a2be)
    - [Главный контейнер](#66283211d4)
        - [Шаблон сетки](#a733a77bb9)
    - [Дочерние контейнеры](#a9f6fd68b8)
        - [Расположение на шаблоне сетки](#d663b76c01)
- [Адаптивность](#840e769ec5)
    - [CSS viewport в HTML](#34ec172bd2)
    - [Media Queries в CSS](#1b1fa0ae9b)
- [БЭМ](#d2d9274452)
    - [Блок](#6b4868dcf6)
    - [Элемент](#19fdef559a)
    - [Модификатор](#cc8d64348a)
        - [Типы модификаторов](#7309941a69)
        - [Принципы работы с модификаторами](#6a5b71dce9)
    - [Микс](#a60f211e85)

<a id="703de1fd82" href="#703de1fd82">CSS. Правила построения</a>
=======================
...
## <a id="fdb91ebe7f" href="#fdb91ebe7f">Группировка селекторов</a>
...
## <a id="ec5c4b24b9" href="#ec5c4b24b9">Псевдоклассы</a>
...
## <a id="af2cc1c996" href="#af2cc1c996">Псевдоэлементы</a>
...
## <a id="808547a980" href="#808547a980">Комментарии</a>
...
<a id="525233b244" href="#525233b244">Специфичность</a>
=============
...
<a id="eb4d16e83e" href="#eb4d16e83e">Правила форматирования CSS</a>
==========================
...
<a id="606cc8a99f" href="#606cc8a99f">Включение таблиц стилей в HTML-документ</a>
=======================================
...
<a id="2a59dd3297" href="#2a59dd3297">Правила задания свойств</a>
=======================

## <a id="498e64affa" href="#498e64affa">Значения стилевых свойств</a>
...
## <a id="d573fbe00c" href="#d573fbe00c">Размеры</a>
...
### <a id="7aebae23b0" href="#7aebae23b0">Вычисления значений</a>

#### <a id="24376d259c" href="#24376d259c">`calc`</a>
...
### <a id="3b4434c233" href="#3b4434c233">Задание цвета с помощью HSL (CSS3)</a>
...
### <a id="a6917a02df" href="#a6917a02df">Задание цвета с помощью RGBA, HSLA (CSS3)</a>
...
## <a id="43e86907b5" href="#43e86907b5">Адреса</a>
...
## <a id="f949999cc9" href="#f949999cc9">Ключевые слова</a>
...
<a id="75aab0875c" href="#75aab0875c">Основные свойства</a>
=================

## <a id="fcb7d21a96" href="#fcb7d21a96">Свойства для работы с текстом</a>

### <a id="299e1a29a8" href="#299e1a29a8">Семейство шрифтов: свойство `font-family`</a>
...
### <a id="d74cbe0399" href="#d74cbe0399">Размер шрифтов: свойство `font-size`</a>
...
### <a id="a57edc9f4d" href="#a57edc9f4d">Насыщенность шрифтов: свойство `font-weight`</a>
...
### <a id="084c666156" href="#084c666156">Стиль шрифта: свойство `font-style`</a>
...
### <a id="72f2b1fac8" href="#72f2b1fac8">Капитель: свойство `font-variant`</a>
...
### <a id="7b5b4103ab" href="#7b5b4103ab">Свойство `font`</a>

`font: [<font-style>||<font-variant>||<font-weight>] <font-size> [/<line-height>] <font-family> | inherit`

### <a id="b7f37bcbf8" href="#b7f37bcbf8">Свойство `@font-face` (CSS3)</a>
...
### <a id="fcb1f96a53" href="#fcb1f96a53">Преобразование текста: свойство `text-transform`</a>
...
### <a id="a8d23f8fbb" href="#a8d23f8fbb">Украшение текста: свойство `text-decoration`</a>
...
### <a id="3e1a894b0c" href="#3e1a894b0c">Добавление теней к тексту: свойство `text-shadow` (CSS3)</a>

`text-shadow: none / <тень>[,<тень>]*`

Где `<тень>`: `<сдвигПоX> <сдвигПоY> [<радиусРазмытия>] [<цвет>]`

### <a id="2007ab2e9c" href="#2007ab2e9c">Свойство `text-overflow` (CSS3)</a>
...
### <a id="b85c3a01a6" href="#b85c3a01a6">Интервал между словами: свойство `word-spacing`</a>
...
### <a id="87e143a6bd" href="#87e143a6bd">Свойство `word-wrap` (CSS3)</a>

Указывает, переносить или нет длинные слова, которые не помещаются по ширине в заданную область.

`word-wrap: normal | break-word | inherit`

### <a id="175e6a1a8c" href="#175e6a1a8c">Пробелы между словами: свойство `white-space`</a>
...
### <a id="572145bc7c" href="#572145bc7c">Выравнивание текста: свойство `text-align`</a>
...
### <a id="9b221b0314" href="#9b221b0314">Интерлиньяж: свойство `line-height`</a>
...
### <a id="1208e3113b" href="#1208e3113b">Интервал между буквами: свойство `letter-spacing`</a>
...
### <a id="f948bae976" href="#f948bae976">Управление цветом переднего плана: свойство `color`</a>
...
## <a id="88ed8a81fa" href="#88ed8a81fa">Свойства для работы с фоном</a>

### <a id="71a1ef903c" href="#71a1ef903c">Управление цветом фона: свойство `background-color`</a>

Это свойство можно применять и к другим элементам, в том числе к заголовкам и тексту.

### <a id="5059eb160a" href="#5059eb160a">Повторение фонового изображения: свойство `background-repeat`</a>
...
### <a id="ddd2263f56" href="#ddd2263f56">Присоединение: свойство `background-attachment`</a>
...
### <a id="3442a89856" href="#3442a89856">Положение фонового изображения: свойство `background-position`</a>
...
### <a id="c9355951cb" href="#c9355951cb">Свойство `background`</a>
...
### <a id="580efba956" href="#580efba956">Размер фонового изображения: свойство `background-size` (CSS3)</a>
...
### <a id="8a8cc9f45b" href="#8a8cc9f45b">Несколько фоновых изображений (CSS3)</a>
...
### <a id="2d6e1df701" href="#2d6e1df701">Свойство `background-origin` (CSS3)</a>
...
## <a id="ae98c5893b" href="#ae98c5893b">Свойства для компоновки CSS</a>
...
### <a id="27ccd9c3b0" href="#27ccd9c3b0">Поля элемента: свойство `margin`</a>
...
### <a id="01e32c77d7" href="#01e32c77d7">Добавление границы: свойство `border`</a>
...
### <a id="afc8bd0365" href="#afc8bd0365">Толщина границы: свойство `border-width`</a>
...
### <a id="d88adc6d32" href="#d88adc6d32">Стиль границы: свойство `border-style`</a>
...
### <a id="b5c1f67f6d" href="#b5c1f67f6d">Цвет границы: свойства `border-color`</a>

Для каждой границы можно задать любой цвет с помощью сокращенного свойства `border-color` или его уточнения.

### <a id="4c2ec146cc" href="#4c2ec146cc">Создание элементов со сглаженными углами: свойство `border-radius` (CSS3)</a>
...
### <a id="7d9ef52b1b" href="#7d9ef52b1b">Заполнение элемента: свойство `padding`</a>
...
### <a id="58965f18d3" href="#58965f18d3">Установка высоты и ширины элемента</a>
...
### <a id="1381aaa37f" href="#1381aaa37f">Область вырезки: свойство `clip`</a>
...
### <a id="fed1cac742" href="#fed1cac742">Свойство `clip-path`</a>
...
### <a id="4eb346df5d" href="#4eb346df5d">Свойство `box-sizing` (CSS3)</a>
...
### <a id="5f7360c7ba" href="#5f7360c7ba">Добавление к элементам тени: свойство `box-shadow` (CSS3)</a>
...
### <a id="2251947baf" href="#2251947baf">Создание прозрачных элементов и картинок: свойство `opacity` (CSS3)</a>
...
## <a id="801f18fd00" href="#801f18fd00">Работа с потоком элементов</a>

### <a id="92b3d45dd2" href="#92b3d45dd2">Типы блоков: свойство `display`</a>
...
### <a id="d4e30281b7" href="#d4e30281b7">"Всплывающие" элементы: свойства `float` и `clear`</a>
...
### <a id="01190deed6" href="#01190deed6">Свойство `position` </a>
...
### <a id="c4ccf940c0" href="#c4ccf940c0">Третье измерение веб-страницы: свойство `z-index`</a>
...
### <a id="e3ff15b979" href="#e3ff15b979">Переполнение контейнеров: свойство `overflow`</a>
...
### <a id="f17f9dfe69" href="#f17f9dfe69">Видимость элемента: свойство `visibility`</a>
...
## <a id="12f8cd3285" href="#12f8cd3285">Курсор</a>

### <a id="782c5b9990" href="#782c5b9990">Свойство `pointer-events` (CSS3)</a>
...
## <a id="7ac607c910" href="#7ac607c910">Трансформирование элементов: свойство `transform` (CSS3)</a>
...
## <a id="4cca151bca" href="#4cca151bca">Градиенты (CSS3)</a>

### <a id="63a7034eea" href="#63a7034eea">Линейные градиенты</a>
...
### <a id="951f34b137" href="#951f34b137">Сферические градиенты</a>
...
### <a id="d992a87931" href="#d992a87931">Повторяющиеся градиенты</a>
...
## <a id="efb13d64a5" href="#efb13d64a5">Переходы: свойство `transition` (CSS3)</a>
...
### <a id="9339ef2322" href="#9339ef2322">Шаги: steps</a>
...
### <a id="ada6a2a22c" href="#ada6a2a22c">Функции смягчения</a>
...
### <a id="887c13b4de" href="#887c13b4de">Свойство `will-change`</a>
...
## <a id="e2f41a8faf" href="#e2f41a8faf">Анимация: свойство `@keyframes`, свойство `animation` (CSS3)</a>
...
### <a id="5f82633d13" href="#5f82633d13">Ход выполнения анимации</a>
...
### <a id="b7aec872b1" href="#b7aec872b1">Разбиение текста на столбцы (CSS3)</a>
...
## <a id="3d7226460b" href="#3d7226460b">Произвольные свойства и переменные CSS</a>
...
## <a id="1b5399545d" href="#1b5399545d">Атрибуты данных</a>
...
<a id="c4b50f95fb" href="#c4b50f95fb">Flexbox (CSS3)</a>
==============
...
## <a id="1c3cf44c72" href="#1c3cf44c72">Основные свойства flex-контейнера</a>

### <a id="a03c657f4f" href="#a03c657f4f">Главная и поперечная ось: свойство `flex-direction`</a>
...
### <a id="1e151c930e" href="#1e151c930e">Выравнивание по главной оси: свойство `justify-content`</a>
...
### <a id="c8d2be1357" href="#c8d2be1357">Выравнивание по поперечной оси: свойство `align-items`</a>
...
### <a id="330920c13a" href="#330920c13a">Многострочная организация блоков</a>
...
## <a id="4356b2472f" href="#4356b2472f">CSS правила для дочерних элементов (flex-блоков)</a>

### <a id="232b3c8675" href="#232b3c8675">Базовый размер отдельно взятого flex-блока: свойство `flex-basis`</a>
...
### <a id="7c335ba65c" href="#7c335ba65c">"Жадность" отдельно взятого flex-блока: свойство `flex-grow`</a>
...
### <a id="9684f0eb9e" href="#9684f0eb9e">Фактор "сжимаемости" отдельно взятого flex-блока: свойство `flex-shrink`</a>
...
### <a id="576a70a1c9" href="#576a70a1c9">Свойство `flex`</a>

Свойство `flex` – короткая запись для свойств `flex-grow`, `flex-shrink` и `flex-basis`

`flex: none | [<flex-grow> <flex-shrink>? || <flex-basis>]`

### <a id="e4cd6d59a2" href="#e4cd6d59a2">Выравнивание отдельно взятого flex-блока по поперечной оси: свойство `align-self`</a>
...
### <a id="6d65b021c2" href="#6d65b021c2">Порядок следования отдельно взятого flex-блока внутри flex-контейнера: свойство `order`</a>
...
<a id="371b89a2be" href="#371b89a2be">Grid</a>
====
...
## <a id="66283211d4" href="#66283211d4">Главный контейнер</a>
...
### <a id="a733a77bb9" href="#a733a77bb9">Шаблон сетки</a>
...
## <a id="a9f6fd68b8" href="#a9f6fd68b8">Дочерние контейнеры</a>
...
### <a id="d663b76c01" href="#d663b76c01">Расположение на шаблоне сетки</a>

Указанный элемент должен располагаться на месте `<сим>` - символа зоны, в макете шаблона сетки.

`grid-area: <сим>;`

<a id="840e769ec5" href="#840e769ec5">Адаптивность</a>
============

## <a id="34ec172bd2" href="#34ec172bd2">CSS viewport в HTML</a>
...
## <a id="1b1fa0ae9b" href="#1b1fa0ae9b">Media Queries в CSS</a>
...
<a id="d2d9274452" href="#d2d9274452">БЭМ</a>
===
...
## <a id="6b4868dcf6" href="#6b4868dcf6">Блок</a>
...
## <a id="19fdef559a" href="#19fdef559a">Элемент</a>
...
## <a id="cc8d64348a" href="#cc8d64348a">Модификатор</a>
...
### <a id="7309941a69" href="#7309941a69">Типы модификаторов</a>
...
### <a id="6a5b71dce9" href="#6a5b71dce9">Принципы работы с модификаторами</a>
...
## <a id="a60f211e85" href="#a60f211e85">Микс</a>
