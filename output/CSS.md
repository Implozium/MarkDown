...
- [Основные свойства](#user-content-Основные-свойства)
    ...
    - [Трансформирование элементов: свойство `transform`](#user-content-Трансформирование-элементов-свойство-transform)
...
Свойство `overscroll-behavior` в значении `none`озволяют предотвратить прокрутку родительского блока при достижении конца прокрутки текущего элемента.
...
## <a id="Трансформирование-элементов-свойство-transform" href="#Трансформирование-элементов-свойство-transform">Трансформирование элементов: свойство `transform`</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
