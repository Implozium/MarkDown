...
- [Инициализация, `canvas`](#user-content-Инициализация-canvas)
- [Цвет](#user-content-Цвет)
- [Система координат](#user-content-Система-координат)
    - [Матрица преобразования](#user-content-Матрица-преобразования)
        - [Матрица преобразования: вращение](#user-content-Матрица-преобразования-вращение)
        - [Матрица преобразования: перемещение](#user-content-Матрица-преобразования-перемещение)
        - [Матрица преобразования: масштабирование](#user-content-Матрица-преобразования-масштабирование)
- [Шейдер](#user-content-Шейдер)
    - [Код шейдеров](#user-content-Код-шейдеров)
        - [`attribute` переменные](#user-content-attribute-переменные)
        - [`uniform` переменные](#user-content-uniform-переменные)
        - [Вершинный шейдер](#user-content-Вершинный-шейдер)
        - [Фрагментный шейдер](#user-content-Фрагментный-шейдер)
- [Буферы](#user-content-Буферы)
