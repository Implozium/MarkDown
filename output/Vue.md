...
### <a id="Входные-параметры-слота" href="#Входные-параметры-слота">Входные параметры слота</a>
...
## <a id="События-компонента" href="#События-компонента">События компонента</a>
...
### <a id="Прослушивание-событий-компонента" href="#Прослушивание-событий-компонента">Прослушивание событий компонента</a>
...
## <a id="Доступы" href="#Доступы">Доступы</a>
...
<a id="Правила-описания-компонентов" href="#Правила-описания-компонентов">Правила описания компонентов</a>
============================

## <a id="Порядок-опций-компонентаэкземпляра" href="#Порядок-опций-компонентаэкземпляра">Порядок опций компонента/экземпляра</a>
...
## <a id="Порядок-атрибутов-элемента" href="#Порядок-атрибутов-элемента">Порядок атрибутов элемента</a>
...
<a id="Анимирование" href="#Анимирование">Анимирование</a>
============
...
## <a id="Слияние-опций" href="#Слияние-опций">Слияние опций</a>
...
## <a id="Глобальные-примеси" href="#Глобальные-примеси">Глобальные примеси</a>
...
<a id="Пользовательские-директивы" href="#Пользовательские-директивы">Пользовательские директивы</a>
==========================
