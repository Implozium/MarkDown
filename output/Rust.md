...
- [Концепция владения](#Концепция-владения)
    - [Ссылки и заимствование](#Ссылки-и-заимствование)
        ...
        - [Заимствование ссылок](#Заимствование-ссылок)
        - [`ref`](#ref)
...
- [Обработка ошибок](#Обработка-ошибок)
    ...
    - [Устранимые ошибки `Result`](#Устранимые-ошибки-Result)
        - [Методы](#Методы)
        - [Общие методы `Result` и `Option`](#Общие-методы-Result-и-Option)
...
- [Типажи `trait`](#Типажи-trait)
    ...
    - [Стандартные типажи](#Стандартные-типажи)
        - [`Clone`](#Clone)
        - [`Copy`](#Copy)
        - [`PartialEq`](#PartialEq)
        - [`Eq`](#Eq)
        ...
        - [`std::convert::From`](#stdconvertFrom)
        - [`std::convert::Into`](#stdconvertInto)
        - [`std::any::Any`](#stdanyAny)
...
- [Умные указатели](#Умные-указатели)
    ...
    - [Умный указатель `Cell<T>`](#Умный-указатель-CellT)
...
- [Стандартная библиотека](#Стандартная-библиотека)
    - [Коллекции общего назначения `std::collections`](#Коллекции-общего-назначения-stdcollections)
        - [Хеш-отображения `std::collections::HashMap`](#Хеш-отображения-stdcollectionsHashMap)
        - [Хеш-набор `std::collections::HashSet`](#Хеш-набор-stdcollectionsHashSet)
        - [`std::collections::VecDeque`](#stdcollectionsVecDeque)
    - [`std::env`](#stdenv)
    - [`std::fs`](#stdfs)
        - [`std::fs::File`](#stdfsFile)
    - [`std::io`](#stdio)
        - [`std::io::BufReader`](#stdioBufReader)
...
`let (<срез1>, <срез2>) = <массив>.split_at_mut(<индекс>);` - возвращает кортеж из двух стайсов типа `&mut [<тип>]` в которых содержится по части массива, разбитых по индексу.
...
При этом заимствованная ссылка продлемает время жизни оригинальной ссылки.
...
## <a id="Сыылки" href="#Сыылки">Сыылки</a> [<a id="Содержание" href="#Содержание">Содержание</a>]
